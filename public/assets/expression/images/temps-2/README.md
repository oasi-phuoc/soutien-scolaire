# Images scène régénérées (temps-2)

Dossier temporaire : `public/assets/expression/images/temps-2/`

## Référence de style
- `scene/102 (2).webp` — intérieur domestique painterly soft
...
- Contexte / type de scène conservé (thème catalogue + tags)
- Personnages **changés** (âges, apparences, vêtements)
- Action / pose **changée** (même intention communicative, autre composition)
