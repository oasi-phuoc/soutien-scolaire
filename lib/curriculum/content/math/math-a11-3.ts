...
export const MATH_A11_3_LESSON: MathSubmoduleLesson = {
    ...
    exercises: [],
    exercisePool: [
      { id: "a11-3-ep01", promptFr: "Résous x + 2 ≤ 7. Donne la borne de l'intervalle.", type: "number", acceptable: ["5"] },
      { id: "a11-3-ep02", promptFr: "Résous 2x > 8. Donne la borne stricte.", type: "number", acceptable: ["4"] },
      { id: "a11-3-ep03", promptFr: "Résous x − 1 < 5. Donne la borne stricte.", type: "number", acceptable: ["6"] },
      { id: "a11-3-ep04", promptFr: "Résous 3x ≤ 15. Donne la borne.", type: "number", acceptable: ["5"] },
      { id: "a11-3-ep05", promptFr: "Résous 2x + 1 < 9. Donne la borne stricte.", type: "number", acceptable: ["4"] },
      { id: "a11-3-ep06", promptFr: "Résous 4x ≥ 20. Donne la borne.", type: "number", acceptable: ["5"] },
      { id: "a11-3-ep07", promptFr: "Résous x + 5 > 12. Donne la borne stricte.", type: "number", acceptable: ["7"] },
      { id: "a11-3-ep08", promptFr: "Résous 3x − 3 ≤ 12. Donne la borne.", type: "number", acceptable: ["5"] },
      { id: "a11-3-ep09", promptFr: "Résous 5x < 35. Donne la borne stricte.", type: "number", acceptable: ["7"] },
      { id: "a11-3-ep10", promptFr: "Résous 2x − 4 ≤ 6. Donne la borne.", type: "number", acceptable: ["5"] },
    ],
    poolSize: 5,
  };
