...
const FIGURES: Array<{ id: string; label: string; figure: GridFigure }> = [
  ...
  { id: "palm", label: "Palmier", figure: fig([
    ...line([5, 10], [5, 4]),
    ...line([5, 4], [1, 2]),
    ...line([5, 4], [2, 1]),
    ...line([5, 4], [5, 0]),
  ...
  { id: "submarine", label: "Sous-marin", figure: fig([
    ...poly([[1, 5], [2, 3], [8, 3], [9, 5], [8, 7], [2, 7]]),
    ...rect(4, 1, 2, 2),
    ...line([5, 1], [5, 0]),
    ...poly([[9, 5], [10, 4], [10, 6]]),
    ...line([2, 5], [0, 4]),
  ...
  { id: "helicopter", label: "Hélicoptère", figure: fig([
    ...rect(3, 4, 5, 3),
    ...poly([[8, 5], [10, 4], [10, 7], [8, 6]]),
    ...line([5, 4], [5, 2]),
    ...line([1, 2], [9, 2]),
    ...line([3, 7], [3, 9]),
    ...line([7, 7], [7, 9]),
  ...
  { id: "igloo", label: "Igloo", figure: fig([
    ...poly([[1, 8], [1, 5], [2, 3], [4, 1], [6, 1], [8, 3], [9, 5], [9, 8]]),
    ...line([1, 8], [9, 8]),
    ...rect(3, 6, 3, 2),
    ...line([2, 5], [8, 5]),
    ...line([3, 3], [7, 3]),
  ...
  { id: "bird2", label: "Oiseau", figure: fig([
    ...poly([[2, 4], [4, 2], [7, 2], [9, 4], [8, 6], [5, 7], [3, 6]]),
    ...poly([[9, 4], [10, 2], [10, 5]]),
    ...line([4, 7], [4, 9]),
    ...line([6, 7], [6, 9]),
    ...line([3, 9], [7, 9]),
  ], [{ x: 6, y: 3 }]) },
  { id: "key2", label: "Clé", figure: fig([
    ...poly([[1, 2], [3, 1], [5, 2], [5, 4], [3, 5], [1, 4]]),
    ...line([5, 3], [9, 3]),
    ...line([9, 3], [9, 6]),
    ...line([7, 3], [7, 5]),
    ...line([8, 3], [8, 5]),
