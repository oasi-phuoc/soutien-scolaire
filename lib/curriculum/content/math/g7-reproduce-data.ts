...
const FIGURES: Array<{ id: string; label: string; figure: GridFigure }> = [
  ...
  { id: "rocket", label: "Fusée", figure: fig([...poly([[5, 1], [3, 3], [7, 3]]), ...rect(3, 3, 4, 4), ...line([3, 7], [1, 9]), ...line([7, 7], [9, 9]), ...line([3, 7], [7, 7]), ...rect(4, 4, 2, 2)], [{ x: 5, y: 5 }]) },
  ...
  { id: "car", label: "Voiture", figure: fig([...poly([[1, 6], [2, 3], [7, 3], [8, 6], [9, 6], [9, 8], [1, 8]]), ...line([2, 3], [2, 6]), ...line([7, 3], [7, 6]), ...rect(2, 4, 2, 1), ...rect(5, 4, 2, 1)], [{ x: 2, y: 9 }, { x: 7, y: 9 }]) },
  { id: "bird", label: "Oiseau", figure: fig([...poly([[1, 5], [3, 2], [6, 1], [8, 3], [9, 5], [7, 7], [4, 8], [2, 7]]), ...poly([[8, 3], [10, 2], [9, 5]]), ...line([4, 8], [4, 10]), ...line([6, 8], [6, 10])], [{ x: 6, y: 3 }]) },
  ...
  { id: "dog", label: "Chien", figure: fig([...poly([[2, 4], [4, 2], [6, 2], [7, 4], [7, 6], [2, 6]]), ...poly([[7, 4], [9, 3], [9, 5], [7, 6]]), ...line([3, 6], [3, 9]), ...line([6, 6], [6, 9]), ...line([2, 5], [0, 4])], [{ x: 8, y: 4 }]) },
  ...
  { id: "butterfly", label: "Papillon", figure: fig([...poly([[5, 2], [1, 0], [0, 3], [2, 5], [5, 4]]), ...poly([[5, 2], [9, 0], [10, 3], [8, 5], [5, 4]]), ...poly([[5, 4], [2, 6], [1, 9], [4, 8], [5, 6]]), ...poly([[5, 4], [8, 6], [9, 9], [6, 8], [5, 6]]), ...line([5, 2], [5, 8])], [{ x: 5, y: 1 }]) },
  { id: "airplane", label: "Avion", figure: fig([...poly([[1, 5], [4, 4], [7, 4], [9, 5], [7, 6], [4, 6]]), ...line([5, 4], [2, 1]), ...line([5, 6], [2, 9]), ...line([7, 4], [8, 2]), ...line([7, 6], [8, 8]), ...poly([[9, 5], [10, 4], [10, 6]])], [{ x: 5, y: 5 }]) },
  ...
  { id: "mushroom", label: "Champignon", figure: fig([...poly([[1, 4], [5, 1], [9, 4]]), ...line([1, 4], [9, 4]), ...rect(3, 4, 4, 4), ...line([2, 8], [8, 8])], [{ x: 3, y: 2 }, { x: 6, y: 2 }, { x: 5, y: 3 }]) },
  { id: "snail", label: "Escargot", figure: fig([...poly([[3, 3], [6, 1], [8, 3], [8, 6], [6, 8], [3, 6]]), ...line([6, 1], [6, 8]), ...line([3, 3], [8, 6]), ...line([8, 3], [3, 6]), ...line([3, 6], [1, 7], [0, 9], [2, 10], [7, 10], [9, 9])], [{ x: 1, y: 5 }]) },
  { id: "robot", label: "Robot", figure: fig([...rect(3, 0, 4, 2), ...rect(2, 2, 6, 5), ...line([2, 4], [0, 3], [0, 6], [2, 5]), ...line([8, 4], [10, 3], [10, 6], [8, 5]), ...line([4, 7], [4, 9]), ...line([6, 7], [6, 9]), ...rect(4, 3, 1, 1), ...rect(6, 3, 1, 1), ...line([4, 5], [7, 5])], [{ x: 4, y: 1 }, { x: 6, y: 1 }]) },
  ...
  { id: "key", label: "Clé", figure: fig([...poly([[2, 1], [4, 1], [5, 2], [5, 4], [4, 5], [2, 5], [1, 4], [1, 2]]), ...line([4, 3], [9, 3]), ...line([9, 3], [9, 5]), ...line([7, 3], [7, 5])], [{ x: 3, y: 3 }]) },
  ...
  { id: "turtle", label: "Tortue", figure: fig([...poly([[2, 3], [5, 1], [8, 3], [9, 6], [5, 8], [1, 6]]), ...line([5, 1], [5, 8]), ...line([2, 3], [8, 6]), ...line([8, 3], [2, 6]), ...poly([[8, 3], [10, 2], [10, 5]]), ...line([2, 6], [0, 7]), ...line([3, 8], [2, 10]), ...line([7, 8], [8, 10])], [{ x: 9, y: 4 }]) },
  ...
  { id: "hat", label: "Chapeau", figure: fig([...poly([[3, 5], [3, 1], [7, 1], [7, 5]]), ...line([0, 5], [10, 5]), ...line([0, 5], [0, 6], [10, 6], [10, 5]), ...line([3, 3], [7, 3])], [{ x: 5, y: 2 }]) },
  ...
  { id: "fox", label: "Renard", figure: fig([...poly([[1, 2], [3, 0], [4, 2], [6, 2], [7, 0], [9, 2], [10, 5], [8, 9], [2, 9], [0, 5]]), ...poly([[4, 5], [5, 7], [6, 5]]), ...line([3, 9], [3, 10]), ...line([7, 9], [7, 10])], [{ x: 3, y: 4 }, { x: 7, y: 4 }]) },
  { id: "truck", label: "Camion", figure: fig([...rect(0, 3, 6, 4), ...poly([[6, 5], [8, 5], [9, 7], [9, 8], [6, 8]]), ...rect(6, 5, 1, 1)], [{ x: 2, y: 9 }, { x: 5, y: 9 }, { x: 8, y: 9 }]) },
  { id: "tent", label: "Tente", figure: fig([...poly([[0, 9], [5, 1], [10, 9]]), ...line([0, 9], [10, 9]), ...line([5, 1], [5, 9]), ...line([3, 9], [3, 6], [7, 6], [7, 9])], [{ x: 5, y: 4 }]) },
  { id: "candle", label: "Bougie", figure: fig([...rect(4, 3, 2, 5), ...poly([[4, 3], [5, 0], [6, 3]]), ...line([3, 8], [7, 8]), ...line([2, 9], [8, 9])], [{ x: 5, y: 1 }]) },
  { id: "bee", label: "Abeille", figure: fig([...poly([[2, 4], [5, 2], [8, 4], [8, 7], [5, 9], [2, 7]]), ...line([4, 2], [4, 9]), ...line([6, 2], [6, 9]), ...poly([[2, 4], [0, 2], [0, 5], [2, 6]]), ...poly([[8, 4], [10, 2], [10, 5], [8, 6]])], [{ x: 4, y: 4 }, { x: 6, y: 4 }]) },
  { id: "ladder", label: "Échelle", figure: fig([...line([2, 0], [2, 10]), ...line([8, 0], [8, 10]), ...line([2, 1], [8, 1]), ...line([2, 3], [8, 3]), ...line([2, 5], [8, 5]), ...line([2, 7], [8, 7]), ...line([2, 9], [8, 9])], [{ x: 5, y: 5 }]) },
  { id: "bridge", label: "Pont", figure: fig([...line([0, 7], [2, 4], [5, 2], [8, 4], [10, 7]), ...line([0, 7], [10, 7]), ...line([2, 7], [2, 4]), ...line([5, 7], [5, 2]), ...line([8, 7], [8, 4]), ...line([0, 8], [0, 10]), ...line([10, 8], [10, 10]), ...line([0, 9], [10, 9])], [{ x: 5, y: 5 }]) },
  ...
  { id: "sword", label: "Épée", figure: fig([...poly([[4, 0], [6, 0], [6, 6], [4, 6]]), ...line([2, 6], [8, 6]), ...line([2, 6], [2, 7], [8, 7], [8, 6]), ...rect(4, 7, 2, 1), ...line([4, 8], [6, 8], [5, 10], [4, 8])], [{ x: 5, y: 3 }]) },
  { id: "dragon", label: "Dragon", figure: fig([...poly([[0, 6], [2, 3], [4, 4], [6, 1], [8, 3], [10, 2], [9, 5], [10, 7], [7, 8], [5, 7], [3, 9], [1, 8]]), ...line([6, 1], [7, 0]), ...line([8, 3], [9, 1]), ...line([3, 9], [2, 10]), ...line([5, 7], [6, 10])], [{ x: 3, y: 4 }, { x: 7, y: 4 }]) },
  { id: "bicycle", label: "Vélo", figure: fig([...poly([[1, 6], [3, 4], [3, 8], [1, 8]]), ...poly([[7, 6], [9, 4], [9, 8], [7, 8]]), ...line([3, 6], [5, 3], [7, 6]), ...line([5, 3], [5, 2], [4, 2]), ...line([3, 6], [6, 6])], [{ x: 2, y: 6 }, { x: 8, y: 6 }]) },
  ...
  { id: "lighthouse", label: "Phare", figure: fig([...poly([[3, 9], [4, 2], [6, 2], [7, 9]]), ...rect(3, 0, 4, 2), ...line([5, 0], [5, 0]), ...line([2, 9], [8, 9]), ...line([1, 10], [9, 10]), ...rect(4, 4, 2, 1), ...rect(4, 6, 2, 1)], [{ x: 5, y: 1 }]) },
