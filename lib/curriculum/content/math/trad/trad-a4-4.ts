...
export const TRAD_A4_4: SubmoduleTrad = {
  ...
  consignes: {
    "a4-4-ep01": { fr: "Calculez 1/5 + 2/5. (ex: 3/5)", en: "Calculate 1/5 + 2/5. (e.g. 3/5)",
      ar: "احسب 1/5 + 2/5. (مثال: 3/5)",
      fa: "1/5 + 2/5 را حساب کنید. (مثال: 3/5)",
      pt: "Calcule 1/5 + 2/5. (ex: 3/5)",
      so: "Xisaabi 1/5 + 2/5. (tusaale: 3/5)",
      ti: "1/5 + 2/5 ሒሳብ ግበር። (ኣብነት፡ 3/5)",
      tr: "1/5 + 2/5 hesaplayın. (örn: 3/5)",
      ps: "1/5 + 2/5 حساب کړئ. (بېلګه: 3/5)",
      uk: "Обчисліть 1/5 + 2/5. (напр.: 3/5)" },
    "a4-4-ep02": { fr: "Calculez 3/8 + 2/8. (ex: 5/8)", en: "Calculate 3/8 + 2/8. (e.g. 5/8)",
      ar: "احسب 3/8 + 2/8. (مثال: 5/8)",
      fa: "3/8 + 2/8 را حساب کنید. (مثال: 5/8)",
      pt: "Calcule 3/8 + 2/8. (ex: 5/8)",
      so: "Xisaabi 3/8 + 2/8. (tusaale: 5/8)",
      ti: "3/8 + 2/8 ሒሳብ ግበር። (ኣብነት፡ 5/8)",
      tr: "3/8 + 2/8 hesaplayın. (örn: 5/8)",
      ps: "3/8 + 2/8 حساب کړئ. (بېلګه: 5/8)",
      uk: "Обчисліть 3/8 + 2/8. (напр.: 5/8)" },
    "a4-4-ep03": { fr: "Calculez 5/7 − 2/7. (ex: 3/7)", en: "Calculate 5/7 − 2/7. (e.g. 3/7)",
      ar: "احسب 5/7 − 2/7. (مثال: 3/7)",
      fa: "5/7 − 2/7 را حساب کنید. (مثال: 3/7)",
      pt: "Calcule 5/7 − 2/7. (ex: 3/7)",
      so: "Xisaabi 5/7 − 2/7. (tusaale: 3/7)",
      ti: "5/7 − 2/7 ሒሳብ ግበር። (ኣብነት፡ 3/7)",
      tr: "5/7 − 2/7 hesaplayın. (örn: 3/7)",
      ps: "5/7 − 2/7 حساب کړئ. (بېلګه: 3/7)",
      uk: "Обчисліть 5/7 − 2/7. (напр.: 3/7)" },
    "a4-4-ep04": { fr: "Calculez 1/2 + 1/3. PPCM(2,3)=6 : 3/6 + 2/6 = ? (ex: 5/6)", en: "Calculate 1/2 + 1/3. LCM(2,3)=6: 3/6 + 2/6 = ? (e.g. 5/6)",
      ar: "احسب 1/2 + 1/3. م.م.م(2,3)=6 : 3/6 + 2/6 = ؟ (مثال: 5/6)",
      fa: "1/2 + 1/3 را حساب کنید. م.م.م(2,3)=6: 3/6 + 2/6 = ؟ (مثال: 5/6)",
      pt: "Calcule 1/2 + 1/3. MMC(2,3)=6: 3/6 + 2/6 = ? (ex: 5/6)",
      so: "Xisaabi 1/2 + 1/3. MMC(2,3)=6: 3/6 + 2/6 = ? (tusaale: 5/6)",
      ti: "1/2 + 1/3 ሒሳብ ግበር። ሓ.ሓ.ሓ(2,3)=6: 3/6 + 2/6 = ? (ኣብነት፡ 5/6)",
      tr: "1/2 + 1/3 hesaplayın. OBEK(2,3)=6: 3/6 + 2/6 = ? (örn: 5/6)",
      ps: "1/2 + 1/3 حساب کړئ. م.م.م(2,3)=6: 3/6 + 2/6 = ؟ (بېلګه: 5/6)",
      uk: "Обчисліть 1/2 + 1/3. НСК(2,3)=6: 3/6 + 2/6 = ? (напр.: 5/6)" },
    "a4-4-ep05": { fr: "Calculez 3/4 − 1/2. PPCM(4,2)=4 : 3/4 − 2/4 = ? (ex: 1/4)", en: "Calculate 3/4 − 1/2. LCM(4,2)=4: 3/4 − 2/4 = ? (e.g. 1/4)",
      ar: "احسب 3/4 − 1/2. م.م.م(4,2)=4 : 3/4 − 2/4 = ؟ (مثال: 1/4)",
      fa: "3/4 − 1/2 را حساب کنید. م.م.م(4,2)=4: 3/4 − 2/4 = ؟ (مثال: 1/4)",
      pt: "Calcule 3/4 − 1/2. MMC(4,2)=4: 3/4 − 2/4 = ? (ex: 1/4)",
      so: "Xisaabi 3/4 − 1/2. MMC(4,2)=4: 3/4 − 2/4 = ? (tusaale: 1/4)",
      ti: "3/4 − 1/2 ሒሳብ ግበር። ሓ.ሓ.ሓ(4,2)=4: 3/4 − 2/4 = ? (ኣብነት፡ 1/4)",
      tr: "3/4 − 1/2 hesaplayın. OBEK(4,2)=4: 3/4 − 2/4 = ? (örn: 1/4)",
      ps: "3/4 − 1/2 حساب کړئ. م.م.م(4,2)=4: 3/4 − 2/4 = ؟ (بېلګه: 1/4)",
      uk: "Обчисліть 3/4 − 1/2. НСК(4,2)=4: 3/4 − 2/4 = ? (напр.: 1/4)" },
    "a4-4-ep06": { fr: "Calculez 2/3 + 1/6. PPCM(3,6)=6 : 4/6 + 1/6 = ? Simplifiez. (ex: 5/6)", en: "Calculate 2/3 + 1/6. LCM(3,6)=6: 4/6 + 1/6 = ? Simplify. (e.g. 5/6)",
      ar: "احسب 2/3 + 1/6. م.م.م(3,6)=6 : 4/6 + 1/6 = ؟ اختزل. (مثال: 5/6)",
      fa: "2/3 + 1/6 را حساب کنید. م.م.م(3,6)=6: 4/6 + 1/6 = ؟ ساده کنید. (مثال: 5/6)",
      pt: "Calcule 2/3 + 1/6. MMC(3,6)=6: 4/6 + 1/6 = ? Simplifique. (ex: 5/6)",
      so: "Xisaabi 2/3 + 1/6. MMC(3,6)=6: 4/6 + 1/6 = ? Fududee. (tusaale: 5/6)",
      ti: "2/3 + 1/6 ሒሳብ ግበር። ሓ.ሓ.ሓ(3,6)=6: 4/6 + 1/6 = ? ቀሊል ግበሮ። (ኣብነት፡ 5/6)",
      tr: "2/3 + 1/6 hesaplayın. OBEK(3,6)=6: 4/6 + 1/6 = ? Sadeleştirin. (örn: 5/6)",
      ps: "2/3 + 1/6 حساب کړئ. م.م.م(3,6)=6: 4/6 + 1/6 = ؟ ساده کړئ. (بېلګه: 5/6)",
      uk: "Обчисліть 2/3 + 1/6. НСК(3,6)=6: 4/6 + 1/6 = ? Спростіть. (напр.: 5/6)" },
    "a4-4-ep07": { fr: "Calculez 7/8 − 3/8. (ex: 1/2)", en: "Calculate 7/8 − 3/8. (e.g. 1/2)",
      ar: "احسب 7/8 − 3/8. (مثال: 1/2)",
      fa: "7/8 − 3/8 را حساب کنید. (مثال: 1/2)",
      pt: "Calcule 7/8 − 3/8. (ex: 1/2)",
      so: "Xisaabi 7/8 − 3/8. (tusaale: 1/2)",
      ti: "7/8 − 3/8 ሒሳብ ግበር። (ኣብነት፡ 1/2)",
      tr: "7/8 − 3/8 hesaplayın. (örn: 1/2)",
      ps: "7/8 − 3/8 حساب کړئ. (بېلګه: 1/2)",
      uk: "Обчисліть 7/8 − 3/8. (напр.: 1/2)" },
    "a4-4-ep08": { fr: "Calculez 1/4 + 1/4 + 1/4. (ex: 3/4)", en: "Calculate 1/4 + 1/4 + 1/4. (e.g. 3/4)",
      ar: "احسب 1/4 + 1/4 + 1/4. (مثال: 3/4)",
      fa: "1/4 + 1/4 + 1/4 را حساب کنید. (مثال: 3/4)",
      pt: "Calcule 1/4 + 1/4 + 1/4. (ex: 3/4)",
      so: "Xisaabi 1/4 + 1/4 + 1/4. (tusaale: 3/4)",
      ti: "1/4 + 1/4 + 1/4 ሒሳብ ግበር። (ኣብነት፡ 3/4)",
      tr: "1/4 + 1/4 + 1/4 hesaplayın. (örn: 3/4)",
      ps: "1/4 + 1/4 + 1/4 حساب کړئ. (بېلګه: 3/4)",
      uk: "Обчисліть 1/4 + 1/4 + 1/4. (напр.: 3/4)" },
    "a4-4-ep09": { fr: "Calculez 5/6 − 1/3. PPCM(6,3)=6 : 5/6 − 2/6 = ? (ex: 3/6 ou 1/2)", en: "Calculate 5/6 − 1/3. LCM(6,3)=6: 5/6 − 2/6 = ? (e.g. 3/6 or 1/2)",
      ar: "احسب 5/6 − 1/3. م.م.م(6,3)=6 : 5/6 − 2/6 = ؟ (مثال: 3/6 أو 1/2)",
      fa: "5/6 − 1/3 را حساب کنید. م.م.م(6,3)=6: 5/6 − 2/6 = ؟ (مثال: 3/6 یا 1/2)",
      pt: "Calcule 5/6 − 1/3. MMC(6,3)=6: 5/6 − 2/6 = ? (ex: 3/6 ou 1/2)",
      so: "Xisaabi 5/6 − 1/3. MMC(6,3)=6: 5/6 − 2/6 = ? (tusaale: 3/6 ama 1/2)",
      ti: "5/6 − 1/3 ሒሳብ ግበር። ሓ.ሓ.ሓ(6,3)=6: 5/6 − 2/6 = ? (ኣብነት፡ 3/6 ወይ 1/2)",
      tr: "5/6 − 1/3 hesaplayın. OBEK(6,3)=6: 5/6 − 2/6 = ? (örn: 3/6 veya 1/2)",
      ps: "5/6 − 1/3 حساب کړئ. م.م.م(6,3)=6: 5/6 − 2/6 = ؟ (بېلګه: 3/6 یا 1/2)",
      uk: "Обчисліть 5/6 − 1/3. НСК(6,3)=6: 5/6 − 2/6 = ? (напр.: 3/6 або 1/2)" },
    "a4-4-ep10": { fr: "Calculez 1/2 + 1/4. PPCM(2,4)=4 : 2/4 + 1/4 = ? (ex: 3/4)", en: "Calculate 1/2 + 1/4. LCM(2,4)=4: 2/4 + 1/4 = ? (e.g. 3/4)",
      ar: "احسب 1/2 + 1/4. م.م.م(2,4)=4 : 2/4 + 1/4 = ؟ (مثال: 3/4)",
      fa: "1/2 + 1/4 را حساب کنید. م.م.م(2,4)=4: 2/4 + 1/4 = ؟ (مثال: 3/4)",
      pt: "Calcule 1/2 + 1/4. MMC(2,4)=4: 2/4 + 1/4 = ? (ex: 3/4)",
      so: "Xisaabi 1/2 + 1/4. MMC(2,4)=4: 2/4 + 1/4 = ? (tusaale: 3/4)",
      ti: "1/2 + 1/4 ሒሳብ ግበር። ሓ.ሓ.ሓ(2,4)=4: 2/4 + 1/4 = ? (ኣብነት፡ 3/4)",
      tr: "1/2 + 1/4 hesaplayın. OBEK(2,4)=4: 2/4 + 1/4 = ? (örn: 3/4)",
      ps: "1/2 + 1/4 حساب کړئ. م.م.م(2,4)=4: 2/4 + 1/4 = ؟ (بېلګه: 3/4)",
      uk: "Обчисліть 1/2 + 1/4. НСК(2,4)=4: 2/4 + 1/4 = ? (напр.: 3/4)" },
  },
};
