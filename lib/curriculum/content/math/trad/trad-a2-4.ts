...
export const TRAD_A2_4: SubmoduleTrad = {
  ...
  blocks: [
    ...
    { label: { en: "Problem:" }, items: { en: ["Ali has 5 apples.", "Sophie has 3 more apples than Ali.", "How many apples does Sophie have?"] } },
    ...
    { label: { en: "Problem:" }, items: { en: ["Ali has 5 more apples than Sophie.", "Ali has 12 apples.", "How many apples does Sophie have?"] } },
    ...
    { label: { en: "Problem:" }, items: { en: ["Ali has 10 apples.", "Sophie has 4 fewer apples than Ali.", "How many apples does Sophie have?"] } },
    ...
    { label: { en: "Problem:" }, items: { en: ["Ali has 4 fewer apples than Sophie.", "Ali has 6 apples.", "How many apples does Sophie have?"] } },
    ...
    { text: { en: "Common verbs and expressions" } },
    {
      label: { en: "Often add" },
      items: { en: [
        "**receive**", "**win**", "**add**", "**buy more**", "**increase**",
        "**in addition**", "**more**", "**total**", "**in all**", "**together**",
      ] },
    },
    {
      label: { en: "Often subtract" },
      items: { en: [
        "**lose**", "**spend**", "**give**", "**take away**", "**remove**",
        "**sell**", "**decrease**", "**there remains**", "**less**", "**difference**",
      ] },
    },
    { text: { en: "Careful: the words **more than** and **less than** are not enough. Always ask: **does the person I am looking for have more or less?**" } },
  ...
  consignes: {
    wordProblems: {
      ...
      ps: "مسئلې حل کړه. يوازې عددي ځواب وليکه.",
