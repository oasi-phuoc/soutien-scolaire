...
export const TRAD_A4_7: SubmoduleTrad = {
  ...
  consignes: {
    "a4-7-ep01": { fr: "Convertissez 1/2 en nombre décimal. (ex: 0.5)", en: "Convert 1/2 to a decimal number. (e.g. 0.5)",
      ar: "حوّل 1/2 إلى عدد عشري. (مثال: 0.5)",
      fa: "1/2 را به عدد اعشاری تبدیل کنید. (مثال: 0.5)",
      pt: "Converta 1/2 para número decimal. (ex: 0.5)",
      so: "U rog 1/2 tiro tobanle. (tusaale: 0.5)",
      ti: "1/2 ናብ ዲሲማል ቁጽሪ ቀይሮ። (ኣብነት፡ 0.5)",
      tr: "1/2'yi ondalık sayıya çevirin. (örn: 0.5)",
      ps: "1/2 اعشاري عدد ته واړوئ. (بېلګه: 0.5)",
      uk: "Перетворіть 1/2 на десятковий дріб. (напр.: 0.5)" },
    "a4-7-ep02": { fr: "Convertissez 1/4 en nombre décimal. (ex: 0.25)", en: "Convert 1/4 to a decimal number. (e.g. 0.25)",
      ar: "حوّل 1/4 إلى عدد عشري. (مثال: 0.25)",
      fa: "1/4 را به عدد اعشاری تبدیل کنید. (مثال: 0.25)",
      pt: "Converta 1/4 para número decimal. (ex: 0.25)",
      so: "U rог 1/4 tiro tobanle. (tusaale: 0.25)",
      ti: "1/4 ናብ ዲሲማል ቁጽሪ ቀይሮ። (ኣብነት፡ 0.25)",
      tr: "1/4'ü ondalık sayıya çevirin. (örn: 0.25)",
      ps: "1/4 اعشاري عدد ته واړوئ. (بېلګه: 0.25)",
      uk: "Перетворіть 1/4 на десятковий дріб. (напр.: 0.25)" },
    "a4-7-ep03": { fr: "Convertissez 3/4 en nombre décimal. (ex: 0.75)", en: "Convert 3/4 to a decimal number. (e.g. 0.75)",
      ar: "حوّل 3/4 إلى عدد عشري. (مثال: 0.75)",
      fa: "3/4 را به عدد اعشاری تبدیل کنید. (مثال: 0.75)",
      pt: "Converta 3/4 para número decimal. (ex: 0.75)",
      so: "U rог 3/4 tiro tobanle. (tusaale: 0.75)",
      ti: "3/4 ናብ ዲሲማል ቁጽሪ ቀይሮ። (ኣብነት፡ 0.75)",
      tr: "3/4'ü ondalık sayıya çevirin. (örn: 0.75)",
      ps: "3/4 اعشاري عدد ته واړوئ. (بېلګه: 0.75)",
      uk: "Перетворіть 3/4 на десятковий дріб. (напр.: 0.75)" },
    "a4-7-ep04": { fr: "Convertissez 3/10 en nombre décimal. (ex: 0.3)", en: "Convert 3/10 to a decimal number. (e.g. 0.3)",
      ar: "حوّل 3/10 إلى عدد عشري. (مثال: 0.3)",
      fa: "3/10 را به عدد اعشاری تبدیل کنید. (مثال: 0.3)",
      pt: "Converta 3/10 para número decimal. (ex: 0.3)",
      so: "U rог 3/10 tiro tobanle. (tusaale: 0.3)",
      ti: "3/10 ናብ ዲሲማል ቁጽሪ ቀይሮ። (ኣብነት፡ 0.3)",
      tr: "3/10'u ondalık sayıya çevirin. (örn: 0.3)",
      ps: "3/10 اعشاري عدد ته واړوئ. (بېلګه: 0.3)",
      uk: "Перетворіть 3/10 на десятковий дріб. (напр.: 0.3)" },
    "a4-7-ep05": { fr: "Convertissez 7/100 en nombre décimal. (ex: 0.07)", en: "Convert 7/100 to a decimal number. (e.g. 0.07)",
      ar: "حوّل 7/100 إلى عدد عشري. (مثال: 0.07)",
      fa: "7/100 را به عدد اعشاری تبدیل کنید. (مثال: 0.07)",
      pt: "Converta 7/100 para número decimal. (ex: 0.07)",
      so: "U rог 7/100 tiro tobanle. (tusaale: 0.07)",
      ti: "7/100 ናብ ዲሲማል ቁጽሪ ቀይሮ። (ኣብነት፡ 0.07)",
      tr: "7/100'ü ondalık sayıya çevirin. (örn: 0.07)",
      ps: "7/100 اعشاري عدد ته واړوئ. (بېلګه: 0.07)",
      uk: "Перетворіть 7/100 на десятковий дріб. (напр.: 0.07)" },
    "a4-7-ep06": { fr: "Convertissez 0.6 en fraction décimale (sur 10). (ex: 6/10)", en: "Convert 0.6 to a decimal fraction (over 10). (e.g. 6/10)",
      ar: "حوّل 0.6 إلى كسر عشري (من 10). (مثال: 6/10)",
      fa: "0.6 را به کسر اعشاری (از 10) تبدیل کنید. (مثال: 6/10)",
      pt: "Converta 0.6 para fração decimal (sobre 10). (ex: 6/10)",
      so: "U rог 0.6 jajab tobanle (ka 10). (tusaale: 6/10)",
      ti: "0.6 ናብ ዲሲማል ፍርቂ (ካብ 10) ቀይሮ። (ኣብነት፡ 6/10)",
      tr: "0.6'yı ondalık kesre (10 üzerinden) çevirin. (örn: 6/10)",
      ps: "0.6 د (10 پر) اعشاري کسر ته واړوئ. (بېلګه: 6/10)",
      uk: "Перетворіть 0.6 на десятковий дріб (із знаменником 10). (напр.: 6/10)" },
    "a4-7-ep07": { fr: "Convertissez 0.25 en fraction (sur 100, puis simplifiez). (ex: 1/4)", en: "Convert 0.25 to a fraction (over 100, then simplify). (e.g. 1/4)",
      ar: "حوّل 0.25 إلى كسر (من 100، ثم اختزل). (مثال: 1/4)",
      fa: "0.25 را به کسر (از 100، سپس ساده کنید) تبدیل کنید. (مثال: 1/4)",
      pt: "Converta 0.25 para fração (sobre 100, depois simplifique). (ex: 1/4)",
      so: "U rог 0.25 jajab (ka 100, ka dibna fududee). (tusaale: 1/4)",
      ti: "0.25 ናብ ፍርቂ (ካብ 100, ቀጺሉ ቀሊል ግበሮ) ቀይሮ። (ኣብነት፡ 1/4)",
      tr: "0.25'i kesre çevirin (100 üzerinden, sonra sadeleştirin). (örn: 1/4)",
      ps: "0.25 کسر ته واړوئ (د 100 پر، بیا ساده کړئ). (بېلګه: 1/4)",
      uk: "Перетворіть 0.25 на дріб (зі знаменником 100, потім спростіть). (напр.: 1/4)" },
    "a4-7-ep08": { fr: "1/5 = ? décimal. (ex: 0.2)", en: "1/5 = ? as a decimal. (e.g. 0.2)",
      ar: "1/5 = ؟ كعدد عشري. (مثال: 0.2)",
      fa: "1/5 = ؟ به صورت اعشاری. (مثال: 0.2)",
      pt: "1/5 = ? como decimal. (ex: 0.2)",
      so: "1/5 = ? sidii tiro tobanle. (tusaale: 0.2)",
      ti: "1/5 = ? ከም ዲሲማል። (ኣብነት፡ 0.2)",
      tr: "1/5 = ? ondalık olarak. (örn: 0.2)",
      ps: "1/5 = ? د اعشاري بڼه. (بېلګه: 0.2)",
      uk: "1/5 = ? як десятковий дріб. (напр.: 0.2)" },
    "a4-7-ep09": { fr: "Convertissez 0.8 en fraction simplifiée. (ex: 4/5)", en: "Convert 0.8 to a simplified fraction. (e.g. 4/5)",
      ar: "حوّل 0.8 إلى كسر مختزل. (مثال: 4/5)",
      fa: "0.8 را به کسر ساده‌شده تبدیل کنید. (مثال: 4/5)",
      pt: "Converta 0.8 para uma fração simplificada. (ex: 4/5)",
      so: "U rог 0.8 jajab la fududeeyay. (tusaale: 4/5)",
      ti: "0.8 ናብ ዝቐለለ ፍርቂ ቀይሮ። (ኣብነት፡ 4/5)",
      tr: "0.8'i sadeleştirilmiş kesre çevirin. (örn: 4/5)",
      ps: "0.8 ساده شوي کسر ته واړوئ. (بېلګه: 4/5)",
      uk: "Перетворіть 0.8 на спрощений дріб. (напр.: 4/5)" },
    "a4-7-ep10": { fr: "Convertissez 2/5 en nombre décimal. (ex: 0.4)", en: "Convert 2/5 to a decimal number. (e.g. 0.4)",
      ar: "حوّل 2/5 إلى عدد عشري. (مثال: 0.4)",
      fa: "2/5 را به عدد اعشاری تبدیل کنید. (مثال: 0.4)",
      pt: "Converta 2/5 para número decimal. (ex: 0.4)",
      so: "U rог 2/5 tiro tobanle. (tusaale: 0.4)",
      ti: "2/5 ናብ ዲሲማል ቁጽሪ ቀይሮ። (ኣብነት፡ 0.4)",
      tr: "2/5'i ondalık sayıya çevirin. (örn: 0.4)",
      ps: "2/5 اعشاري عدد ته واړوئ. (بېلګه: 0.4)",
      uk: "Перетворіть 2/5 на десятковий дріб. (напр.: 0.4)" },
  },
};
