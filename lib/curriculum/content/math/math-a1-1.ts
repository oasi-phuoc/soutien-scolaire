  ...
  exercises: [
    {
      ...
      promptPivot: {
        ...
        ti: "ብቑጽሪ ጽሓፍ፡ ሰለስተ ሚእቲ ኣርብዓን ሸውዓተን።",
        pt: "Escreve em números: trezentos e quarenta e sete.",
      },
...

    {
      ...
      promptPivot: {
        ...
        ti: "ብፈረንሳይ ብሓደ ቃል ጽሓፍ፡ 508",
        pt: "Escreve por extenso em francês (numa só palavra): 508",
      },
...

    {
      ...
      promptPivot: {
        ...
        ti: "ኣብ 60 ክንደይ ሓደታት ኣለዉ?",
        pt: "Quantas unidades existem em 60?",
      },
...

    {
      ...
      promptFr:
        "Quel est le plus grand : 892 ou 928 ? (écris le nombre gagnant)",
      ...
      promptPivot: {
        ...
        ti: "ኣየናይ ይዓቢ፡ 892 ወይ 928? (እቲ ዝዓበየ ቁጽሪ ጽሓፍ)",
        pt: "Qual é maior: 892 ou 928? (escreve o número maior)",
      },
