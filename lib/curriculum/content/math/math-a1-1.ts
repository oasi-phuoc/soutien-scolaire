  ...
  theory: {
    ...
    paragraphs: {
      ...
      pt: [
        ...
        "Na Suíça romanda, usa-se frequentemente septante, huitante e nonante para 70, 80 e 90.",
      ],
    },
    readAloud: {
  ...
  exercises: [
    ...
    },
    {
      ...
      promptPivot: {
        ...
        pt: "Escreve por extenso (uma única palavra em francês): 508",
      },
      type: "short_text",
