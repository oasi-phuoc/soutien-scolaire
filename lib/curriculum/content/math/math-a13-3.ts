...
export const MATH_A13_3_LESSON: MathSubmoduleLesson = {
    ...
    exercises: [],
    exercisePool: [
      { id: "a13-3-ep01", promptFr: "Sur la droite f(x) = 2x + 1, quelle est l'ordonnée du point d'abscisse 3 ?", type: "number", acceptable: ["7"] },
      { id: "a13-3-ep02", promptFr: "Sur la droite f(x) = x − 2, quelle est l'ordonnée du point d'abscisse 5 ?", type: "number", acceptable: ["3"] },
      { id: "a13-3-ep03", promptFr: "Sur la droite f(x) = 3x, quelle est l'ordonnée du point d'abscisse 4 ?", type: "number", acceptable: ["12"] },
      { id: "a13-3-ep04", promptFr: "Sur la droite f(x) = −x + 4, quelle est l'ordonnée du point d'abscisse 2 ?", type: "number", acceptable: ["2"] },
      { id: "a13-3-ep05", promptFr: "Quelle est l'abscisse du point (3 ; 7) ?", type: "number", acceptable: ["3"] },
      { id: "a13-3-ep06", promptFr: "Quelle est l'ordonnée du point (3 ; 7) ?", type: "number", acceptable: ["7"] },
      { id: "a13-3-ep07", promptFr: "Sur la droite f(x) = 2x − 3, quelle est l'ordonnée du point d'abscisse 4 ?", type: "number", acceptable: ["5"] },
      { id: "a13-3-ep08", promptFr: "Sur la droite f(x) = x + 6, quelle est l'ordonnée du point d'abscisse −2 ?", type: "number", acceptable: ["4"] },
      { id: "a13-3-ep09", promptFr: "Sur la droite f(x) = 4x − 1, quelle est l'ordonnée du point d'abscisse 2 ?", type: "number", acceptable: ["7"] },
      { id: "a13-3-ep10", promptFr: "Sur la droite f(x) = −2x + 5, quelle est l'ordonnée du point d'abscisse 3 ?", type: "number", acceptable: ["-1"] },
    ],
    poolSize: 5,
  };
