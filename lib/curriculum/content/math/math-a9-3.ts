...
export const MATH_A9_3_LESSON: MathSubmoduleLesson = {
    ...
    exercises: [],
    exercisePool: [
      { id: "a9-3-ep01", promptFr: "Évalue 2x + 3 pour x = 4.", type: "number", acceptable: ["11"] },
      { id: "a9-3-ep02", promptFr: "Évalue 3x − 5 pour x = 3.", type: "number", acceptable: ["4"] },
      { id: "a9-3-ep03", promptFr: "Évalue x² − 2 pour x = 5.", type: "number", acceptable: ["23"] },
      { id: "a9-3-ep04", promptFr: "Évalue 4a + 2 pour a = 3.", type: "number", acceptable: ["14"] },
      { id: "a9-3-ep05", promptFr: "Évalue 2x² pour x = 3.", type: "number", acceptable: ["18"] },
      { id: "a9-3-ep06", promptFr: "Évalue 5n − n² pour n = 3.", type: "number", acceptable: ["6"] },
      { id: "a9-3-ep07", promptFr: "Évalue x³ pour x = 2.", type: "number", acceptable: ["8"] },
      { id: "a9-3-ep08", promptFr: "Évalue 10 − 3x pour x = 2.", type: "number", acceptable: ["4"] },
      { id: "a9-3-ep09", promptFr: "Évalue 3x + 2y pour x = 2, y = 4.", type: "number", acceptable: ["14"] },
      { id: "a9-3-ep10", promptFr: "Évalue (x + 1)² pour x = 3.", type: "number", acceptable: ["16"] },
    ],
    poolSize: 5,
  };
