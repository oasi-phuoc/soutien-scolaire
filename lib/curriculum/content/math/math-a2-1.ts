...
export const MATH_A2_1_LESSON: MathSubmoduleLesson = {
    ...
    theory: {
      ...
      blocks: [
        ...
        { type: "svg_row", items: [
          { markup: `<svg viewBox="0 0 170 88" width="100%" xmlns="http://www.w3.org/2000/svg"><defs><marker id="arr-comm1" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><polygon points="0 0,7 3.5,0 7" fill="#60a5fa"/></marker></defs><text x="30" y="27" text-anchor="middle" font-size="20" font-weight="bold" fill="#f97316">57</text><text x="85" y="27" text-anchor="middle" font-size="17" font-weight="bold" fill="#374151">+</text><text x="140" y="27" text-anchor="middle" font-size="20" font-weight="bold" fill="#f97316">49</text><line x1="42" y1="35" x2="79" y2="63" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-comm1)"/><line x1="128" y1="35" x2="91" y2="63" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-comm1)"/><text x="85" y="83" text-anchor="middle" font-size="20" font-weight="bold" fill="#16a34a">106</text></svg>`, captionFr: "57 + 49 = 106" },
          { markup: `<svg viewBox="0 0 170 88" width="100%" xmlns="http://www.w3.org/2000/svg"><defs><marker id="arr-comm2" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><polygon points="0 0,7 3.5,0 7" fill="#60a5fa"/></marker></defs><text x="30" y="27" text-anchor="middle" font-size="20" font-weight="bold" fill="#f97316">49</text><text x="85" y="27" text-anchor="middle" font-size="17" font-weight="bold" fill="#374151">+</text><text x="140" y="27" text-anchor="middle" font-size="20" font-weight="bold" fill="#f97316">57</text><line x1="42" y1="35" x2="79" y2="63" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-comm2)"/><line x1="128" y1="35" x2="91" y2="63" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-comm2)"/><text x="85" y="83" text-anchor="middle" font-size="20" font-weight="bold" fill="#16a34a">106</text></svg>`, captionFr: "49 + 57 = 106" },
        ] },
        ...
        { type: "svg_row", items: [
          { markup: `<svg viewBox="0 0 190 128" width="100%" xmlns="http://www.w3.org/2000/svg"><defs><marker id="arr-assoc1" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><polygon points="0 0,7 3.5,0 7" fill="#60a5fa"/></marker></defs><text x="18" y="22" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">15</text><text x="50" y="22" text-anchor="middle" font-size="15" font-weight="bold" fill="#374151">+</text><text x="80" y="22" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">37</text><text x="112" y="22" text-anchor="middle" font-size="15" font-weight="bold" fill="#374151">+</text><text x="158" y="22" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">22</text><line x1="25" y1="28" x2="51" y2="55" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc1)"/><line x1="77" y1="28" x2="63" y2="55" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc1)"/><text x="56" y="72" text-anchor="middle" font-size="18" font-weight="bold" fill="#16a34a">52</text><text x="92" y="72" text-anchor="middle" font-size="15" font-weight="bold" fill="#374151">+</text><text x="128" y="72" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">22</text><line x1="64" y1="78" x2="87" y2="105" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc1)"/><line x1="120" y1="78" x2="97" y2="105" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc1)"/><text x="92" y="122" text-anchor="middle" font-size="18" font-weight="bold" fill="#16a34a">74</text></svg>`, captionFr: "(15 + 37) + 22 = 74" },
          { markup: `<svg viewBox="0 0 190 128" width="100%" xmlns="http://www.w3.org/2000/svg"><defs><marker id="arr-assoc2" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><polygon points="0 0,7 3.5,0 7" fill="#60a5fa"/></marker></defs><text x="18" y="22" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">15</text><text x="50" y="22" text-anchor="middle" font-size="15" font-weight="bold" fill="#374151">+</text><text x="80" y="22" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">37</text><text x="112" y="22" text-anchor="middle" font-size="15" font-weight="bold" fill="#374151">+</text><text x="158" y="22" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">22</text><line x1="88" y1="28" x2="114" y2="55" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc2)"/><line x1="151" y1="28" x2="128" y2="55" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc2)"/><text x="22" y="72" text-anchor="middle" font-size="18" font-weight="bold" fill="#f97316">15</text><text x="62" y="72" text-anchor="middle" font-size="15" font-weight="bold" fill="#374151">+</text><text x="120" y="72" text-anchor="middle" font-size="18" font-weight="bold" fill="#16a34a">59</text><line x1="30" y1="78" x2="83" y2="105" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc2)"/><line x1="112" y1="78" x2="99" y2="105" stroke="#60a5fa" stroke-width="2" marker-end="url(#arr-assoc2)"/><text x="92" y="122" text-anchor="middle" font-size="18" font-weight="bold" fill="#16a34a">74</text></svg>`, captionFr: "15 + (37 + 22) = 74" },
        ] },
