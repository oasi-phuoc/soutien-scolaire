...
export const MATH_A4_2_LESSON: MathSubmoduleLesson = {
    ...
    exercisePool: [
      ...
      { id: "a4-2-ep06", promptFr: "Complétez : 1/2 = ?/6. Quelle est la valeur de ? ?", type: "number", acceptable: ["3"], hintFr: "Trouve le PGCD du numérateur et du dénominateur, puis divise les deux par ce nombre."},
      { id: "a4-2-ep07", promptFr: "Complétez : 3/4 = ?/12. Quelle est la valeur de ? ?", type: "number", acceptable: ["9"], hintFr: "Trouve le PGCD du numérateur et du dénominateur, puis divise les deux par ce nombre."},
      ...
      { id: "a4-2-ep10", promptFr: "Complétez : 2/5 = ?/10. Quelle est la valeur de ? ?", type: "number", acceptable: ["4"], hintFr: "Trouve le PGCD du numérateur et du dénominateur, puis divise les deux par ce nombre."},
    ],
    poolSize: 5,
  };