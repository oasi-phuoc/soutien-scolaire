...
export const MATH_A1_5_LESSON: MathSubmoduleLesson = {
    ...
    theory: {
      ...
      blocks: [
        ...
        { type: "highlight", fr: "Suite croissante", pivot: { en: "Increasing sequence", ar: "متتالية تصاعدية", fa: "دنباله صعودی", ti: "ዝዓቢ ተኸታታሊ", uk: "Зростаюча послідовність", pt: "Sequência crescente" } },
        { type: "section", labelFr: "", itemsFr: [
          "Les nombres augmentent.",
          "Exemple : 1 ; 3 ; 5 ; 7",
        ] },
        { type: "highlight", fr: "Suite décroissante", pivot: { en: "Decreasing sequence", ar: "متتالية تنازلية", fa: "دنباله نزولی", ti: "ዝነኪ ተኸታታሊ", uk: "Спадна послідовність", pt: "Sequência décroissante" } },
        { type: "section", labelFr: "", itemsFr: [
      ...
      paragraphs: {
        ...
        pt: [
          "Uma **sequência numérica** é uma lista ordenada onde cada termo é obtido aplicando a mesma regra.",
          "Para encontrar a regra, calcula a diferença entre dois termos consecutivos — esse é o **passo**.",
    ...
    exercises: [
      {
        ...
        promptPivot: { en: "Sequence: 3, 6, 9, 12, ? (write the next term)", pt: "Sequência: 3, 6, 9, 12, ? (escreve o próximo termo)" },
        type: "number",
        acceptable: ["15"],
      },
      {
        ...
        promptPivot: { en: "Sequence: 50, 45, 40, 35, ?", pt: "Sequência: 50, 45, 40, 35, ?" },
        type: "number",
        acceptable: ["30"],
      },
      {
        ...
        promptPivot: { en: "Sequence: 100, 200, 300, 400, ?", pt: "Sequência: 100, 200, 300, 400, ?" },
        type: "number",
        acceptable: ["500"],
      },
    ],
