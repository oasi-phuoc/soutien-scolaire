...
export const MATH_A3_5_LESSON: MathSubmoduleLesson = {
  ...
  exercisePool: [
    ...
    { id: "a3-5-ep32", promptFr: "Exercice 10 — Pair ou impair\nDonne le 5ème multiple impair de 3. (3, 9, 15, 21, ___)", type: "number", acceptable: ["27"] },

    // Exercice 11 — Divisible ou non
    { id: "a3-5-ep33", promptFr: "Exercice 11 — Divisible ou non\n45 est-il divisible par 3 ? (somme des chiffres : 4+5=9) (oui/non)", type: "short_text", acceptable: ["oui", "Oui", "OUI"] },
    ...
    { id: "a3-5-ep36", promptFr: "Exercice 11 — Divisible ou non\n92 est-il divisible par 3 ? (somme : 9+2=11) (oui/non)", type: "short_text", acceptable: ["non", "Non", "NON"] },
    ...
    { id: "a3-5-ep39", promptFr: "Exercice 12 — Règles de divisibilité\n123 est divisible par 3. La somme de ses chiffres est 1+2+3=___.", type: "number", acceptable: ["6"] },
    ...
    { id: "a3-5-ep42", promptFr: "Exercice 13 — Chiffre manquant\nQuel chiffre remplace _ pour que 15_ soit divisible par 3 ? (somme divisible par 3 : 1+5+_)", type: "short_text", acceptable: ["0", "3", "6", "9"] },

    // Exercice 14 — Trouver un nombre (devinettes)
    { id: "a3-5-ep43", promptFr: "Exercice 14 — Trouver un nombre\nJe suis multiple de 4 et de 5. Je suis plus petit que 50. Qui suis-je ? (le plus petit tel nombre, autre que 0)", type: "number", acceptable: ["20"] },
    { id: "a3-5-ep44", promptFr: "Exercice 14 — Trouver un nombre\nJe suis divisible par 3 et par 2. Je suis plus petit que 15. Qui suis-je ? (le plus petit tel nombre, autre que 0)", type: "number", acceptable: ["6"] },
    { id: "a3-5-ep45", promptFr: "Exercice 14 — Trouver un nombre\nJe suis un diviseur de 36. Je suis supérieur à 12 et inférieur à 36. Qui suis-je ? (le plus petit)", type: "number", acceptable: ["18"] },

    // Exercice 15 — Intrus
    { id: "a3-5-ep46", promptFr: "Exercice 15 — Trouver l'intrus\nDans la suite 6, 12, 18, 25, 30 : quel est l'intrus ? (nombre non multiple de 6)", type: "number", acceptable: ["25"] },
    { id: "a3-5-ep47", promptFr: "Exercice 15 — Trouver l'intrus\nDans la suite 5, 10, 15, 21, 25 : quel est l'intrus ? (nombre non multiple de 5)", type: "number", acceptable: ["21"] },
