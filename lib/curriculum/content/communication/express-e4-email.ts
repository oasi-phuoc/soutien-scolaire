...
Merci de répondre en indiquant quels vêtements il doit prendre et pourquoi.
Office du tourisme`,
    },
    instruction: "Répondez à l'office du tourisme pour l'inviter à un week-end à la montagne. Expliquez quels vêtements il doit prendre et pourquoi.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous collectons des vêtements propres et en bon état cette semaine.
Merci pour votre aide`,
    },
    instruction: "Répondez à la Croix-Rouge pour proposer des vêtements et des accessoires. Décrivez les articles, les tailles, l'état et le moment possible pour les apporter.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Salut,
Je viens ce week-end. Quelle est la météo et quels vêtements je dois prendre ?
Tom`,
    },
    instruction: "Répondez à Tom pour le conseiller sur les vêtements du week-end. Conseillez des chaussures, une veste et un accessoire utile.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Pour lundi, venez avec une tenue correcte et confortable. N'hésitez pas si vous avez une question.
Merci de répondre en décrivant votre tenue et en posant une question sur les règles si nécessaire.
Cordialement`,
    },
    instruction: "Répondez au responsable en décrivant la tenue que vous porterez pour votre premier jour. Posez une question si une règle existe.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Votre commande est livree. Vous pouvez demander un échange sous quinze jours.
Cordialement`,
    },
    instruction: "Répondez à la boutique pour expliquer qu'un pantalon est trop grand. Demandez un échange et donnez la taille souhaitée.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Pour rechercher un objet perdu, merci d'envoyer une description précise.
Cordialement`,
    },
    instruction: "Répondez au service des objets trouvés pour décrire votre écharpe perdue. Donnez la couleur, la matière, le lieu et votre contact.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Répondez à l'association pour donner des vêtements d'enfant. Précisez les tailles, les saisons et l'état des articles.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Le modèle qui vous intéresse existe en plusieurs couleurs. Contactez-nous pour plus d'informations.
Merci de répondre avec vos questions sur la taille, la couleur disponible et la livraison.
Service client`,
    },
...
Cordialement`,
    ...
    instruction: "Répondez au coach pour décrire votre tenue de sport. Dites quels vêtements et accessoires vous avez déjà.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Ami`,
    ...
    instruction: "Répondez à votre ami pour expliquer quels vêtements vous prenez pour un voyage de deux jours. Justifiez votre choix avec la météo et les activités.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Ami`,
    ...
    instruction: "Répondez à votre ami pour décrire un sac oublie chez lui. Indiquez la couleur du sac et les vêtements à l'intérieur.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant quels articles apporter et où les déposer.
Cordialement`,
    },
    instruction: "Répondez à Responsable bureau pour organiser une collecte de vêtements. Expliquez quels articles apporter et où les déposer.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous pouvons vous aider à trouver un vêtement précis si vous nous envoyez une description.
Cordialement`,
    },
    instruction: "Répondez à la boutique pour décrire la veste que vous cherchez. Donnez la taille, la couleur, le prix souhaité et l'occasion.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant ce que vous aimez porter et ce que vous évitez.
Amie`,
    },
    instruction: "Répondez à votre amie en parlant de vos couleurs préfèrees pour les vêtements. Expliquez ce que vous aimez porter et ce que vous évitez.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en tenant compte des végétariens et en proposant une entrée, un plat, un dessert et une boisson.
L'équipe`,
    },
    instruction: "Répondez à l'équipe pour proposer un menu de repas. Mentionnez les végétariens et proposez une entrée, un plat, un dessert et une boisson.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Notre restaurant proposé ce soir une salade de chevre, un risotto aux legumes et une tarte aux pommes.
Merci de répondre en indiquant l'heure, l'adresse et une idée de plat végétarien.
Le restaurant`,
    },
    instruction: "Répondez à Aux bons Amis pour l'inviter à dîner au restaurant Aux bons Amis. Donnez l'heure, l'adresse et une idée de plat végétarien.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre avec la date, l'heure, le nombre de personnes et une demande d'option végétarienne.
Cordialement`,
    },
    instruction: "Répondez au restaurant pour réserver une table. Donnez la date, l'heure, le nombre de personnes et demandez une option végétarienne.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez au restaurant pour expliquer une allergie alimentaire. Demandez quels plats sont possibles et restez poli.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Bises`,
    ...
    instruction: "Répondez à votre famille pour proposer un restaurant pratique. Expliquez les plats possibles, le prix et pourquoi il convient aux enfants.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Notre terrasse est ouverte quand la météo est bonne. Les reservations sont possibles.
Merci de répondre en indiquant le nombre de personnes, l'heure et une demande sur le soleil ou l'ombre.
Cordialement`,
    },
    instruction: "Répondez au café pour demander une table en terrasse. Donnez le nombre de personnes, l'heure et une demande sur le soleil ou l'ombre.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant le nombre d'enfants et l'heure de votre venue.
Cordialement`,
    },
    instruction: "Répondez au restaurant pour demander s'il y a un menu enfant. Donnez le nombre d'enfants et l'heure de votre venue.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant l'heure, le prix approximatif et les préférences alimentaires.
A bientot`,
    },
    instruction: "Répondez à la classe pour proposer un restaurant après le cours. Mentionnez l'heure, le prix approximatif et les préférences alimentaires.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous espérons que votre repas s'est bien passé. Vos remarques sont importantes pour nous.
Merci de répondre en décrivant la situation et en demandant un geste commercial simple.
Cordialement`,
    },
    instruction: "Répondez au restaurant pour expliquer poliment que le service etait lent. Décrivez la situation et demandez un geste commercial simple.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Répondez au groupe pour présenter un repas dans un restaurant international. Demandez les préférences alimentaires et confirmez l'heure.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
A plus`,
    ...
    instruction: "Répondez à votre collègue pour proposer un déjeuner rapide. Donnez le nom du restaurant, l'heure et une formule simple.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant le lieu, l'heure, le type de cuisine et une raison de votre choix.
Le guide`,
    },
    instruction: "Répondez à Guide local pour l'inviter à dîner au restaurant. Donnez le lieu, l'heure, le type de cuisine et une raison de votre choix.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Ana`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous pouvons livrer des formules petit déjeuner pour les entreprises et les particuliers. Merci d'envoyer les détails de votre commande.
Cordialement`,
    },
    instruction: "Répondez à la boulangerie pour donner des précisions sur la livraison de votre petit déjeuner. Indiquez la formule, le nombre de personnes, l'heure et le jour.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Les commandes de pain peuvent être réservées par e-mail avant 16 h.
Merci de répondre en indiquant les quantités, l'heure de retrait et votre nom.
Cordialement`,
    },
    instruction: "Répondez à la boulangerie pour commander du pain pour un dîner. Donnez les quantités, l'heure de retrait et votre nom.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous faisons un petit déjeuner d'équipe vendredi. Peux-tu proposer une commande à la boulangerie ?
Merci`,
    },
...
Ami`,
    ...
    instruction: "Répondez à votre ami pour lui demander un sandwich sans beurre. Précisez le pain, la garniture, le dessert et la boisson.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    sourceMessage: {
      from: "Boulangerie Pâtisserie Claire",
      subject: "Gâteaux sur commande",
      body: `Bonjour,
Nous préparons des gâteaux d'anniversaire sur commande.
Pour organiser votre commande, merci de nous indiquer le nombre de personnes, le parfum souhaité, le texte sur le gâteau et l'heure de retrait.
Cordialement,
La boulangerie`,
    },
    instruction: "Répondez à la boulangerie pour commander votre gâteau d'anniversaire. Indiquez le nombre de personnes, le parfum, le texte sur le gâteau et l'heure de retrait.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Répondez à la boulangerie pour réserver des baguettes dimanche matin. Donnez la quantité, l'heure et votre nom.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous avons besoin d'un goûter simple pour les enfants mercredi après-midi.
Merci`,
    },
    instruction: "Répondez à Centre de loisirs pour commander un goûter pour des enfants. Précisez les pains au chocolat, les jus, les serviettes et l'heure.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Ana`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nos croissants et pains au chocolat sont disponibles sur réservation pour les grandes quantités.
Merci de répondre en indiquant le nombre souhaité.
Cordialement`,
    },
    instruction: "Répondez à la boulangerie pour demander le prix et la disponibilité de croissants pour demain matin. Donnez le nombre souhaité.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Ami`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Pour les commandes de groupe, merci de nous envoyer les produits et les quantités.
Cordialement`,
    },
    instruction: "Répondez à la boulangerie pour une commande familiale de déjeuner. Indiquez les choix de chacun, les quantités et l'heure de retrait.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant pour quel repas vous en avez besoin.
Cordialement`,
    },
    instruction: "Répondez à la boulangerie pour demander s'il y a du pain complet ou du pain aux céréales. Expliquez pour quel repas vous en avez besoin.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant le sandwich, le dessert, la boisson, votre nom et l'heure.
Cordialement`,
    },
    instruction: "Répondez à la boulangerie pour choisir une formule midi. Précisez le sandwich, le dessert, la boisson, votre nom et l'heure.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
La classe souhaité organiser un petit déjeuner vendredi matin. Il faut contacter la boulangerie.
Merci`,
    },
    instruction: "Répondez au secrétariat pour commander des viennoiseries pour une classe. Donnez le nombre d'élèves, les quantités et le moment de livraison.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez à la boulangerie pour demander si une commande tardive est encore possible. Expliquez la situation et donnez les produits souhaités.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      subject: "Votre avis",
      body: `Bonjour,
Merci pour votre commande de ce matin. Votre avis nous intéresse.
La boulangère`,
    },
    instruction: "Répondez à la boulangère pour donner votre avis sur la commande. Dites ce que vous avez aimé et quand vous pensez revenir.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez à la boulangerie avec une commande très précise. Donnez les produits, les quantités, le nom, l'heure de retrait et une demande particulière.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
