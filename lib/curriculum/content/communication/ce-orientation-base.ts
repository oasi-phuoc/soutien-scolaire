...
const MAP = (lieu: string): [string, string, string] => [
  `/assets/expression/images/ce/itineraire/ce-itineraire-${lieu}-trajet-a.webp`,
  `/assets/expression/images/ce/itineraire/ce-itineraire-${lieu}-trajet-b.webp`,
  `/assets/expression/images/ce/itineraire/ce-itineraire-${lieu}-trajet-c.webp`,
];
