...
const MAP = (id: string): [string, string, string] => [
  `/assets/expression/images/scene/${id}-a.webp`,
  `/assets/expression/images/scene/${id}-b.webp`,
  `/assets/expression/images/scene/${id}-c.webp`,
];
  ...
  },
  {
    ...
    pool: [
      ...
      ceQ(
        ...
        0,
        "Il faut le _________ par téléphone.",
        "contacter",
        ["appeler"],
      ),
    ],
  },
  {
    ...
    pool: [
      ...
      ceQ(
        ...
        ["Par téléphone", "Par courriel", "Par texto"],
        0,
        "Il faut la _________ par téléphone.",
        "contacter",
        ["appeler"],
      ),
    ],
