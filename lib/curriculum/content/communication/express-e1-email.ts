...
Lucas`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Notre première rencontre a lieu mardi à 18 h. Merci de nous envoyer quelques informations sur vous avant la réunion.
L'équipe Bonjour`,
    },
    instruction: "Répondez à l'association pour vous présenter et confirmer votre venue à la première rencontre.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Mme Durand`,
    ...
    instruction: "Répondez à cet e-mail pour vous présenter au responsable. Donnez votre identite, votre téléphone, votre disponibilité et une phrase sur votre expérience.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Claire`,
    ...
    instruction: "Répondez à cet e-mail en présentant votre ami Karim. Donnez son âge, sa ville, sa nationalité et une activité qu'il aime.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Merci pour votre intérêt. Pour finaliser l'inscription, envoyez une courte présentation.
Cordialement,
Le groupe`,
    },
    instruction: "Répondez au groupe pour vous présenter au groupe de conversation. Indiquez votre niveau de français, vos objectifs et vos disponibilités.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en vous présentant, en indiquant votre appartement et en proposant une rencontre.
A bientot,
Thomas`,
    },
...
Helene`,
    ...
    instruction: "Répondez à Helene avec une présentation de vous et de la personne qui vient avec vous.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Le secrétariat`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Je vois le nom de Sofia dans l'équipe, mais je ne la connais pas. Pouvez-vous me la présenter rapidement ?
Merci`,
    },
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous organisons un échange culturel vendredi. Chaque participant doit envoyer une petite présentation.
Merci de répondre en vous présentant et en proposant un thème simple de discussion.
Cordialement`,
    },
    instruction: "Répondez à la Maison des cultures pour participer à l'échange culturel. Présentez-vous et proposez un thème simple de discussion.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
L'équipe`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      subject: "Bienvenue",
      body: `Bonjour,
Bienvenue dans l'équipe Horizon. Envoyez-nous quelques lignes pour vous présenter à tous.
A bientot`,
    },
    instruction: "Répondez au message d'accueil de l'équipe. Présentez-vous, dites votre poste et ajoutez une phrase amicale.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Camille`,
    ...
    instruction: "Répondez à Camille pour décrire la photo de famille. Expliquez qui est sur la photo et ce que chaque personne aime faire.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Elise`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous aimerions connaitre un peu votre famille avant votre séjour chez nous.
Merci de répondre en parlant des parents, des frères et sœurs et des habitudes à la maison.
A bientot,
Famille Bernard`,
    },
    instruction: "Répondez à la famille Bernard pour présenter votre famille à votre future famille d'accueil. Parlez des parents, des frères et sœurs et des habitudes à la maison.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Sophie`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Nous préparons un article sur les familles et leurs animaux. Pouvez-vous nous présenter là votre ?
Merci`,
    },
    instruction: "Répondez à l'association en presentant votre famille et vos animaux. Dites qui s'occupe des animaux et comment ils s'appellent.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez à l'école pour le dossier scolaire de votre enfant.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre avec la date, l'heure, l'adresse et une demande pour apporter quelque chose.
Le syndic`,
    },
    instruction: "Répondez à Carnet d'adresses pour les inviter à un apéro. Donnez la date, l'heure, l'adresse et demandez d'apporter quelque chose.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Souhaitez-vous venir avec un collègue ?
Merci de nous répondre avec son nom et vos disponibilités.
Cordialement`,
    },
    instruction: "Répondez à l'atelier pour inscrire votre collègue au cours de cuisine proposé. Donnez son nom, confirmez l'heure et demandez s'il reste une place.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
  ...
  },
  {
    ...
    sourceMessage: {
      ...
      body: `Bonjour,
Dimanche, l'entrée au musée est gratuite de 10 h à 18 h.
Souhaitez-vous réserver une visite avec un ami ?
Merci de répondre avec la date, l'heure et le lieu de rendez-vous souhaités.
Le musée`,
    },
    instruction: "Répondez au musée pour organiser une visite avec un ami. Proposez une date, une heure et un lieu de rendez-vous.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Pouvez-vous proposer une soirée jeux aux voisins ?
Merci de répondre avec l'heure, le lieu et une demande simple pour les boissons.
Cordialement`,
    },
    instruction: "Répondez au conseil des voisins pour proposer une soirée jeux. Indiquez l'heure, le lieu et une demande simple pour les boissons.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre avec une heure et une activité pour les enfants.
A bientot`,
    },
    instruction: "Répondez à la famille Petit pour proposer une sortie au parc. Donnez une heure et proposez une activité pour les enfants.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Pouvez-vous proposer un apéro de bienvenue et préciser ce que chacun peut apporter ?
Le syndic`,
    },
    instruction: "Répondez au syndic pour proposer un apéro de bienvenue dans votre immeuble. Expliquez pourquoi vous l'organisez et ce que chacun peut apporter.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Emma`,
    ...
    instruction: "Répondez à Emma pour accepter le concert. Demandez le prix de la place et le lieu du rendez-vous.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre avec un restaurant, une heure et une demande de réponse avant midi.
L'équipe`,
    },
    instruction: "Répondez à l'équipe pour les inviter à déjeuner. Proposez un restaurant, une heure et demandez une réponse avant midi.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant un lieu, une date et une idée de nourriture à apporter.
Cordialement`,
    },
...
Merci de répondre en indiquant l'heure, le prix approximatif et les affaires à prendre.
La mairie`,
    },
    instruction: "Répondez à la piscine municipale pour l'inviter à la piscine. Donnez l'heure, le prix approximatif et les affaires à prendre.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci de répondre en indiquant le point de rendez-vous, l'heure et la durée prevue.
A bientot`,
    },
    instruction: "Répondez au groupe pour inviter tout le monde à une promenade dimanche. Donnez le point de rendez-vous, l'heure et la durée prevue.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
