...
export const EXPRESS_E13_2: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.13", title: "La négation (2/2)", href: "/francais/grammaire/a2-gr-l42" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E13_3: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.18", title: "Les relations logiques — Cause et conséquence", href: "/francais/grammaire/a2-gr-l52" },
    ]),
    {
      type: "plain",
