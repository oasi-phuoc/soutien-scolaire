...
export const EXPRESS_E13_1: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.36", title: "Les pronoms Y et EN", href: "/francais/grammaire/a2-gr-l36" },
    ]),
    {
      type: "plain",
  ...
  ceExercises: E13_1_CE,
  ceEmailExercises: E13_1_CE_EMAIL,
...
export const EXPRESS_E13_2: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.33", title: "La négation (2/2)", href: "/francais/grammaire/a2-gr-l42" },
    ]),
    {
      type: "plain",
  ...
  ceExercises: E13_2_CE,
  ceEmailExercises: E13_2_CE_EMAIL,
...
export const EXPRESS_E13_3: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.38", title: "Les relations logiques — Cause et conséquence", href: "/francais/grammaire/a2-gr-l52" },
    ]),
    {
      type: "plain",
  ...
  ceExercises: E13_3_CE,
  ceEmailExercises: E13_3_CE_EMAIL,
...
export const EXPRESS_E13_4: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.26", title: "Les questions fermées", href: "/francais/grammaire/a2-gr-l07" },
    ]),
    {
      type: "plain",
  ...
  ceExercises: E13_4_CE,
  ceEmailExercises: E13_4_CE_EMAIL,
...
export const EXPRESS_E13_5: CommunicationLesson = lessonFromListening({
  ...
  ceExercises: E13_5_CE,
  ceEmailExercises: E13_5_CE_EMAIL,
