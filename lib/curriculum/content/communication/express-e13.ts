...
export const EXPRESS_E13_1: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.12", title: "Les pronoms Y et EN", href: "/francais/grammaire/a2-gr-l36" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E13_2: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.9", title: "La négation (2/2)", href: "/francais/grammaire/a2-gr-l42" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E13_4: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.2", title: "Les questions fermées", href: "/francais/grammaire/a2-gr-l07" },
    ]),
    {
      type: "plain",
