...
export const EXPRESS_E13_1: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.51", title: "Les pronoms Y et EN", href: "/francais/grammaire/a2-gr-l36" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E13_2: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.48", title: "La négation (2/2)", href: "/francais/grammaire/a2-gr-l42" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E13_3: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.53", title: "Les relations logiques — Cause et conséquence", href: "/francais/grammaire/a2-gr-l52" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E13_4: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.41", title: "Les questions fermées", href: "/francais/grammaire/a2-gr-l07" },
    ]),
    {
      type: "plain",
