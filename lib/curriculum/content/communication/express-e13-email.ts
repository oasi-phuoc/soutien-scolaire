...
const E13_1_CE_EMAIL_2_POOL = buildExpressPool("e13-1-ce-email-2", [
  q({
    ...
    img: ["", "", ""],
    imgC: 0,
    fillQ: "Les informations concernent e-mail formation.",
    fill: "e-mail",
...
const E13_2_CE_EMAIL_2_POOL = buildExpressPool("e13-2-ce-email-2", [
  q({
    ...
    img: ["", "", ""],
    imgC: 0,
    fillQ: "Les informations concernent e-mail stage.",
    fill: "e-mail",
...
const E13_3_CE_EMAIL_2_POOL = buildExpressPool("e13-3-ce-email-2", [
  q({
    ...
    img: ["", "", ""],
    imgC: 0,
    fillQ: "Les informations concernent e-mail emploi.",
    fill: "e-mail",
...
const E13_4_CE_EMAIL_2_POOL = buildExpressPool("e13-4-ce-email-2", [
  q({
    ...
    img: ["", "", ""],
    imgC: 0,
    fillQ: "Les informations concernent e-mail entretien.",
    fill: "e-mail",
...
const E13_5_CE_EMAIL_2_POOL = buildExpressPool("e13-5-ce-email-2", [
  q({
    ...
    img: ["", "", ""],
    imgC: 0,
    fillQ: "Les informations concernent e-mail entreprise.",
    fill: "e-mail",
