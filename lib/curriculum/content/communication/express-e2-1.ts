...
import { E2_1_CE_EMAIL, E2_1_PE_EMAIL } from "./express-e2-email";
...
export const EXPRESS_E2_1: CommunicationLesson = {
  ...
  theory: [
    { type: "heading", text: "Décrire son logement", black: true, trans: t("Describing your home") },
    {
      ...
      items: [
        ...
        { code: "G1.10", title: "Articles", href: "/francais/grammaire/a1-gr-l04" }
      ],
    },
    {
      type: "plain",
  ...
  ceExercises: E2_1_CE,
  ceEmailExercises: E2_1_CE_EMAIL,
  poDialogues: E2_1_PO,
  pePrompts: E2_1_PE,
  peEmailPrompts: E2_1_PE_EMAIL,
};
