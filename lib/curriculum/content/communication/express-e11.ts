...
export const EXPRESS_E11_1: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.60", title: "Les marqueurs de temps", href: "/francais/grammaire/gr-marqueurs-temps-complet" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E11_2: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.58", title: "Les pronoms COD et COI", href: "/francais/grammaire/a2-gr-l35" },
    ]),
    {
      type: "plain",
...
export const EXPRESS_E11_4: CommunicationLesson = lessonFromListening({
  ...
  theory: [
    ...
    prereqItems([
      { code: "G4.69", title: "L'hypothèse sur le futur", href: "/francais/grammaire/a2-gr-hypothese-futur" },
    ]),
    {
      type: "plain",
