  ...
  },
{
  ...
  lines: [
    ...
    { role: "B", text: "Bonjour, je voudrais savoir comment faire pour comprendre le planning de la semaine." },
    { role: "A", text: "Bien sûr. Vous travaillez mardi et jeudi." },
    { role: "B", text: "D'accord. Est-ce qu'il faut réserver avant ?" },
    { role: "A", text: "Oui. La réunion est vendredi matin." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Bonjour, j'ai un problème : l'imprimante ne marche plus." },
    { role: "A", text: "Je comprends. Elle manque de papier." },
    { role: "B", text: "Merci. Est-ce possible de régler ça maintenant ?" },
    { role: "A", text: "Je vais chercher une ramette." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Oui, je voudrais parler avec la responsable." },
    { role: "A", text: "Je peux vous proposer lundi à 14 heures." },
    { role: "B", text: "Oui, ce créneau me convient." },
    { role: "A", text: "Je veux discuter des horaires." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Oui, je confirme la réunion d'équipe." },
    { role: "A", text: "Très bien. C'est bien demain à 9 heures ?" },
    { role: "B", text: "Oui, c'est exact." },
    { role: "A", text: "Parfait, c'est noté." },
    { role: "B", text: "J'apporte le dossier client." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Oui, j'hésite pour demander une formation interne." },
    { role: "A", text: "Écrivez à votre responsable." },
    { role: "B", text: "C'est vrai, mais je veux aussi quelque chose de pratique." },
    { role: "A", text: "Expliquez ce que vous voulez apprendre." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Bonjour, je vous préviens : j'arrive en retard au bureau." },
    { role: "A", text: "Merci de nous prévenir. Que se passe-t-il ?" },
    { role: "B", text: "Mon train est supprimé." },
    { role: "A", text: "D'accord, ce n'est pas grave." },
    { role: "B", text: "Je commence en visio depuis la gare." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Bonjour, je voudrais signaler un problème : mon badge ne fonctionne plus." },
    { role: "A", text: "Je suis désolé pour cela." },
    { role: "B", text: "Je reste bloqué à l'entrée." },
    { role: "A", text: "Je comprends. Quelle solution souhaitez-vous ?" },
    { role: "B", text: "Pouvez-vous appeler la sécurité ?" },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Oui, j'ai besoin d'aide pour remplacer un collègue malade." },
    { role: "A", text: "Il faut couvrir l'accueil ce matin." },
    { role: "B", text: "D'accord, je fais ça tout de suite." },
    { role: "A", text: "Je peux venir à 10 heures." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Oui, je compare travailler le matin ou l'après-midi." },
    { role: "A", text: "Le matin est plus calme." },
    { role: "B", text: "Et l'autre possibilité ?" },
    { role: "A", text: "L'après-midi convient mieux aux clients." },
...
},
{
  ...
  lines: [
    ...
    { role: "B", text: "Oui, je voulais vous remercier pour ton aide sur le rapport." },
    { role: "A", text: "C'est gentil, merci." },
    { role: "B", text: "J'ai fini avant la réunion." },
    { role: "A", text: "Je suis content que cela vous ait aidé." },
    { role: "B", text: "Je te dois un café." },
