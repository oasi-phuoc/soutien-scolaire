...
const RADIO_21 = buildPool("avance", "radio-21", [
  {
    id: "ar21-q1", textQ: "Émission radio 21 — Que faut-il faire pour bien répondre aux questions ?", text: ["Écouter attentivement l'émission","Lire sans écouter","Regarder une vidéo"], textC: 0,
    img: ["Écouter","Lire seul","Vidéo"], imgC: 0,
    fillQ: "Émission 21 — Il faut _________ l'émission.", fill: "écouter",
    fillA: ["ecouter"],
  },
  {
    id: "ar21-q2", textQ: "Émission radio 21 — Quel est le support de cette activité ?", text: ["Une émission de radio","Un message écrit","Une conversation face à face"], textC: 0,
    img: ["Radio","Message","Conversation"], imgC: 0,
    fillQ: "Émission 21 — Il s'agit d'une émission de _________.", fill: "radio",
  },
  {
    id: "ar21-q3", textQ: "Émission radio 21 — Comment progresser dans cette épreuve ?", text: ["Écouter l'émission plusieurs fois","Copier les réponses","Ignorer l'audio"], textC: 0,
    img: ["Réécouter","Copier","Ignorer"], imgC: 0,
    fillQ: "Émission 21 — _________ l'émission plusieurs fois.", fill: "Écouter",
    fillA: ["ecouter"],
  },
  {
    id: "ar21-q4", textQ: "Émission radio 21 — Que doit-on retenir de l'audio ?", text: ["Les informations principales de l'émission","Seulement le début","Uniquement la musique"], textC: 0,
    img: ["Infos principales","Début","Musique"], imgC: 0,
    fillQ: "Émission 21 — Retenez les _________ principales.", fill: "informations",
  },
  {
    id: "ar21-q5", textQ: "Émission radio 21 — Quelle attitude adopter pendant l'écoute ?", text: ["Se concentrer sur l'émission","Parler avec un voisin","Utiliser son téléphone"], textC: 0,
    img: ["Se concentrer","Parler","Téléphone"], imgC: 0,
    fillQ: "Émission 21 — Il faut se _________ sur l'émission.", fill: "concentrer",
  },
  {
    id: "ar21-q6", textQ: "Émission radio 21 — Pourquoi relire les questions avant d'écouter ?", text: ["Pour savoir quoi chercher dans l'émission","Pour écrire un résumé","Pour traduire mot à mot"], textC: 0,
    img: ["Savoir quoi chercher","Résumé","Traduire"], imgC: 0,
    fillQ: "Émission 21 — Il faut savoir quoi _________ dans l'émission.", fill: "chercher",
  },
]);

const RADIO_22 = buildPool("avance", "radio-22", [
  {
    id: "ar22-q1", textQ: "Émission radio 22 — Que faut-il faire pour bien répondre aux questions ?", text: ["Écouter attentivement l'émission","Lire sans écouter","Regarder une vidéo"], textC: 0,
    img: ["Écouter","Lire seul","Vidéo"], imgC: 0,
    fillQ: "Émission 22 — Il faut _________ l'émission.", fill: "écouter",
    fillA: ["ecouter"],
  },
  {
    id: "ar22-q2", textQ: "Émission radio 22 — Quel est le support de cette activité ?", text: ["Une émission de radio","Un message écrit","Une conversation face à face"], textC: 0,
    img: ["Radio","Message","Conversation"], imgC: 0,
    fillQ: "Émission 22 — Il s'agit d'une émission de _________.", fill: "radio",
  },
  {
    id: "ar22-q3", textQ: "Émission radio 22 — Comment progresser dans cette épreuve ?", text: ["Écouter l'émission plusieurs fois","Copier les réponses","Ignorer l'audio"], textC: 0,
    img: ["Réécouter","Copier","Ignorer"], imgC: 0,
    fillQ: "Émission 22 — _________ l'émission plusieurs fois.", fill: "Écouter",
    fillA: ["ecouter"],
  },
  {
    id: "ar22-q4", textQ: "Émission radio 22 — Que doit-on retenir de l'audio ?", text: ["Les informations principales de l'émission","Seulement le début","Uniquement la musique"], textC: 0,
    img: ["Infos principales","Début","Musique"], imgC: 0,
    fillQ: "Émission 22 — Retenez les _________ principales.", fill: "informations",
  },
  {
    id: "ar22-q5", textQ: "Émission radio 22 — Quelle attitude adopter pendant l'écoute ?", text: ["Se concentrer sur l'émission","Parler avec un voisin","Utiliser son téléphone"], textC: 0,
    img: ["Se concentrer","Parler","Téléphone"], imgC: 0,
    fillQ: "Émission 22 — Il faut se _________ sur l'émission.", fill: "concentrer",
  },
  {
    id: "ar22-q6", textQ: "Émission radio 22 — Pourquoi relire les questions avant d'écouter ?", text: ["Pour savoir quoi chercher dans l'émission","Pour écrire un résumé","Pour traduire mot à mot"], textC: 0,
    img: ["Savoir quoi chercher","Résumé","Traduire"], imgC: 0,
    fillQ: "Émission 22 — Il faut savoir quoi _________ dans l'émission.", fill: "chercher",
  },
]);
...
const RADIO_20 = buildPool("avance", "radio-20", [
  ...
  {
    id: "ar20-q6", textQ: "Quelle institution présentera de nouvelles méthodes aux entreprises ?", text: ["L'INRS","La FAO","L'Unesco"], textC: 0,
    img: ["INRS","FAO","Unesco"], imgC: 0,
    fillQ: "L'_________ présentera de nouvelles méthodes.", fill: "INRS",
    fillA: ["inrs"],
  },
]);
...
const RADIO_23 = buildPool("avance", "radio-23", [
  ...
  {
    id: "ar23-q2", textQ: "Quel acteur incarne l'agriculteur ?", text: ["Guillaume Canet","Fabrice Luchini","David Foenkinos"], textC: 0,
    img: ["Canet","Luchini","Foenkinos"], imgC: 0,
    fillQ: "Guillaume _________ joue l'agriculteur.", fill: "Canet",
    fillA: ["canet"],
  },
  {
