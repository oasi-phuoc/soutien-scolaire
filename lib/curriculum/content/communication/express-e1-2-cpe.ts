...
{
  id: "e1-2-po-11",
  title: "Carte de famille à la mairie",
  context: "Vous êtes à la mairie pour demander une carte famille pour la piscine municipale.",
  ...
  lines: [
    ...
    { role: "B", text: "Bonjour, je voudrais une carte famille pour la piscine." },
    { role: "A", text: "Combien de personnes vivent chez vous ?" },
    { role: "B", text: "Nous sommes quatre : deux adultes et deux enfants." },
    { role: "A", text: "Les enfants ont quel âge ?" },
    { role: "B", text: "Ils ont six ans et neuf ans." },
    { role: "A", text: "Très bien. La carte sera prête demain." },
    { role: "B", text: "Je peux venir la chercher le matin ?" },
    { role: "A", text: "Oui, dès 9 heures." },
    { role: "B", text: "Merci, à demain." },
  ],
},
{
  id: "e1-2-po-12",
  title: "Appeler pour une visite",
  context: "Vous appelez votre tante pour organiser une visite en famille dimanche.",
  roleA: { title: "La tante", vous: "la tante" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "Allô, bonjour ! Comment vas-tu ?" },
    { role: "B", text: "Bonjour tante Rosa, ça va bien." },
    { role: "A", text: "Tu appelles pour dimanche ?" },
    { role: "B", text: "Oui, nous voulons venir avec les enfants." },
    { role: "A", text: "Avec plaisir. Vous arrivez vers quelle heure ?" },
    { role: "B", text: "Vers 15 heures, après le repas." },
    { role: "A", text: "Très bien, je prépare un gâteau." },
    { role: "B", text: "Super. On apporte du jus de fruit." },
    { role: "A", text: "Parfait, à dimanche !" },
    { role: "B", text: "À dimanche, bisous." },
  ],
},
{
  id: "e1-2-po-13",
  title: "Nouveau voisin et famille",
  context: "Vous rencontrez votre voisin dans l'immeuble et vous présentez votre famille.",
  roleA: { title: "Le voisin", vous: "le voisin / la voisine" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "Bonjour, vous êtes les nouveaux voisins ?" },
    { role: "B", text: "Oui, nous venons d'emménager au troisième." },
    { role: "A", text: "Bienvenue ! Vous êtes en famille ?" },
    { role: "B", text: "Oui, avec mon mari et notre fille." },
    { role: "A", text: "Votre fille va à l'école du quartier ?" },
    { role: "B", text: "Oui, elle commence lundi." },
    { role: "A", text: "Ma fille aussi y va. Elles pourront se rencontrer." },
    { role: "B", text: "Ce serait très bien." },
    { role: "A", text: "Alors à bientôt dans l'immeuble." },
    { role: "B", text: "À bientôt, merci." },
  ],
},
{
  id: "e1-2-po-14",
  title: "Inscription à l'accueil",
  context: "Vous êtes à l'accueil d'un centre de loisirs pour inscrire votre enfant.",
  roleA: { title: "L'accueil", vous: "la personne à l'accueil" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "Bonjour, vous voulez une information ?" },
    { role: "B", text: "Oui, je veux inscrire mon fils au centre." },
    { role: "A", text: "Il a quel âge ?" },
    { role: "B", text: "Il a huit ans." },
    { role: "A", text: "Il reste des places le mercredi après-midi." },
    { role: "B", text: "C'est parfait, je travaille ce jour-là." },
    { role: "A", text: "Il faut remplir cette fiche." },
    { role: "B", text: "Je peux la remplir maintenant ?" },
    { role: "A", text: "Oui, prenez cette table." },
    { role: "B", text: "Merci beaucoup." },
  ],
},
{
  id: "e1-2-po-15",
  title: "Chemin vers la crèche",
  context: "Dans la rue, vous demandez à une passante où se trouve la crèche de votre petit frère.",
  roleA: { title: "La passante", vous: "la passante" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "Bonjour, vous cherchez quelque chose ?" },
    { role: "B", text: "Oui, je cherche la crèche des Petits Pins." },
    { role: "A", text: "C'est pour votre enfant ?" },
    { role: "B", text: "Non, pour mon petit frère." },
    { role: "A", text: "Elle est au bout de la rue, à gauche." },
    { role: "B", text: "Merci. C'est loin à pied ?" },
    { role: "A", text: "Non, cinq minutes seulement." },
    { role: "B", text: "Parfait, je suis rassuré." },
    { role: "A", text: "Bonne journée !" },
    { role: "B", text: "Merci, vous aussi." },
  ],
},
{
  id: "e1-2-po-16",
  title: "Photo de famille au bureau",
  context: "Au bureau, un collègue voit une photo de votre famille sur votre téléphone.",
  roleA: { title: "Le collègue", vous: "le collègue / la collègue" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "C'est ta famille sur la photo ?" },
    { role: "B", text: "Oui, c'est ma femme et mes deux enfants." },
    { role: "A", text: "Ils sont grands !" },
    { role: "B", text: "Oui, ma fille a dix ans maintenant." },
    { role: "A", text: "Et ton fils ?" },
    { role: "B", text: "Il a quatre ans, il parle beaucoup." },
    { role: "A", text: "Vous partez en vacances ensemble ?" },
    { role: "B", text: "Oui, une semaine au bord du lac." },
    { role: "A", text: "Profitez bien !" },
    { role: "B", text: "Merci, c'est gentil." },
  ],
},
{
  id: "e1-2-po-17",
  title: "Chambre familiale à la réception",
  context: "À la réception d'un hôtel, vous confirmez que la chambre convient à votre famille.",
  roleA: { title: "Le réceptionniste", vous: "le / la réceptionniste" },
  roleB: { title: "Vous", vous: "le client / la cliente" },
  lines: [
    { role: "A", text: "Bonjour, vous avez une réservation ?" },
    { role: "B", text: "Oui, une chambre familiale au nom de Silva." },
    { role: "A", text: "Je vois : deux adultes et un bébé." },
    { role: "B", text: "Oui. Est-ce qu'il y a un lit bébé ?" },
    { role: "A", text: "Oui, il est déjà dans la chambre." },
    { role: "B", text: "Merci. La chambre est calme ?" },
    { role: "A", text: "Oui, elle donne sur le jardin." },
    { role: "B", text: "Parfait pour notre bébé." },
    { role: "A", text: "Voici votre clé." },
    { role: "B", text: "Merci beaucoup." },
  ],
},
{
  id: "e1-2-po-18",
  title: "Appel vidéo avec les grands-parents",
  context: "En visio, vous présentez votre bébé aux grands-parents.",
  roleA: { title: "La grand-mère", vous: "la grand-mère" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "Oh, je vois le bébé !" },
    { role: "B", text: "Oui, il sourit aujourd'hui." },
    { role: "A", text: "Il a bien dormi cette nuit ?" },
    { role: "B", text: "Oui, presque six heures." },
    { role: "A", text: "Et toi, tu n'es pas trop fatiguée ?" },
    { role: "B", text: "Un peu, mais ça va." },
    { role: "A", text: "Nous venons vous voir samedi." },
    { role: "B", text: "Super, on vous attend après le repas." },
    { role: "A", text: "On apportera des fruits." },
    { role: "B", text: "Merci, à samedi !" },
  ],
},
{
  id: "e1-2-po-19",
  title: "Guichet des activités enfants",
  context: "Au guichet, vous demandez une réduction pour les activités de vos enfants.",
  roleA: { title: "L'employé", vous: "l'employé / l'employée du guichet" },
  roleB: { title: "Vous", vous: "la personne qui parle" },
  lines: [
    { role: "A", text: "Bonjour, vous venez pour les activités ?" },
    { role: "B", text: "Oui, pour mes deux enfants." },
    { role: "A", text: "Ils veulent faire quel cours ?" },
    { role: "B", text: "Natation pour ma fille et dessin pour mon fils." },
    { role: "A", text: "Il y a une réduction pour deux inscriptions." },
    { role: "B", text: "Très bien. Ça fait combien ?" },
    { role: "A", text: "Quarante francs par mois au total." },
    { role: "B", text: "D'accord, je les inscris." },
    { role: "A", text: "Je prépare les fiches." },
    { role: "B", text: "Merci beaucoup." },
  ],
},
{
  id: "e1-2-po-20",
  title: "Vêtements pour la famille",
  context: "Dans un magasin, vous cherchez des pulls pour toute la famille.",
  roleA: { title: "Le vendeur", vous: "le vendeur / la vendeuse" },
  roleB: { title: "Vous", vous: "le client / la cliente" },
  lines: [
    { role: "A", text: "Bonjour, je peux vous aider ?" },
    { role: "B", text: "Oui, je cherche trois pulls pour ma famille." },
    { role: "A", text: "Pour adultes ou enfants ?" },
    { role: "B", text: "Un pour moi et deux pour mes enfants." },
    { role: "A", text: "Voici les tailles enfants au fond." },
    { role: "B", text: "Vous avez du bleu et du rouge ?" },
    { role: "A", text: "Oui, dans cette rangée." },
    { role: "B", text: "Parfait. Je peux les essayer ?" },
    { role: "A", text: "Bien sûr, les cabines sont à droite." },
    { role: "B", text: "Merci." },
  ],
}
];
...
export const E1_2_PE: ExpressPePrompt[] = [
  {
    id: "e1-2-pe-1",
    title: "Carte de vacances",
    situation: "",
    instruction: "Vous êtes en vacances avec la famille de Léa. Vous écrivez une carte postale à votre mère pour présenter sa famille.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Présentez votre famille dans un court texte. Parlez des personnes importantes, de leur prénom, de leur âge et d'une activité qu'elles aiment.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vous envoyez une photo de famille à un ami français. Décrivez qui est sur la photo et expliquez votre lien avec chaque personne.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vous arrivez dans une famille d'accueil. Écrivez un message à un ami pour présenter les parents, les enfants et l'ambiance de la maison.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Votre famille prepare un anniversaire. Écrivez un message pour présenter les personnes invitees et dire ce que chacun apporte.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    title: "Frere et sœur",
    situation: "",
    instruction: "Présentez votre frere ou votre sœur à un camarade de classe. Donnez son prénom, son âge, son travail ou ses études et ses gouts.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    id: "e1-2-pe-7",
    title: "Grand-parent préfère",
    situation: "",
    instruction: "Écrivez un petit texte sur un grand-parent que vous aimez beaucoup. Décrivez son caractere, sa ville et ce que vous faites ensemble.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Expliquez votre arbre familial à un ami. Utilisez des phrases simples pour présenter vos parents, vos grands-parents et vos cousins.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vous parlez d'une famille nombreuse que vous connaissez. Présentez les membres de la famille et dites comment ils vivent ensemble.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vous rencontrez la famille de votre conjoint ou conjointe. Écrivez un message à un ami pour présenter les personnes et vos impressions.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Présentez votre famille et les animaux de la maison. Dites qui s'occupe de chaque animal et pourquoi vous l'aimez.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vos cousins viennent chez vous ce week-end. Écrivez un message pour les présenter à votre colocataire et expliquer leur programme.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Décrivez votre famille idéale dans un court texte. Parlez du nombre de personnes, de leur caractere et des activités que vous faites ensemble.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Racontez un souvenir simple avec votre famille. Dites où vous etiez, avec qui, et pourquoi ce moment etait agreable.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Présentez la famille de votre voisin à un nouvel habitant de l'immeuble. Expliquez qui est qui et donnez une information utile.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vous invitez un ami à manger avec votre famille. Écrivez-lui un message pour présenter les personnes présentes et le rassurer.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    title: "Deux familles",
    situation: "",
    instruction: "Comparez en phrases simples votre famille et la famille d'un ami. Dites qui est dans chaque famille et ce qui est différent.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Écrivez un message pour présenter un enfant et ses parents à une babysitter. Donnez les prénoms, les habitudes et une information importante.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    situation: "",
    instruction: "Vous passez le week-end avec votre famille. Écrivez un message pour dire avec qui vous êtes et ce que vous faites ensemble.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    id: "e1-2-pe-20",
    title: "Portrait familial",
    situation: "",
    instruction: "Choisissez trois personnes de votre famille et faites leur portrait. Donnez pour chaque personne son lien avec vous, son caractere et une activité aimee.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
