...
Bises`,
    ...
    instruction: "Vous êtes étudiant de français dans une nouvelle université. Écrivez un e-mail à votre famille pour parler de vos cours, de vos horaires et de votre professeur.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Vous êtes étudiant étranger en France et vous voulez prendre des cours de français. Écrivez un e-mail à votre université pour demander les horaires, le niveau et l'inscription.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez au secrétariat en demandant votre emploi du temps. Précisez votre niveau, vos disponibilites et le type de cours souhaite.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez à votre professeur pour expliquer votre absence au cours. Demandez les devoirs et dites quand vous revenez.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
A bientot`,
    ...
    instruction: "Écrivez un e-mail à deux camarades pour proposer un groupe de travail. Donnez un lieu, un jour et un objectif simple.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez au responsable pedagogique pour expliquer que le cours est trop difficile ou trop facile. Demandez conseil avec politesse.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Maman`,
    ...
    instruction: "Écrivez un e-mail à votre famille pour parler d'un petit examen de français. Dites ce que vous revisez et comment vous vous sentez.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez au secrétariat pour demander si vous pouvez encore vous inscrire au cours de français debutant. Présentez votre situation en phrases simples.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
A plus`,
    ...
    instruction: "Écrivez à un camarade pour demander les devoirs du soir. Expliquez que vous avez oublie de les noter et remerciez-le.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Bises`,
    ...
    instruction: "Répondez à votre famille en presentant votre professeur de français. Donnez son nom, sa facon d'enseigner et une chose que vous aimez.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez au secrétariat pour demander une attestation de participation au cours. Donnez votre nom, votre cours et la date souhaitee.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Ami`,
    ...
    instruction: "Écrivez à un ami pour raconter votre installation dans une nouvelle université. Parlez des cours, des étudiants et de votre routine.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez un e-mail au professeur pour poser une question sur le prochain cours. Demandez l'heure, la salle et le travail à préparer.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
A tout de suite`,
    ...
    instruction: "Répondez à votre collègue en expliquant pourquoi vous êtes en retard. Racontez votre matin et donnez votre heure d'arrivee.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Amie`,
    ...
    instruction: "Écrivez à votre amie pour décrire votre routine du samedi. Dites ce que vous faites le matin, l'après-midi et le soir.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez une réponse pour décrire une journée où vous faites du sport. Donnez l'heure, le lieu et ce que vous faites après.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Le professeur`,
    ...
    instruction: "Écrivez au forum du cours pour décrire votre journée idéale. Donnez des heures et parlez des personnes avec vous.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez à votre professeur pour décrire une nouvelle routine que vous voulez essayer. Expliquez ce que vous changez et pourquoi.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez à votre proprietaire en décrivant les horaires de votre colocataire. Restez simple et expliquez si la routine pose un problème.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Écrivez au forum pour comparer votre routine de semaine et votre routine du dimanche. Dites ce qui est pareil et ce qui change.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Marco`,
    ...
    instruction: "Répondez à un ami et expliquez comment se passe souvent un matin en France. Parlez du petit déjeuner, des transports et du debut du travail.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Votre coach`,
    ...
    instruction: "Écrivez une réponse à votre coach de langue avec le bilan de votre journée. Dites ce que vous faites en français le matin, l'après-midi et le soir.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez un e-mail pour répondre à l'annonce de travail de la ville de Périgueux. Présentez-vous, donnez vos disponibilites et demandez un rendez-vous.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      from: "Responsable RH",
      subject: "Bienvenue dans l'equipe",
      body: `Bonjour,
Nous sommes heureux de vous accueillir lundi pour votre premier jour.
Cordialement`,
    },
    instruction: "Répondez au responsable pour confirmer votre premier jour. Demandez l'heure d'arrivee, l'adresse exacte et le nom de la personne à contacter.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Écrivez une réponse au stagiaire en presentant votre equipe. Dites qui fait quoi et qui peut l'aider au debut.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Répondez à cette offre avec une courte présentation professionnelle. Parlez de votre expérience, de vos competences et de vos disponibilites.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Envoyez un e-mail aux collègues pour organiser une courte reunion. Donnez le sujet, le jour, l'heure et le lieu.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez un e-mail de présentation pour une candidature. Indiquez ce que vous savez faire, les langues parlees et le type de poste recherche.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Merci`,
    ...
    instruction: "Répondez à l'equipe pour expliquer comment remplacer un collègue absent. Dites quelles tâches sont importantes aujourd'hui.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
A plus`,
    ...
    instruction: "Écrivez une réponse pour inviter deux collègues à une pause café. Proposez l'heure et le lieu de facon amicale.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez au conseiller emploi pour décrire le travail que vous aimeriez faire. Parlez du lieu, des horaires et des qualites nécessaires.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    id: "e3-3-pee-13",
    title: "Depart collègue",
    situation: "",
    sourceMessage: {
      from: "Equipe",
      subject: "Depart de Lina",
      body: `Bonjour,
Lina quitte l'entreprise vendredi. Nous voulons lui envoyer un message commun.
L'equipe`,
    },
    instruction: "Écrivez un e-mail de groupe pour remercier un collègue qui quitte l'entreprise. Souhaitez-lui une bonne continuation.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
A plus`,
    ...
    instruction: "Écrivez à un collègue pour demander de l'aide sur une tâche que vous ne comprenez pas. Expliquez le problème avec politesse.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      from: "Responsable",
      subject: "Présentation de l'equipe",
      body: `Bonjour,
Pour le nouveau partenaire, préparez une présentation simple de notre equipe.
Merci`,
    },
    instruction: "Répondez au responsable en presentant une equipe internationale. Donnez les prénoms, les langues parlees et les roles principaux.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez à l'employeur pour demander un travail à temps partiel. Présentez vos jours disponibles et le type de tâches que vous pouvez faire.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
...
Cordialement`,
    ...
    instruction: "Écrivez à votre responsable pour demander une petite formation. Expliquez ce que vous voulez apprendre et pourquoi c'est utile pour votre travail.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
  {
    ...
    sourceMessage: {
      ...
      subject: "Chef d'equipe",
      body: `Bonjour,
Je voudrais savoir qui est le chef d'equipe et comment le contacter.
Merci`,
    },
    instruction: "Répondez au nouveau collaborateur en presentant le chef d'equipe. Donnez son rôle, ses horaires et la meilleure facon de le contacter.",
    points: [],
    minWords: PE_MIN,
    maxWords: PE_MAX,
  },
