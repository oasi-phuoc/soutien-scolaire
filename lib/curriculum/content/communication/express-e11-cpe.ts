...
const E11_1_CE_12_TEXT = `Ticket d'inscription

Activité : une lecture d'étiquettes alimentaires.
Lieu : la maison médicale. Date : vendredi 2 août. Heure : 8 h 30.
Responsable : la docteure Morel. Tarif : 6 CHF.
À apporter : une loupe ou ses lunettes. Remarque : les personnes allergiques préviennent dès l'arrivée.`;
...
const E11_1_CE_13_TEXT = `Formulaire — informations utiles

Nom de l'activité : un atelier pique-nique équilibré.
Niveau conseillé : débutant A2, avec aide de l'entraîneuse Emma.
Rendez-vous samedi 10 août à 13 h à le parc des Amandiers.
Le formulaire demande de confirmer auprès de la coach et de prévoir une gourde.`;
...
const E11_2_CE_12_TEXT = `Ticket d'inscription

Activité : une promenade avec observation des oiseaux.
Lieu : la maison médicale. Date : vendredi 2 août. Heure : 8 h 30.
Responsable : la docteure Morel. Tarif : 6 CHF.
À apporter : des jumelles si possible. Remarque : on parle doucement près des nids.`;
...
const E11_2_CE_13_TEXT = `Formulaire — informations utiles

Nom de l'activité : un atelier réparation de vélo.
Niveau conseillé : débutant A2, avec aide de l'entraîneuse Emma.
Rendez-vous samedi 10 août à 13 h à le parc des Amandiers.
Le formulaire demande de confirmer auprès de la coach et de prévoir une chambre à air usée.`;
...
const E11_3_CE_12_TEXT = `Ticket d'inscription

Activité : une discussion sur les podcasts.
Lieu : la maison médicale. Date : vendredi 2 août. Heure : 8 h 30.
Responsable : la docteure Morel. Tarif : 6 CHF.
À apporter : un podcast court. Remarque : les extraits durent moins de trois minutes.`;
...
const E11_3_CE_13_TEXT = `Formulaire — informations utiles

Nom de l'activité : un vote pour le menu de fête.
Niveau conseillé : débutant A2, avec aide de l'entraîneuse Emma.
Rendez-vous samedi 10 août à 13 h à le parc des Amandiers.
Le formulaire demande de confirmer auprès de la coach et de prévoir une idée de plat.`;
...
const E11_4_CE_12_TEXT = `Ticket d'inscription

Activité : une initiation aux réservations en ligne.
Lieu : la maison médicale. Date : vendredi 2 août. Heure : 8 h 30.
Responsable : la docteure Morel. Tarif : 6 CHF.
À apporter : un mot de passe. Remarque : il faut vérifier son adresse e-mail.`;
...
const E11_4_CE_13_TEXT = `Formulaire — informations utiles

Nom de l'activité : une marche découverte avant le départ.
Niveau conseillé : débutant A2, avec aide de l'entraîneuse Emma.
Rendez-vous samedi 10 août à 13 h à le parc des Amandiers.
Le formulaire demande de confirmer auprès de la coach et de prévoir une gourde.`;
