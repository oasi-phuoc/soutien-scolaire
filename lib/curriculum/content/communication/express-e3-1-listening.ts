...
const POOL_078 = buildExpressPool("e3-1-078", [
  q({
    ...
    textC: 0,
    imgQ: "Que viennent faire les étrangers dont parle l'audio ?",
    img: ["étudier", "travail", "voyage"],
    imgC: 0,
...
const POOL_081 = buildExpressPool("e3-1-081", [
  q({
    ...
    textC: 0,
    img: ["directeur", "bibliothèque", "cafétéria"],
    imgC: 0,
