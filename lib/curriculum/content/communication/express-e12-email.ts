...
const E12_1_CE_EMAIL_2_POOL = buildExpressPool("e12-1-ce-email-2", [
  q({
    ...
    img: ["médecin", "infirmier", "pharmacien"],
    imgC: 0,
    fillQ: "Les informations concernent _________ santé.",
    fill: "e-mail",
...
const E12_2_CE_EMAIL_2_POOL = buildExpressPool("e12-2-ce-email-2", [
  q({
    ...
    img: ["médecin", "infirmier", "pharmacien"],
    imgC: 0,
    fillQ: "Les informations concernent _________ sport.",
    fill: "e-mail",
...
const E12_3_CE_EMAIL_2_POOL = buildExpressPool("e12-3-ce-email-2", [
  q({
    ...
    img: ["médecin", "infirmier", "pharmacien"],
    imgC: 0,
    fillQ: "Les informations concernent _________ alimentation.",
    fill: "e-mail",
...
const E12_4_CE_EMAIL_2_POOL = buildExpressPool("e12-4-ce-email-2", [
  q({
    ...
    img: ["médecin", "infirmier", "pharmacien"],
    imgC: 0,
    fillQ: "Les informations concernent _________ la ville.",
    fill: "e-mail",
...
const E12_5_CE_EMAIL_2_POOL = buildExpressPool("e12-5-ce-email-2", [
  q({
    ...
    img: ["médecin", "infirmier", "pharmacien"],
    imgC: 0,
    fillQ: "Les informations concernent _________ bien-être.",
    fill: "e-mail",
