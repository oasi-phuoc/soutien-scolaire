...
},
{
  ...
  situation: "On vous propose soit un dîner chez des amis samedi soir, soit un pique-nique au parc dimanche midi.",
  instruction: "Comparez les deux invitations (dîner chez des amis / pique-nique au parc) : avantages et inconvénients de chacune, puis indiquez votre préférence et pourquoi.",
  points: [],
  minWords: PE_MIN,
  maxWords: PE_MAX,
},
...
},
{
  ...
  situation: "Vous hésitez entre une rencontre au café en ville et une sortie au cinéma avec le même ami.",
  instruction: "Comparez les deux possibilités (café en ville / sortie au cinéma) : avantages et inconvénients de chacune, puis indiquez votre préférence et pourquoi.",
  points: [],
  minWords: PE_MIN,
  maxWords: PE_MAX,
},
...
},
{
  ...
  situation: "Vous pouvez aller soit à un concert en plein air, soit à une fête de quartier le même soir.",
  instruction: "Comparez les deux événements (concert en plein air / fête de quartier) : avantages et inconvénients de chacun, puis indiquez votre préférence et pourquoi.",
  points: [],
  minWords: PE_MIN,
  maxWords: PE_MAX,
},
...
},
{
  ...
  situation: "À l'école, on vous propose soit un atelier théâtre le mercredi, soit un club sportif le vendredi.",
  instruction: "Comparez les deux activités scolaires (atelier théâtre / club sportif) : avantages et inconvénients de chacune, puis indiquez votre préférence et pourquoi.",
  points: [],
  minWords: PE_MIN,
  maxWords: PE_MAX,
},
...
},
{
  ...
  situation: "Une association vous propose soit d'aider à la distribution alimentaire, soit d'animer un atelier pour enfants.",
  instruction: "Comparez les deux engagements associatifs (distribution alimentaire / atelier pour enfants) : avantages et inconvénients de chacun, puis indiquez votre préférence et pourquoi.",
  points: [],
  minWords: PE_MIN,
  maxWords: PE_MAX,
},
