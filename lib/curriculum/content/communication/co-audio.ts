...
export function isCoGroupPlayable(group: COAudioGroup): boolean {
  if (group.source === "scolaire") return SCOLAIRE_PLAYABLE_GROUP_IDS_ALL.has(group.id);
  return true;
}
...
export const CO_AUDIO_GROUPS: COAudioGroup[] = [
  ...
  group("moyen", "radio", "24", [
    item("moyen", "radio", "24", "radio-24.mp3", "— Bonjour et bienvenue sur « Radio Muzik ». Nous recevons aujourd’hui le célèbre chanteur guyanais Chris Lombrete. Bonjour Chris.\n— Bonjour.\n— Chris, vous avez fait des concerts en Guyane, en Martinique... Racontez-nous votre tournée.\n— Eh bien, oui, j’ai fait 12 concerts. J’ai pu voyager pendant 2 mois dans différents départements de la France, différentes villes. Pointe-à-Pitre, Fort-de-France... C’était vraiment super.\n— Et quel est votre meilleur souvenir ?\n— Mon meilleur souvenir de concert ? Euh, je crois que c’était en Guyane, dans ma ville, à Cayenne. Il y avait environ 300 personnes. Ils connaissaient les chansons par cœur et ils ont tous chanté avec moi. C’était magique.\n— Merci Chris. Et maintenant, vous préparez un nouvel album, c’est ça ?\n— Oui. Le CD sera prêt dans 3-4 mois."),
  ]),
  ...
  group("moyen", "conversation", "38", [
    item("moyen", "conversation", "38", "conversation-38.mp3", "Dialogue 1\n— Excusez-moi monsieur, bonjour. J’ai oublié à quelle heure doit partir le train pour Bordeaux.\n— Le train partira à 15h50 en voie numéro 3.\n— Très bien, merci beaucoup. Bonne journée.\n\nDialogue 2\n— Marc, je dois récupérer un colis à la poste, mais je ne peux pas y aller, je suis malade. Tu pourrais y aller s’il te plaît ?\n— Bien sûr, pas de problème.\n— Merci beaucoup.\n\nDialogue 3\n— Allô ? Bonjour, ici le cabinet du docteur Robichet. Je vous appelle pour vous confirmer votre consultation de 16h aujourd’hui.\n— Ah très bien, merci.\n— N’oubliez pas de vous présenter au cabinet 15 minutes avant le rendez-vous.\n— D’accord.\n\nDialogue 4\n— Salut Marie,\n— Bonjour Pierre ! C’est toujours d’accord pour le cinéma de ce soir ?\n— Malheureusement, non. Je ne pourrai pas venir. Je suis vraiment désolé.\n— Bien sûr, pas de problème. On ira une prochaine fois !"),
  ]),
  group("moyen", "conversation", "39", [
    item("moyen", "conversation", "39", "conversation-39.mp3", "Dialogue 1\n— Phil ! Tu voudrais venir avec moi à l’exposition musicale ce week-end ?\n— Ah oui pourquoi pas. C’est où ?\n— Pas très loin d’ici. À la porte de la Villette.\n— Je t’invite !\n— Super ! D’accord.\n\nDialogue 2\n— Didier, dis-moi, Thibault est allé travailler aujourd’hui ?\n— Non, il n’est pas allé au travail aujourd’hui.\n— Sais-tu pourquoi ?\n— Je crois qu’il est malade.\n— Ah d’accord.\n\nDialogue 3\n— Stéphanie, je ne me sens pas bien.\n— Oh ! Tu devrais appeler ton médecin pour prendre un rendez-vous.\n— J’ai essayé de l’appeler, mais je tombe sur son répondeur.\n— Ah ! Il est peut-être en congé.\n\nDialogue 4\n— J’ai croisé notre nouvelle voisine ce matin.\n— Ah oui ? Elle est comment ?\n— Elle est très grande, un peu mince, elle doit avoir 40 ans. Elle est très gentille.\n— D’accord. J’irai lui souhaiter la bienvenue tout à l’heure."),
  ]),
  group("moyen", "conversation", "40", [
    item("moyen", "conversation", "40", "conversation-40.mp3", "Dialogue 1\n— Bonjour madame, que désirez-vous aujourd’hui ?\n— Bonjour, alors je vais prendre le plat du jour, un jus d’orange et un tiramisu s’il vous plaît.\n— Très bien, ce sera tout ?\n— Oui merci.\n\nDialogue 2\n— Martin, tu peux m’aider à trouver un cadeau pour mon père ?\n— Qu’est-ce qu’il aime ?\n— Il adore le rugby.\n— Tu pourrais lui acheter des tickets pour aller voir un match.\n— Ah ! C’est une super idée ça ! Merci Martin.\n\nDialogue 3\n— Justine, je vais devoir m’absenter quelques jours pour le travail. Tu pourrais t’occuper de mon chat ?\n— Oui bien sûr. Qu’est-ce que je dois faire ?\n— Il faudrait lui donner à manger et jouer un peu avec lui.\n— Ok très bien.\n\nDialogue 4\n— Salut Clara ! Comment tu vas ?\n— Bien et toi ? Tu as l’air tout heureux, qu’est-ce qui se passe ?\n— Je viens d’avoir les résultats, j’ai eu mon concours pour devenir professeur !\n— Ah mais c’est génial ça !"),
  ]),
  group("moyen", "conversation", "41", [
    item("moyen", "conversation", "41", "conversation-41.mp3", "Dialogue 1\n— Julie, je dois aller au nouveau centre des impôts demain. Tu sais comment y aller ?\n— Oui, tu dois prendre le bus 171 et descendre à l’arrêt Gabriel Péri. C’est juste à côté du bureau de poste.\n— Très bien, merci beaucoup.\n\nDialogue 2\n— Eh Clémence ! Comment tu vas ?\n— Salut Max ! Ça fait longtemps que je ne t’ai pas vu. Eh bien, ça va et toi ? Comment vont tes enfants ?\n— Tout le monde va bien. Nous allons bientôt partir pour les vacances. Et toi ?\n— Nous aussi.\n\nDialogue 3\n— Marion, finalement, je ne peux pas venir avec toi au marché cet après-midi.\n— Ah bon ? Pourquoi ?\n— Une entreprise m’a appelé pour me faire passer un entretien.\n— Ah d’accord. Bonne chance pour ton entretien.\n\nDialogue 4\n— C’était bien tes vacances ?\n— Pas très bien. Il a plu pendant 2 semaines. Du coup, on n’a pas pu profiter de la plage. L’hôtel n’était pas très agréable...\n— Quel dommage !"),
  ]),
  group("moyen", "conversation", "42", [
    item("moyen", "conversation", "42", "conversation-42.mp3", "Dialogue 1\n— Bonjour, je voudrais un sandwich au fromage avec une bouteille d’eau, s’il vous plaît.\n— Très bien. Est-ce qu’il vous faut autre chose ?\n— Oui, je prendrai aussi une tarte aux fraises.\n— Très bien, je vous apporte ça.\n\nDialogue 2\n— Amine, ça te dirait de sortir un peu demain ?\n— Oh oui, quelle bonne idée ! Qu’est-ce que tu proposes ?\n— Eh bien, on pourrait aller au jardin du Luxembourg et voir un film au cinéma le soir.\n— Parfait ! Super !\n\nDialogue 3\n— Alors, tu as terminé de lire le livre que je t’ai prêté ? Tu as aimé ?\n— Eh bien... je n’ai pas du tout aimé. C’était long, et je n’aime pas les histoires d’amour. Je préfère les histoires policières.\n— Ah d’accord. Dommage !\n\nDialogue 4\n— Sylvie, tu peux me rappeler à quelle heure commence le concert demain soir ?\n— Tu oublies toujours tout, toi. Les portes de la salle ouvrent à 19 h 30, mais le concert ne commence pas avant 21 h.\n— Super, merci beaucoup.\n— De rien !"),
  ]),
  group("moyen", "conversation", "43", [
    item("moyen", "conversation", "43", "conversation-43.mp3", "Dialogue 1\n— Excusez-moi monsieur, j’essaie de retirer de l’argent au distributeur de billets, mais je n’y arrive pas.\n— Il a un problème technique. Vous pouvez utiliser celui à l’intérieur de la banque si vous voulez.\n— D’accord.\n\nDialogue 2\n— Bonjour madame, vous savez à quelle heure la banque va ouvrir ?\n— Bonjour. Je ne suis pas sûre, mais je crois qu’elle ouvre à 13h30.\n— D’accord. Je vais revenir tout à l’heure.\n\nDialogue 3\n— Excusez-moi monsieur, je cherche la mairie de Sèvres.\n— Je suis vraiment désolé, mais je ne sais pas. Je ne suis pas d’ici.\n— Ce n’est pas grave. Je vais demander à quelqu’un d’autre.\n\nDialogue 4\n— Attendez madame, vous voulez que je vous aide à porter les sacs ?\n— Oh c’est très gentil, monsieur. Oui, je veux bien. Merci beaucoup. Ils sont vraiment très lourds.\n— Avec plaisir madame."),
  ]),
  group("moyen", "conversation", "44", [
    item("moyen", "conversation", "44", "conversation-44.mp3", "Dialogue 1\n— Bonjour madame, vous désirez ?\n— Je voudrais un café gourmand, s’il vous plaît.\n— Bien, madame. Je vous l’apporte tout de suite.\n— Oh... je voudrais un verre d’eau également. C’est possible ?\n— Bien sûr, madame. Je vous l’apporte avec le café.\n\nDialogue 2\n— Oh ! Il est déjà deux heures moins le quart. Mon client va arriver. Je dois retourner au bureau.\n— D’accord. À ce soir, mon chéri. Bonne chance avec ton client.\n— Merci, passe une bonne journée. À plus tard.\n\nDialogue 3\n— Et si on allait au cinéma ce soir ?\n— Bonne idée ! Quel film est-ce que tu voudrais voir ?\n— Les infidèles.\n— Ah... Et pourquoi pas aller au théâtre ?\n— Oui, ça nous changera ! Regardons le programme culturel.\n\nDialogue 4\n— Comment est-ce que je peux me rendre à la gare d’Austerlitz ?\n— Prends la ligne 10 du métro. C’est le plus direct.\n— Tu es sûr ? Je dois y aller après le travail.\n— Ah non ! Alors, prends la ligne 5.\n— D’accord, merci."),
  ]),
  group("moyen", "conversation", "45", [
    item("moyen", "conversation", "45", "conversation-45.mp3", "Dialogue 1\n— Salut Julie. Ça va ?\n— Salut Max, je vais bien, merci. Je te présente mon frère, Yannick.\n— Salut Yannick, enchanté. Julie m’a beaucoup parlé de toi.\n\nDialogue 2\n— Alors, tu es toujours d’accord pour m’accompagner au concert ?\n— Oui, bien sûr. On se voit à quelle heure ?\n— Eh bien, rendez-vous à 20 heures devant la salle, le concert commence à 21 heures. Ça te va ?\n— Parfait, j’y serai.\n\nDialogue 3\n— Valérie, je peux te demander une faveur ? C’est important.\n— Bien sûr, je t’écoute.\n— Est-ce que tu peux garder mon fils, samedi soir ?\n— Pas de problème.\n— Merci, c’est gentil.\n\nDialogue 4\n— Dis, ça te dit de venir au cinéma avec Lucie et moi ?\n— Oui, pourquoi pas. Quand ?\n— Vendredi soir, la séance est à 21 h.\n— Désolée, mais je suis déjà prise vendredi.\n— Dommage, ce sera pour une autre fois."),
  ]),
  group("moyen", "conversation", "46", [
    item("moyen", "conversation", "46", "conversation-46.mp3", "Dialogue 1\n— Alors, cette fête d’anniversaire ? C’était comment ?\n— C’était génial ! Nous étions 20 personnes. Nous avons dansé toute la nuit.\n— Oh là là, vous étiez nombreux.\n— Oui. Et j’ai eu plein de cadeaux. C’était formidable.\n\nDialogue 2\n— Salut Hugo ! J’ai deux places pour le match de basket de samedi. Tu veux venir avec moi ?\n— C’est vrai ? C’est terrible, je ne peux pas y aller. C’est l’anniversaire de ma mère.\n— Oh non ! C’est dommage...\n\nDialogue 3\n— Tu sais quoi ? Paul m’a demandée en mariage.\n— C’est vrai ? Comme c’est romantique.\n— Oui. En plus, nous allons nous marier à Paris.\n— Félicitations ! Je suis heureuse pour toi.\n\nDialogue 4\n— Marc, tu peux m’accompagner chez le médecin ?\n— Oui. Sophie, tu es malade ? Qu’est-ce qui ne va pas ?\n— Rien de grave. C’est pour un vaccin seulement, mais je préfère être accompagnée."),
  ]),
  group("moyen", "conversation", "47", [
    item("moyen", "conversation", "47", "conversation-47.mp3", "Dialogue 1\n— Bonjour Leïla ! Encore félicitations pour ton mariage !\n— Bonjour Farida, merci beaucoup !\n— C’était une très belle réception. On a très bien mangé et on s’est vraiment bien amusés. Bravo et merci !\n\nDialogue 2\n— Ah, ma veste est toute sale !\n— Oups, pardon, j’ai mis ta veste pour aller dans le jardin ce matin. Je suis vraiment désolée !\n\nDialogue 3\n— Julien, ça te dit d’aller au cinéma ce soir avec moi ?\n— Ah oui, pourquoi pas ! Tu voudrais voir quel film ?\n— Euh... Un film d’action ou une comédie, par exemple, ça te dit ?\n\nDialogue 4\n— J’aimerais bien aller au restaurant ce soir. Tu connais un bon restaurant par ici ?\n— Je te conseille la crêperie « La Chandeleur » à Lisieux. On y mange les meilleures crêpes de Normandie !"),
  ]),
  group("moyen", "conversation", "48", [
    item("moyen", "conversation", "48", "conversation-48.mp3", "Dialogue 1\n— Waouh, sympa ton nouveau pantalon ! Tu l’as acheté au centre commercial ?\n— Ah merci ! Oui, il vient du centre commercial.\n— Et tu l’as payé combien ?\n— Je l’ai eu en soldes pour seulement 19 € !\n\nDialogue 2\n— Samia, ça te dirait d’aller au restaurant qui fait les plats végétariens ? J’ai entendu dire qu’il était vraiment bon !\n— Ah, pourquoi pas !\n\nDialogue 3\n— Henria, merci beaucoup pour ton aide. Grâce à toi, j’ai trouvé un beau cadeau pour mon petit cousin !\n— De rien, je suis contente de vous avoir aidés toi et ton petit cousin !\n\nDialogue 4\n— Bonjour Madame. Vous avez la carte de fidélité du magasin ?\n— Bonjour, euh, non je n’ai pas de carte fidélité.\n— Vous voulez la faire aujourd’hui ? Elle vous offre plein d’avantages et des réductions !\n— Euh, non, désolée, ça ne m’intéresse pas."),
  ]),
  group("moyen", "conversation", "49", [
    item("moyen", "conversation", "49", "conversation-49.mp3", "Dialogue 1\n— Excuse-moi Éric, j’ai oublié la date de l’examen. Tu peux me rappeler la date, s’il te plaît ?\n— Bien sûr. C’est le mercredi 17.\n— Ah oui ! À 9h, c’est bien ça ?\n— Exactement.\n\nDialogue 2\n— Dis, Sandrine, tu sais comment on va à la bibliothèque ?\n— La bibliothèque ? Elle est au bâtiment C, au premier étage.\n— D’accord. Et à quelle heure est-ce qu’elle ouvre ?\n— Elle ouvre à 9h et demie, tous les jours.\n\nDialogue 3\n— Astrid, tu veux réviser l’examen de mercredi avec moi ?\n— D’accord. On peut se voir ce soir si tu veux. Je suis libre à partir de 17 h.\n— Je ne suis pas disponible ce soir. Demain après-midi, ça te va ?\n— D’accord. Mais à 15 h alors. Rendez-vous à la bibliothèque.\n\nDialogue 4\n— Caroline, j’ai oublié mon livre chez mes parents.\n— Vraiment ? Ça tombe mal, nous avons notre examen dans 2 jours.\n— Je sais ! Est-ce que tu peux me prêter un livre ? Je voudrais faire des photocopies.\n— Bien sûr. Allons les faire maintenant !"),
  ]),
