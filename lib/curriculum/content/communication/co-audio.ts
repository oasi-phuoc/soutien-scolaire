...
export const CO_AUDIO_GROUPS: COAudioGroup[] = [
  ...
  group("moyen", "annonce", "1", [
    ...
    item("moyen", "annonce", "1.3", "annonce-1.3.mp3", "Chers spectateurs, nous vous informons que le film “La roue tourne”, gagnant du César de la meilleure comédie de l’année commencera à 18h30. Veuillez nous excusez."),
  ...
  group("moyen", "annonce", "3", [
    ...
    item("moyen", "annonce", "3.4", "annonce-3.4.mp3", "Chers étudiants, pour des raisons de sécurité, vous devez présenter votre carte d’étudiant à l’entrée de l’université. Les cartes nationales d’identité ou les cartes de bibliothèques ne sont pas acceptées."),
  ...
  group("moyen", "annonce", "4", [
    item("moyen", "annonce", "4.1", "annonce-4.1.mp3", "Mesdames et messieurs le cirque Pindet vous invite à nous retrouver pour un spectacle extraordinaire d’1h30. Venez voir des animaux, des clowns, des acrobates. Rendez-vous mardi 14 à 18h."),
  ...
  group("moyen", "radio", "14", [
    ...
    item("moyen", "radio", "14.2", "radio-14.2.mp3", "Dernières nouvelles pour les amoureux de la série à succès “La maison de papier” qui a fait rire des milliers de spectateurs. Les acteurs feront des photos avec le public de 14h à 16h à la Cité du cinéma à Saint-Denis."),
  ...
  group("moyen", "radio", "16", [
    ...
    item("moyen", "radio", "16.3", "radio-16.3.mp3", "Bienvenue dans l’émission “C’est de l’art”. Aujourd’hui, nous parlerons de l’exposition sur Stéphanie Roncin, la célèbre peintre. Elle a peint des portraits de femmes au 20ème siècle. Admirez les 30 tableaux de cette exposition à partir du 12 février au musée Monet à Paris."),
  ]),
  group("moyen", "radio", "17", [
    item("moyen", "radio", "17.1", "radio-17.1.mp3", "Bonjour. À l’approche de l’automne, restez en forme en faisant une promenade de 20 minutes. L’effort physique est très bon pour le moral. Pour les plus sportifs, le vélo et natation vous sont conseillés ! N’oubliez pas de boire !"),
