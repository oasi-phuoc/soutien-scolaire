...
export const A1_GR_VERBES_ER_PART: GrammarLesson = {
  ...
  theory: [
    ...
    {
      type: "text",
      text: "Le verbe {a}aller{/a} sert à indiquer un déplacement (il est alors suivi d'un lieu ou d'un infinitif) ou à prendre et donner des nouvelles.",
      transText: {
    ...
    {
      type: "text",
      text: "Nou{li}s|a{/li}llons, vou{li}s|a{/li}llez.",
    },
    ...
    {
      type: "text",
      text: "{a}1.{/a} Avec {a}je, tu, il/elle/on, ils/elles{/a}, ces verbes ont une particularité orthographique qui change la prononciation.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}2.{/a} Ils ont deux radicaux : le 1er (comme l'infinitif) pour {a}nous{/a} et {a}vous{/a} ; le 2e (modifié) pour les autres personnes.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}3.{/a} Les verbes comme {a}jeter{/a} doublent le {a}t{/a} devant une terminaison muette.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}4.{/a} Les verbes comme {a}appeler{/a} doublent le {a}l{/a} devant une terminaison muette.",
      transText: {
