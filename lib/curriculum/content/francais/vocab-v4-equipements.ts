...
export const V4_EQUIPEMENTS_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "canapé", image: "canapé.jpg",          article: "le",  gender: "m", definition: "grand siège confortable pour plusieurs personnes" },
    ...
    { word: "télévision", image: "télévision.jpg",      article: "la",  gender: "f", definition: "écran pour regarder des programmes" },
    ...
    { word: "machine à laver", image: "machine-à-laver.jpg", article: "la",  gender: "f", definition: "appareil pour laver le linge" },
