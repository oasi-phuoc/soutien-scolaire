  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ tableau est de Van Gogh.", choices: ["Ce", "Cet", "Cette", "Ces"], correctIdx: 0 },
        { sentence: "___ femme est appelée « l'Arlésienne ».", choices: ["Cette", "Ce", "Cet", "Ces"], correctIdx: 0 },
        { sentence: "___ tableaux sont vraiment intéressants.", choices: ["Ces", "Ce", "Cet", "Cette"], correctIdx: 0 },
        { sentence: "___ artiste a vécu au XIXe siècle.", choices: ["Cet", "Ce", "Cette", "Ces"], correctIdx: 0 },
        { sentence: "___ semaine, je vais au musée.", choices: ["Cette", "Ce", "Cet", "Ces"], correctIdx: 0 },
        { sentence: "___ statues sont au musée Rodin.", choices: ["Ces", "Cette", "Ce", "Cet"], correctIdx: 0 },
        { sentence: "J'aime ___ appartement.", choices: ["cet", "ce", "cette", "ces"], correctIdx: 0 },
        { sentence: "Regarde ___ voiture.", choices: ["cette", "ce", "cet", "ces"], correctIdx: 0 },
        { sentence: "Prends ___ bus !", choices: ["ce", "cet", "cette", "ces"], correctIdx: 0 },
        { sentence: "___ hôtel est très connu.", choices: ["Cet", "Ce", "Cette", "Ces"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
