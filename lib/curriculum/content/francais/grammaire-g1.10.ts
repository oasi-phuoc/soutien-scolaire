...
export const A1_GR_VERBES_RE_OIR: GrammarLesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      items: [
        "On utilise savoir pour parler de ce que l'on est capable de faire ou d'informations",
        "On utilise connaître pour parler d'une personne ou d'une chose avec lequel on est familier",
      ],
      noBulletItems: [0,1],
    ...
    },
    {
      ...
      rows: [
        ...
        ["savoir", "+ {a}que{/a}, {a}si{/a} ou {a}où{/a}", "Fait", "Je sais qu'il est {a}français{/a}.\nTu sais si {a}le magasin est ouvert{/a} ?\nJe sais où {a}il habite{/a}."],
