...
export const V9_TRANSPORT_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "train",   article: "le",  gender: "m", definition: "transport ferroviaire longue distance" },
    ...
    { word: "moto",    article: "la",  gender: "f", definition: "véhicule motorisé à deux roues" },
    { word: "avion",   article: "l'",  gender: "m", definition: "véhicule aérien pour voyager loin" },
    { word: "bateau",  article: "le",  gender: "m", definition: "véhicule pour voyager sur l'eau" },
