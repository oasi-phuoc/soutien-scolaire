...
export const NATIONALITES_A1_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "Italie",       article: "l'",  gender: "f", image: "italie.jpg",    definition: "pays de la botte" },
    ...
    { word: "Espagne",      article: "l'",  gender: "f", image: "espagne.jpg",   definition: "pays ibérique" },
    { word: "Allemagne",    article: "l'",  gender: "f", image: "allemagne.jpg", definition: "pays d'Europe centrale" },
    { word: "Suisse",       article: "la",  gender: "f", image: "suisse.jpg",    definition: "pays alpin neutre" },
