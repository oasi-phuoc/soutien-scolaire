...
export const NATIONALITES_A1_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "Italie",       article: "l'",  gender: "f", image: "/vocab/images/italie.jpg",    definition: "pays de la botte" },
    ...
    { word: "Espagne",      article: "l'",  gender: "f", image: "/vocab/images/espagne.jpg",   definition: "pays ibérique" },
    { word: "Allemagne",    article: "l'",  gender: "f", image: "/vocab/images/allemagne.jpg", definition: "pays d'Europe centrale" },
    { word: "Suisse",       article: "la",  gender: "f", image: "/vocab/images/suisse.jpg",    definition: "pays alpin neutre" },
