...
export const NATIONALITES_A1_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "Italie",       article: "l'",  gender: "f", definition: "pays de la botte" },
    ...
    { word: "Espagne",      article: "l'",  gender: "f", definition: "pays ibérique" },
    { word: "Allemagne",    article: "l'",  gender: "f", definition: "pays d'Europe centrale" },
    { word: "Suisse",       article: "la",  gender: "f", definition: "pays alpin neutre" },
