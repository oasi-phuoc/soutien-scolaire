  ...
  exercises: [
    {
      ...
      pool: [
        ...
        { sentence: "finir → tu : ___", hint: "finir → finis", answer: "Finis !" },
        { sentence: "partir → tu : ___", hint: "partir → pars", answer: "Pars !" },
        { sentence: "manger → nous : ___", hint: "nous mangeons → mangeons", answer: "Mangeons !" },
        { sentence: "finir → nous : ___", hint: "nous finissons → finissons", answer: "Finissons !" },
        { sentence: "parler → vous : ___", hint: "vous parlez → parlez", answer: "Parlez !" },
        { sentence: "choisir → vous : ___", hint: "vous choisissez → choisissez", answer: "Choisissez !" },
        { sentence: "être → tu : ___", hint: "irrégulier : sois", answer: "Sois !" },
        { sentence: "avoir → vous : ___", hint: "irrégulier : ayez", answer: "Ayez !" },
        { sentence: "aller → tu : ___", hint: "irrégulier : va", answer: "Va !" },
      ],
      poolSize: 7,
    },
    {
      ...
      pool: [
        ...
        { sentence: "Mangez ! → ___ !", hint: "ne...pas encadre le verbe", answer: "Ne mangez pas" },
        { sentence: "Soyons patients ! → ___ !", hint: "ne...pas encadre le verbe", answer: "Ne soyons pas impatients" },
        { sentence: "Pars ! → ___ !", hint: "ne...pas encadre le verbe", answer: "Ne pars pas" },
        { sentence: "Finis ça ! → ___ !", hint: "ne...pas encadre le verbe", answer: "Ne finis pas ça" },
        { sentence: "Allez vite ! → ___ !", hint: "ne...pas encadre le verbe", answer: "N'allez pas vite" },
      ],
      poolSize: 5,
    },
    {
      ...
      items: [],
      pool: [
        { word: "Ne touche pas à ça !", categoryIdx: 0 },
        { word: "Tu devrais travailler plus.", categoryIdx: 1 },
        { word: "Venez dîner chez nous !", categoryIdx: 2 },
        { word: "Arrête de parler !", categoryIdx: 0 },
        { word: "Mange moins de sucre.", categoryIdx: 1 },
        { word: "Entrez, je vous en prie !", categoryIdx: 2 },
        { word: "Ferme la porte !", categoryIdx: 0 },
        { word: "Repose-toi un peu.", categoryIdx: 1 },
      ],
      poolSize: 6,
    },
    {
