  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Tu vas au stade ? — Oui, j'___ vais.", choices: ["y", "en", "le"], correctIdx: 0 },
        { sentence: "Non, j'___ viens. (du stade)", choices: ["en", "y", "du"], correctIdx: 0 },
        { sentence: "Vous habitez en Suisse ? — Je n'___ habite plus.", choices: ["y", "en", "la"], correctIdx: 0 },
        { sentence: "Tu vas acheter le pain ? — J'___ vais.", choices: ["y", "en", "le"], correctIdx: 0 },
        { sentence: "Vous sortez de la cafétéria ? — Nous ___ sortons.", choices: ["en", "y", "de"], correctIdx: 0 },
        { sentence: "Je vais ___ aller avec Jérôme.", choices: ["y", "en", "là"], correctIdx: 0 },
        { sentence: "Il va bientôt ___ sortir.", choices: ["en", "y", "de"], correctIdx: 0 },
        { sentence: "Je n'___ vais pas.", choices: ["y", "en", "le"], correctIdx: 0 },
        { sentence: "Elle n'___ est pas sortie.", choices: ["en", "y", "de"], correctIdx: 0 },
        { sentence: "___ , j'ai compris !", choices: ["Ça y est", "Ça en est", "Y est ça"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
