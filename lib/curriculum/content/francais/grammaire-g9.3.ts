  ...
  exercises: [
    {
      ...
      items: [],
      pool: [
        { sentence: "Attention ! Tu ___ tomber ! [imminent]", choices: ["vas", "tomberas", "tombes"], correctIdx: 0 },
        { sentence: "Dans dix ans, j'___ dans une grande ville. [éloigné]", choices: ["habiterai", "vais habiter", "habite"], correctIdx: 0 },
        { sentence: "Le train ___ partir dans 2 minutes ! [imminent]", choices: ["va", "partira", "part"], correctIdx: 0 },
        { sentence: "L'année prochaine, ils ___ en Italie. [prévision éloignée]", choices: ["voyageront", "vont voyager", "voyagent"], correctIdx: 0 },
        { sentence: "Je ___ appeler demain matin. [intention décidée]", choices: ["vais", "appellerai", "appelle"], correctIdx: 0 },
        { sentence: "Dans 20 ans, les robots ___ nos maisons. [prévision]", choices: ["construiront", "vont construire", "construisent"], correctIdx: 0 },
        { sentence: "On ___ manger, j'ai faim. [immédiat]", choices: ["va", "mangera", "mange"], correctIdx: 0 },
        { sentence: "En 2050, les énergies renouvelables ___ partout. [futur lointain]", choices: ["seront", "vont être", "sont"], correctIdx: 0 },
      ],
      poolSize: 6,
    },
    {
