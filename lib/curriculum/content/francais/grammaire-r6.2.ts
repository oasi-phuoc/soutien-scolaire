  ...
  exercises: [
    ...
    },
    {
      ...
      pool: [
        ...
        { sentence: "Si j'avais le temps, je ___ du sport. [improbable]", choices: ["ferais (cond.)", "ferai (futur)", "fais (présent)", "faisais (imp.)"], correctIdx: 0 },
        { sentence: "Si elle ___ étudié, elle aurait réussi. [impossible]", choices: ["avait (pqp)", "a (pc)", "aura (futur)", "aurait (cond.)"], correctIdx: 0 },
        { sentence: "S'il fait beau, nous ___ à la plage. [probable]", choices: ["irons (futur)", "irions (cond.)", "sommes allés", "allions"], correctIdx: 0 },
        { sentence: "Si nous avions su, nous ___ venu. [impossible]", choices: ["serions (cond. passé)", "serons (futur)", "sommes (présent)", "étions (imp.)"], correctIdx: 0 },
      ],
      poolSize: 4,
    },
    {
