  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Tu jugeras quand il ___ terminé.", choices: ["aura", "a", "avait"], correctIdx: 0 },
        { sentence: "Appelez-moi dès que vous ___ reçu le contrat.", choices: ["aurez", "avez", "aviez"], correctIdx: 0 },
        { sentence: "J'___ fini avant midi.", choices: ["aurai", "ai", "avais"], correctIdx: 0 },
        { sentence: "Tu ___ arrivé(e) demain.", choices: ["seras", "auras", "es"], correctIdx: 0 },
        { sentence: "Nous ___ partis avant midi.", choices: ["serons", "aurons", "sommes"], correctIdx: 0 },
        { sentence: "On continuera quand tu te ___ excusé(e).", choices: ["seras", "auras", "es"], correctIdx: 0 },
        { sentence: "Je n'___ pas fini avant midi.", choices: ["aurai", "ai", "avais"], correctIdx: 0 },
        { sentence: "Formation : auxiliaire au ___ + participe.", choices: ["futur simple", "présent", "imparfait"], correctIdx: 0 },
        { sentence: "Conjunction fréquente : ___", choices: ["dès que", "parce que", "mais"], correctIdx: 0 },
        { sentence: "Ils se ___ arrêtés.", choices: ["seront", "auront", "sont"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
