  ...
  theory: [
    ...
    },
    {
      ...
      transItems: {
        ...
        pt: ["{a}2.{/a} Falar de uma ação habitual."],
        so: ["{a}2.{/a} Ka hadal ficil caado ah."],
        ti: ["{a}2.{/a} ብዛዕባ ልሙድ ተግባር ምዝራብ።"],
        tr: ["{a}2.{/a} Alışkanlık olan bir eylemden söz etmek."],
        ps: ["{a}2.{/a} د عادت شوي عمل په اړه خبرې کول."],
    ...
    },
    {
      ...
      transItems: {
        ...
        pt: ["{a}3.{/a} Fazer uma descrição geral no presente, ou exprimir gostos e ideias."],
        so: ["{a}3.{/a} Bixi sharaxaad guud oo joogta ah, ama muuji waxyaabaha la jecel yahay iyo fikrado."],
        ti: ["{a}3.{/a} ኣብ ህሉው ግዜ ሓፈሻዊ መግለጺ ምሃብ፣ ወይ ድሌታትን ሓሳባትን ምግላጽ።"],
        tr: ["{a}3.{/a} Şimdiki zamanda genel bir betimleme yapmak veya beğenileri ve fikirleri ifade etmek."],
        ps: ["{a}3.{/a} په اوسني وخت کې عمومي تشریح ورکول، یا خوښې او نظریات څرګندول."],
