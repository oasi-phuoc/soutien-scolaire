  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Nous ___ dans le bus. (décor)", choices: ["étions", "avons été", "sommes", "serons"], correctIdx: 0 },
        { sentence: "Je ___ un livre. (en cours)", choices: ["lisais", "ai lu", "lis", "lirai"], correctIdx: 0 },
        { sentence: "Soudain, le chauffeur ___ .", choices: ["a freiné", "freinait", "freine", "freinera"], correctIdx: 0 },
        { sentence: "Elle ___ sur moi !", choices: ["est tombée", "tombait", "tombe", "tombera"], correctIdx: 0 },
        { sentence: "Avant, j'___ au bureau en voiture. (habitude)", choices: ["allais", "suis allé", "vais", "irai"], correctIdx: 0 },
        { sentence: "Un jour, j'___ un accident. (fin d'habitude)", choices: ["ai eu", "avais", "ai", "aurai"], correctIdx: 0 },
        { sentence: "J'___ en train de lire quand elle est tombée.", choices: ["étais", "ai été", "suis", "serai"], correctIdx: 0 },
        { sentence: "Elle est tombée ___ je lisais.", choices: ["pendant que", "soudain", "tout à coup", "un jour"], correctIdx: 0 },
        { sentence: "___ , le chauffeur a freiné.", choices: ["Soudain", "Pendant que", "Avant", "Toujours"], correctIdx: 0 },
        { sentence: "J'ai marché. ≠ Je ___ .", choices: ["marchais", "marche", "marcherai", "ai marché"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
