  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "La fille ___ sort avec Lucas.", choices: ["qui", "que", "où", "dont"], correctIdx: 0 },
        { sentence: "La fille ___ on a vue au cinéma.", choices: ["qu'", "qui", "où", "dont"], correctIdx: 0 },
        { sentence: "Un appartement ___ donne sur un parc.", choices: ["qui", "que", "où", "dont"], correctIdx: 0 },
        { sentence: "Le couple ___ nous avons rencontré.", choices: ["que", "qui", "où", "dont"], correctIdx: 0 },
        { sentence: "L'université ___ j'ai terminé mes études.", choices: ["où", "qui", "que", "dont"], correctIdx: 0 },
        { sentence: "Le jour ___ j'ai soutenu ma thèse.", choices: ["où", "qui", "que", "dont"], correctIdx: 0 },
        { sentence: "C'est toi ___ m'as présenté cette fille.", choices: ["qui", "que", "où", "qu'"], correctIdx: 0 },
        { sentence: "C'est elle ___ je connais le mieux.", choices: ["que", "qui", "où", "dont"], correctIdx: 0 },
        { sentence: "Une ville ___ il adore.", choices: ["qu'", "qui", "où", "que"], correctIdx: 0 },
        { sentence: "La fille ___ est là.", choices: ["qui", "qu'", "où", "que"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
