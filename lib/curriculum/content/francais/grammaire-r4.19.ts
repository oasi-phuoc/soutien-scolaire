...
export const A2_GR_L19: GrammarLesson = {
  ...
  theory: [
    { type: "heading", text: "Les pronoms relatifs : relier deux phrases", trans: { en: "Relative pronouns: linking two sentences", ar: "الضمائر الموصولة: ربط جملتين", fa: "ضمایر موصولی: پیوند دو جمله", ti: "ኣዛመድቲ ቃላት፦ ምትእስሳር ክልተ ሓረግ", uk: "Відносні займенники: з'єднання двох речень" } },
    {
      ...
      transItems: {
        en: ["A relative pronoun allows you to {a}link two sentences{/a} while avoiding a repetition.", "The two main ones: {a}qui{/a} (subject) and {a}que / qu'{/a} (direct object)."],
        ar: ["يسمح الضمير الموصول بـ{a}ربط جملتين{/a} مع تجنب التكرار.", "الرئيسيان: {a}qui{/a} (الفاعل) و{a}que / qu'{/a} (المفعول المباشر)."],
        fa: ["ضمیر موصولی امکان {a}پیوند دو جمله{/a} را بدون تکرار فراهم می‌کند.", "دو ضمیر اصلی: {a}qui{/a} (فاعل) و {a}que / qu'{/a} (مفعول مستقیم)."],
        ti: ["ኣዛማዲ ቃል {a}ክልተ ሓረግ ብምትእስሳር{/a} ምድግጋም የወግድ።", "እቶም ክልተ ቀንዲ፦ {a}qui{/a} (ባዕሉ) ከምኡውን {a}que / qu'{/a} (ቀጥታዊ ኣቕሓ)።"],
        uk: ["Відносний займенник дозволяє {a}з'єднати два речення{/a}, уникаючи повтору.", "Два основні: {a}qui{/a} (підмет) і {a}que / qu'{/a} (прямий додаток)."],
      },
    },
    {
      type: "grid",
