  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je crois qu'ils ___ par la fenêtre. (entrer)", choices: ["sont entrés", "soient entrés", "aient entrés"], correctIdx: 0 },
        { sentence: "Je ne crois pas qu'ils ___ par l'extérieur. (passer)", choices: ["soient passés", "sont passés", "passent"], correctIdx: 0 },
        { sentence: "Je vous assure qu'un cambrioleur ___ chez moi.", choices: ["est entré", "soit entré", "entre"], correctIdx: 0 },
        { sentence: "C'est incroyable qu'il ___ par la fenêtre !", choices: ["soit passé", "est passé", "passe"], correctIdx: 0 },
        { sentence: "Je pense qu'il y ___ un seul cambrioleur.", choices: ["avait", "ait", "ait eu"], correctIdx: 0 },
        { sentence: "Je suis convaincu que la police ___ l'arrêter.", choices: ["va", "aille", "ait"], correctIdx: 0 },
        { sentence: "Affirmatif (penser/croire) → ___ .", choices: ["indicatif", "subjonctif", "impératif"], correctIdx: 0 },
        { sentence: "Sentiment / appréciation → ___ .", choices: ["subjonctif", "indicatif", "impératif"], correctIdx: 0 },
        { sentence: "On voit qu'il n'y ___ pas de trace.", choices: ["a", "ait", "soit"], correctIdx: 0 },
        { sentence: "Je ne pense pas qu'il ___ (quasi-certitude).", choices: ["est entré", "soit entré", "entre"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
