  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Il pense à son film. → Il ___ pense.", choices: ["y", "en", "à lui", "le"], correctIdx: 0 },
        { sentence: "Il pense à une actrice. → Il pense ___ .", choices: ["à elle", "y", "en", "la"], correctIdx: 0 },
        { sentence: "Il a besoin d'un scénario. → Il ___ a besoin.", choices: ["en", "y", "de lui", "le"], correctIdx: 0 },
        { sentence: "Il a besoin de cette actrice. → Il a besoin ___ .", choices: ["d'elle", "en", "y", "de la"], correctIdx: 0 },
        { sentence: "Je ___ occupe. (de ça)", choices: ["m'en", "m'y", "me", "en me"], correctIdx: 0 },
        { sentence: "Je ___ intéresse. (à ça)", choices: ["m'y", "m'en", "me", "y me"], correctIdx: 0 },
        { sentence: "Elle ___ souvient. (de ça)", choices: ["s'en", "s'y", "se", "en se"], correctIdx: 0 },
        { sentence: "On ___ inscrit. (à ça)", choices: ["s'y", "s'en", "se", "y se"], correctIdx: 0 },
        { sentence: "Je ne m'___ occupe pas.", choices: ["en", "y", "à", "de"], correctIdx: 0 },
        { sentence: "Il ne s'___ habitue pas.", choices: ["y", "en", "à", "de"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
