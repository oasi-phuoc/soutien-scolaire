...
export const A2_GR_FUTUR_IRREGULIERS: GrammarLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      items: [],
      pool: [
        { sentence: "Demain, je ___ au cinéma.", choices: ["irai", "allerai", "vais"], correctIdx: 0 },
        { sentence: "Elle ___ de la musique.", choices: ["fera", "faisera", "ferait"], correctIdx: 0 },
        { sentence: "Ils ___ beaucoup de travail.", choices: ["auront", "avront", "aurait"], correctIdx: 0 },
        { sentence: "Tu ___ nous rendre visite.", choices: ["pourras", "pourrais", "peux"], correctIdx: 0 },
        { sentence: "Il ___ apprendre cette règle.", choices: ["voudra", "vouldra", "voulera"], correctIdx: 0 },
        { sentence: "Je ___ en France l'été prochain.", choices: ["serai", "serais", "suis"], correctIdx: 0 },
      ],
      poolSize: 5,
    },
    {
