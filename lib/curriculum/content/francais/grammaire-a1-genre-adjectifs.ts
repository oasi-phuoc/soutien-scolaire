  ...
  theory: [
    ...
    },
    {
      ...
      transHeaders: {
        ...
        pt: ["Masculino antes de consoante", "Masculino antes de vogal/h mudo", "Feminino", "Plural masculino"],
        so: ["Lab ka hor shibbane", "Lab ka hor shaqal/h aan la dhawaaqin", "Dheddig", "Jamac lab"],
        ti: ["ተባዕታይ ቅድሚ ተናባቢ", "ተባዕታይ ቅድሚ ናይ ድምጺ ፊደል / h ዝሕባእ", "ኣንስታይ", "ባዙሕ ተባዕታይ"],
        tr: ["Ünsüzden önce eril", "Ünlü/sessiz h’den önce eril", "Dişil", "Eril çoğul"],
        ps: ["له بې‌واکه توري مخکې مذکر", "له واکې/بې‌غږه h مخکې مذکر", "مؤنث", "مذکر جمع"],
