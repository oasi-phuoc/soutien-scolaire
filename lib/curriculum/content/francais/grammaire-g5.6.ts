...
export const A1_GR_AUTRES_NEGATIONS: GrammarLesson = {
  ...
  theory: [
            ...
            },
            {
              ...
              rows: [
                ...
                [
                  ...
                  "Elle {a}n'{/a}ai {a}jamais{/a} visité Lucerne."
                ],
              ],
            },
          ],
            ...
            },
            {
              ...
              rows: [
                ...
                [
                  ...
                  "Il {a}n'{/a} a {a}pas encore{/a} terminé son travail."
                ],
                [
                  "Elle est partie.",
                  "Elle {a}n'{/a} est {a}pas encore{/a} partie."
                ],
              ],
            },
          ],
            ...
            },
            {
              ...
              rows: [
                ...
                [
                  ...
                  "Elle {a}n'{/a} invite {a}personne{/a}."
                ],
                [
            ...
            },
            {
              ...
              rows: [
                ...
                [
                  ...
                  "Nous {a}n'{/a} avons {a}ni{/a} chat {a}ni{/a} chien."
                ],
                [
    ...
    {
      type: "text",
      text: "{a}Ne ... que{/a} signifie « seulement ». Cette structure n'est pas une négation. Elle permet de limiter ce qui est dit.",
      transText: {
    ...
    },
    {
      ...
      rows: [
        [
          "Je parle {a}seulement{/a} français.",
          "Je {a}ne{/a} parle {a}que{/a} français."
        ],
        [
          "Elle mange {a}seulement{/a} des légumes.",
          "Elle {a}ne{/a} mange {a}que{/a} des légumes."
        ],
        [
          "Nous travaillons {a}seulement{/a} les lundis.",
          "Nous {a}ne{/a} travaillons {a}que{/a} le lundi."
        ],
        [
          "Il boit {a}seulement{/a} du thé.",
