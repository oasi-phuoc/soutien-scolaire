...
export const A1_GR_PHRASES: GrammarLesson = {
  ...
  theory: [
    ...
    {
      type: "text",
      text: "On peut poser différentes questions :",
      transText: {
        en: "We can ask different questions:",
        ar: "يمكننا طرح أسئلة مختلفة:",
        fa: "می‌توانیم پرسش‌های مختلفی مطرح کنیم:",
        pt: "Podemos fazer perguntas diferentes:",
        so: "Waxaan weydiin karnaa su'aalo kala duwan:",
        ti: "እዞም ዝተፈላለዩ ሕቶታት ክንሓትት ንኽእል፦",
        tr: "Farklı sorular sorabiliriz:",
        ps: "موږ بېلابېلې پوښتنې کولی شو:",
        uk: "Можна поставити різні запитання:",
      },
    },
    {
      type: "text",
      ...
      transText: {
        en: "The complement answers the question {a}quoi ?{/a} or {a}qui ?{/a}.",
        ar: "يجيب المتمم عن السؤال {a}quoi ?{/a} أو {a}qui ?{/a}.",
        fa: "متمم به پرسش {a}quoi ?{/a} یا {a}qui ?{/a} پاسخ می‌دهد.",
        pt: "O complemento responde à pergunta {a}quoi ?{/a} ou {a}qui ?{/a}.",
        so: "Dhammaystirku wuxuu ka jawaabaa su'aasha {a}quoi ?{/a} ama {a}qui ?{/a}.",
        ti: "መላእታ ነቲ {a}quoi ?{/a} ወይ {a}qui ?{/a} ዝብል ሕቶ ይምልስ።",
        tr: "Tümleç {a}quoi ?{/a} veya {a}qui ?{/a} sorusuna cevap verir.",
    ...
    },
    {
      ...
      transText: {
        en: "The complement answers the question {a}à qui ?{/a} or {a}à quoi ?{/a}.",
        ar: "يجيب المتمم عن السؤال {a}à qui ?{/a} أو {a}à quoi ?{/a}.",
        fa: "متمم به پرسش {a}à qui ?{/a} یا {a}à quoi ?{/a} پاسخ می‌دهد.",
        pt: "O complemento responde à pergunta {a}à qui ?{/a} ou {a}à quoi ?{/a}.",
        so: "Dhammaystirku wuxuu ka jawaabaa su'aasha {a}à qui ?{/a} ama {a}à quoi ?{/a}.",
        ti: "መላእታ ነቲ {a}à qui ?{/a} ወይ {a}à quoi ?{/a} ዝብል ሕቶ ይምልስ።",
        tr: "Tümleç {a}à qui ?{/a} veya {a}à quoi ?{/a} sorusuna cevap verir.",
    ...
    },
    {
      ...
      transText: {
        en: "The complement answers the question {a}où ?{/a}, {a}quand ?{/a}, or {a}comment ?{/a}.",
        ar: "يجيب المتمم عن السؤال {a}où ?{/a} أو {a}quand ?{/a} أو {a}comment ?{/a}.",
        fa: "متمم به پرسش {a}où ?{/a}، {a}quand ?{/a} یا {a}comment ?{/a} پاسخ می‌دهد.",
        pt: "O complemento responde à pergunta {a}où ?{/a}, {a}quand ?{/a} ou {a}comment ?{/a}.",
        so: "Dhammaystirku wuxuu ka jawaabaa su'aasha {a}où ?{/a}, {a}quand ?{/a} ama {a}comment ?{/a}.",
        ti: "መላእታ ነቲ {a}où ?{/a}፣ {a}quand ?{/a} ወይ {a}comment ?{/a} ዝብል ሕቶ ይምልስ።",
        tr: "Tümleç {a}où ?{/a}, {a}quand ?{/a} veya {a}comment ?{/a} sorularına cevap verir.",
