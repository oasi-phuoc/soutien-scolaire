  ...
  exercises: [
    {
      ...
      items: [],
      pool: [
        { sentence: "Avant, je ___ tous les matins. [habitude]", choices: ["courais", "ai couru", "courrais"], correctIdx: 0 },
        { sentence: "Hier, je ___ dix kilomètres. [action ponctuelle]", choices: ["ai couru", "courais", "courrais"], correctIdx: 0 },
        { sentence: "Quand j'étais enfant, nous ___ à Lyon. [description]", choices: ["habitions", "avons habité", "habitons"], correctIdx: 0 },
        { sentence: "L'année dernière, nous ___ en Espagne. [événement terminé]", choices: ["avons déménagé", "déménagions", "déménageons"], correctIdx: 0 },
        { sentence: "Il ___ dans la rue quand il a vu un accident. [action en cours]", choices: ["marchait", "a marché", "marcherait"], correctIdx: 0 },
        { sentence: "Soudain, le téléphone ___. [événement soudain]", choices: ["a sonné", "sonnait", "sonnera"], correctIdx: 0 },
        { sentence: "Quand elle était petite, elle ___ du piano. [habitude]", choices: ["jouait", "a joué", "jouerait"], correctIdx: 0 },
        { sentence: "Ce matin, j'___ un email important. [événement ponctuel]", choices: ["ai reçu", "recevais", "reçois"], correctIdx: 0 },
        { sentence: "Pendant que je ___, elle regardait la télé. [simultanéité]", choices: ["cuisinais", "ai cuisiné", "cuisinerai"], correctIdx: 0 },
        { sentence: "Il ___ son travail à 18h hier. [action terminée]", choices: ["a fini", "finissait", "finit"], correctIdx: 0 },
      ],
      poolSize: 6,
    },
    {
