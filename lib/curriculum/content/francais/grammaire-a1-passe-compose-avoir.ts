  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Hier, j'___ organisé la fête.", choices: ["ai", "as", "a", "avons"], correctIdx: 0 },
        { sentence: "Tu ___ rangé la salle.", choices: ["as", "ai", "a", "avez"], correctIdx: 0 },
        { sentence: "Nous ___ préparé le repas.", choices: ["avons", "avez", "ont", "ai"], correctIdx: 0 },
        { sentence: "Ils ___ vérifié la sono.", choices: ["ont", "avez", "avons", "a"], correctIdx: 0 },
        { sentence: "Je n'___ pas changé la décoration.", choices: ["ai", "as", "a", "avons"], correctIdx: 0 },
        { sentence: "finir → participe : ___", choices: ["fini", "finé", "finis", "finit"], correctIdx: 0 },
        { sentence: "prendre → participe : ___", choices: ["pris", "prendu", "prit", "prenu"], correctIdx: 0 },
        { sentence: "ouvrir → participe : ___", choices: ["ouvert", "ouvri", "ouvru", "ouvris"], correctIdx: 0 },
        { sentence: "faire → participe : ___", choices: ["fait", "fairé", "fais", "faité"], correctIdx: 0 },
        { sentence: "Avec avoir, le participe ___ avec le sujet.", choices: ["ne s'accorde pas", "s'accorde toujours", "s'accorde au féminin", "s'accorde au pluriel"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
