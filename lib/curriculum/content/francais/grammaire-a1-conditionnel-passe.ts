  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Tu ___ me prévenir. (devoir)", choices: ["aurais dû", "as dû", "auras dû", "avais dû"], correctIdx: 0 },
        { sentence: "J'___ t'appeler. (vouloir, regret)", choices: ["aurais voulu", "ai voulu", "voudrais", "voulais"], correctIdx: 0 },
        { sentence: "À ta place, je ___ plus tôt. (arriver, être)", choices: ["serais arrivé", "suis arrivé", "arriverais", "étais arrivé"], correctIdx: 0 },
        { sentence: "À votre place, nous ___ . (s'inquiéter)", choices: ["nous serions inquiétés", "nous sommes inquiétés", "nous inquiéterions", "nous étions inquiétés"], correctIdx: 0 },
        { sentence: "Vous n'auriez ___ dû arriver si tard !", choices: ["pas", "point", "jamais de", "rien"], correctIdx: 0 },
        { sentence: "Formation : auxiliaire au ___ + participe passé.", choices: ["conditionnel présent", "imparfait", "futur", "subjonctif"], correctIdx: 0 },
        { sentence: "À ta place, j'___ . (téléphoner)", choices: ["aurais téléphoné", "ai téléphoné", "téléphonerais", "téléphonais"], correctIdx: 0 },
        { sentence: "Regret : souvent avec ___ .", choices: ["aimer / vouloir", "aller / venir", "être / avoir seulement", "dire / faire"], correctIdx: 0 },
        { sentence: "Reproche : souvent avec ___ .", choices: ["devoir / pouvoir", "aimer / préférer", "aller / venir", "être / sembler"], correctIdx: 0 },
        { sentence: "Elle ___ venir. (pouvoir, reproche)", choices: ["aurait pu", "a pu", "pourrait", "pouvait"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
