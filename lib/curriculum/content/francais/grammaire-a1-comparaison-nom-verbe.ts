  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Il y a ___ lignes de métro que de bus.", choices: ["moins de", "moins", "autant", "plus"], correctIdx: 0 },
        { sentence: "Le métro transporte ___ voyageurs.", choices: ["plus de", "plus", "autant", "moins"], correctIdx: 0 },
        { sentence: "Le métro ne pollue pas ___ les bus.", choices: ["autant que", "autant de", "plus de", "moins de"], correctIdx: 0 },
        { sentence: "Les métros font ___ bruit que les trains.", choices: ["autant de", "autant", "plus", "moins"], correctIdx: 0 },
        { sentence: "Je prends le ___ bus que ma voisine.", choices: ["même", "mêmes", "plus", "autant"], correctIdx: 0 },
        { sentence: "Les voitures polluent ___ que le métro.", choices: ["plus", "plus de", "autant de", "moins de"], correctIdx: 0 },
        { sentence: "Le métro pollue ___ que les bus.", choices: ["moins", "moins de", "autant de", "plus de"], correctIdx: 0 },
        { sentence: "Il fait ___ moi.", choices: ["comme", "autant de", "plus de", "le même"], correctIdx: 0 },
        { sentence: "Je déteste le métro autant que ___ .", choices: ["toi", "tu", "te", "ton"], correctIdx: 0 },
        { sentence: "On a ___ tickets.", choices: ["les mêmes", "le même", "autant", "plus de"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
