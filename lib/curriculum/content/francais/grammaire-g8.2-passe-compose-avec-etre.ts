...
export const A1_CONJ_L30: ConjLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      items: [],
      pool: [
        { sentence: "Elle ___ à Paris.", choices: ["est allée", "est allé", "a allé"], correctIdx: 0 },
        { sentence: "Ils ___ hier soir.", choices: ["sont arrivés", "sont arrivé", "ont arrivé"], correctIdx: 0 },
        { sentence: "Ma mère ___ tôt.", choices: ["est partie", "est parti", "a parti"], correctIdx: 0 },
        { sentence: "Mes sœurs ___ du cinéma.", choices: ["sont revenues", "sont revenu", "ont revenues"], correctIdx: 0 },
        { sentence: "Tu ___ à la gare ? [masc.]", choices: ["es arrivé", "es arrivée", "as arrivé"], correctIdx: 0 },
        { sentence: "Nous ___ longtemps. [fém. pl.]", choices: ["sommes restées", "sommes restés", "avons resté"], correctIdx: 0 },
        { sentence: "Le médecin ___ de bonne heure.", choices: ["est venu", "est venue", "a venu"], correctIdx: 0 },
        { sentence: "Les étudiants ___ en cours.", choices: ["sont entrés", "sont entrées", "ont entré"], correctIdx: 0 },
      ],
      poolSize: 6,
    },
    {
