  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ferai tout mon possible ___ être là. (même sujet)", choices: ["pour", "pour que", "afin que", "quand"], correctIdx: 0 },
        { sentence: "Je ferai tout mon possible ___ nous soyons tous ensemble.", choices: ["pour que", "pour", "afin de", "après que"], correctIdx: 0 },
        { sentence: "Je ferai tout ___ d'être là. (soutenu, même sujet)", choices: ["afin", "pour que", "afin que", "après"], correctIdx: 0 },
        { sentence: "… pour que nous soyons ensemble et ___ nous fassions la fête.", choices: ["que", "pour que", "afin que", "de"], correctIdx: 0 },
        { sentence: "… afin d'être avec vous et ___ faire la fête.", choices: ["de", "afin de", "pour", "que"], correctIdx: 0 },
        { sentence: "Je viendrai pour ___ manquer cette fête.", choices: ["ne pas", "pas ne", "ne", "pas"], correctIdx: 0 },
        { sentence: "Sujets différents → ___ + subjonctif.", choices: ["pour que", "pour", "afin de", "après que"], correctIdx: 0 },
        { sentence: "Même sujet → ___ + infinitif.", choices: ["pour", "pour que", "afin que", "jusqu'à ce que"], correctIdx: 0 },
        { sentence: "___ / afin de : langue soutenue.", choices: ["Afin que", "Alors", "Donc", "Quand"], correctIdx: 0 },
        { sentence: "Je ferai tout pour que nous ___ tous ensemble. (être)", choices: ["soyons", "sommes", "serons", "être"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
