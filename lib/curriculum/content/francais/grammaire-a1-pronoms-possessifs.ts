  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Alex, c'est ___ ? (ton portable)", choices: ["le tien", "la tienne", "le sien", "le vôtre"], correctIdx: 0 },
        { sentence: "mon collègue → ___", choices: ["le mien", "la mienne", "les miens", "le nôtre"], correctIdx: 0 },
        { sentence: "ma sœur → ___", choices: ["la mienne", "le mien", "les miennes", "la nôtre"], correctIdx: 0 },
        { sentence: "mes copains → ___", choices: ["les miens", "les miennes", "le mien", "les nôtres"], correctIdx: 0 },
        { sentence: "notre maison → ___", choices: ["la nôtre", "le nôtre", "la vôtre", "la leur"], correctIdx: 0 },
        { sentence: "vos parents → ___", choices: ["les vôtres", "les nôtres", "les leurs", "les tiens"], correctIdx: 0 },
        { sentence: "son sac → ___", choices: ["le sien", "la sienne", "le tien", "le leur"], correctIdx: 0 },
        { sentence: "ses clés → ___", choices: ["les siennes", "les siens", "les tiennes", "les leurs"], correctIdx: 0 },
        { sentence: "leur chien → ___", choices: ["le leur", "la leur", "le sien", "le nôtre"], correctIdx: 0 },
        { sentence: "C'est ___ voiture ? — Oui, c'est la nôtre.", choices: ["votre", "vôtre", "notre", "leur"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
