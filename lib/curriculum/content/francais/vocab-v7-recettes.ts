...
export const V7_RECETTES_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "œuf", image: "oeuf.jpg",         article: "l'",  gender: "m", definition: "ingrédient pondu par la poule" },
    { word: "beurre", image: "beurre.jpg",      article: "le",  gender: "m", definition: "matière grasse faite de crème de lait" },
    { word: "ingrédient", image: "ingredient.jpg",  article: "l'",  gender: "m", definition: "élément de base d'une recette" },
    { word: "pâte", image: "pate.jpg",        article: "la",  gender: "f", definition: "mélange de farine et liquide pour cuisiner" },
    ...
    { word: "mélange", image: "melange.jpg",     article: "le",  gender: "m", definition: "résultat de la combinaison de plusieurs ingrédients" },
  ],
  sentences: [
