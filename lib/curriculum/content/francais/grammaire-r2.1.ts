...
export const A1_CONJ_L08: ConjLesson = {
  ...
  evalExercises: [
    ...
    },
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je vais ___ supermarché.",       choices: ["au",   "à le", "en",  "à"],   correctIdx: 0 },
        { sentence: "Elle vient ___ Espagne.",        choices: ["d'",   "de",   "du",  "des"],  correctIdx: 0 },
        { sentence: "Ils vont ___ États-Unis.",       choices: ["aux",  "au",   "en",  "à"],   correctIdx: 0 },
        { sentence: "Je vais ___ pharmacie.",         choices: ["à la", "au",   "à le","en"],   correctIdx: 0 },
        { sentence: "Il part ___ Tokyo.",             choices: ["pour", "à",    "en",  "au"],   correctIdx: 0 },
        { sentence: "Tu viens ___ école ?",           choices: ["de l'","du",   "de",  "d'"],   correctIdx: 0 },
        { sentence: "Elle monte ___ voiture.",        choices: ["dans la","dans le","au","en"],  correctIdx: 0 },
        { sentence: "Nous arrivons ___ travail.",     choices: ["du",   "de le","de",  "à"],    correctIdx: 0 },
      ],
    },
  ],
};
