...
export const V4_TYPE_LOGEMENT_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "résidence", image: "residence.jpg",   article: "la",  gender: "f", definition: "ensemble d'habitations avec services communs" },
    ...
    { word: "gîte", image: "gite.jpg",        article: "le",  gender: "m", definition: "logement de vacances à la campagne" },
