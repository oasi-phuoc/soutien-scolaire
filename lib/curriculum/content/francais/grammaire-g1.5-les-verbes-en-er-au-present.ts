...
export const A1_CONJ_L07: ConjLesson = {
  ...
  evalExercises: [
    ...
    },
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Elle ___ à Paris. (habiter)",    choices: ["habite", "habites", "habitons"],      correctIdx: 0 },
        { sentence: "Vous ___ le français. (parler)", choices: ["parlez", "parlons", "parle"],      correctIdx: 0 },
        { sentence: "Ils ___ beaucoup. (travailler)", choices: ["travaillent", "travaille", "travaillons"],   correctIdx: 0 },
        { sentence: "Nous ___ du sport. (aimer)",     choices: ["aimons", "aiment", "aimez"],        correctIdx: 0 },
        { sentence: "Tu ___ la radio ? (écouter)",    choices: ["écoutes", "écoute", "écoutez"],     correctIdx: 0 },
        { sentence: "Je ___ un livre. (chercher)",    choices: ["cherche", "cherches", "cherchons"],     correctIdx: 0 },
        { sentence: "Il ___ du sport. (pratiquer)",   choices: ["pratique", "pratiques", "pratiquons"],    correctIdx: 0 },
        { sentence: "Elles ___ à 8h. (arriver)",      choices: ["arrivent", "arrivez", "arrivons"],       correctIdx: 0 },
      ],
    },
  ],
};
