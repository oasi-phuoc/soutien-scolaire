  ...
  exercises: [
    {
      ...
      pool: [
        ...
        { sentence: "J'ai ___ ! (rollers identiques)", choices: ["les mêmes", "le même", "l'autre", "quelques-uns"], correctIdx: 0 },
        { sentence: "Pas ___ chaussette.", choices: ["l'autre", "les mêmes", "quelqu'un", "tout"], correctIdx: 0 },
        { sentence: "J'en ai ___ dans mon sac.", choices: ["une autre", "l'autre", "les mêmes", "tout"], correctIdx: 0 },
        { sentence: "___ est belge et l'autre est suisse.", choices: ["L'un", "L'autre", "Quelqu'un", "Chacun"], correctIdx: 0 },
        { sentence: "___ est venu te voir hier.", choices: ["Quelqu'un", "Quelque chose", "N'importe quoi", "L'autre"], correctIdx: 0 },
        { sentence: "Quelque chose ___ important.", choices: ["d'", "de la", "du", "des"], correctIdx: 0 },
        { sentence: "Donne-moi ___ à boire.", choices: ["n'importe quoi", "quelqu'un", "l'autre", "tous"], correctIdx: 0 },
        { sentence: "Tu dis ___ ! (= des bêtises)", choices: ["n'importe quoi", "quelque chose", "n'importe qui", "l'autre"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
