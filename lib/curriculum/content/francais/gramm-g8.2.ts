  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ___ rentré en train.", choices: ["suis", "ai", "est"], correctIdx: 0 },
        { sentence: "Elle ___ sortie hier.", choices: ["est", "a", "sont"], correctIdx: 0 },
        { sentence: "Nous ___ arrivés à l'heure.", choices: ["sommes", "avons", "êtes"], correctIdx: 0 },
        { sentence: "Ils ___ partis tôt.", choices: ["sont", "ont", "sommes"], correctIdx: 0 },
        { sentence: "Marie est ___ .", choices: ["arrivée", "arrivé", "arrivés"], correctIdx: 0 },
        { sentence: "J'___ monté les valises. (COD)", choices: ["ai", "suis", "est"], correctIdx: 0 },
        { sentence: "Je ___ monté en ascenseur.", choices: ["suis", "ai", "est"], correctIdx: 0 },
        { sentence: "Je ___ réveillé à 6 heures.", choices: ["me suis", "m'ai", "suis me"], correctIdx: 0 },
        { sentence: "Ils se ___ amusés.", choices: ["sont", "ont", "sommes"], correctIdx: 0 },
        { sentence: "Je ne ___ pas parti.", choices: ["suis", "ai", "me suis"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
