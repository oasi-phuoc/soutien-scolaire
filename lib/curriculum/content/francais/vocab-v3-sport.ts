...
export const V3_SPORT_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "vélo",     image: "velo.jpg",       article: "le",  gender: "m", definition: "sport et moyen de transport à deux roues" },
    ...
    { word: "randonnée", image: "randonnee.jpg", article: "la",  gender: "f", definition: "longue marche en pleine nature" },
    { word: "judo", image: "judo.jpg",         article: "le",  gender: "m", definition: "art martial japonais" },
    { word: "gymnastique", image: "gymnastique.avif",  article: "la",  gender: "f", definition: "sport d'agilité et de souplesse" },
    ...
    { word: "volley-ball", image: "volley-ball.avif",  article: "le",  gender: "m", definition: "sport collectif où l'on frappe un ballon par-dessus un filet" },
