  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Bruno est rentré ___ 3 mois.", choices: ["il y a", "dans", "depuis"], correctIdx: 0 },
        { sentence: "Clara va partir ___ deux mois.", choices: ["dans", "il y a", "depuis"], correctIdx: 0 },
        { sentence: "Je travaille ___ le 1er avril.", choices: ["depuis", "il y a", "dans"], correctIdx: 0 },
        { sentence: "Clara va partir ___ un mois.", choices: ["pour", "depuis", "il y a"], correctIdx: 0 },
        { sentence: "___ les vacances, je me repose.", choices: ["Pendant", "En", "Dans"], correctIdx: 0 },
        { sentence: "Je vais au travail ___ une demi-heure.", choices: ["en", "pendant", "depuis"], correctIdx: 0 },
        { sentence: "Le magasin ouvre ___ du 1er décembre.", choices: ["à partir", "jusqu'à", "depuis"], correctIdx: 0 },
        { sentence: "J'ai travaillé ___ minuit.", choices: ["jusqu'à", "à partir de", "depuis"], correctIdx: 0 },
        { sentence: "Il va partir ___ mai.", choices: ["jusqu'en", "jusqu'à", "depuis"], correctIdx: 0 },
        { sentence: "Ils sont mariés ___ 35 ans.", choices: ["depuis", "il y a", "dans"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
