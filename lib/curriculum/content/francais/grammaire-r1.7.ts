...
export const A1_GR_L02: GrammarLesson = {
  ...
  evalExercises: [
    ...
    // ── Éval 2 — QCM: Choisissez la bonne forme négative ─────────────────────
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ___ mange ___ viande. (pas de)",       choices: ["ne … pas de", "ne … pas", "n' … plus"],    correctIdx: 0 },
        { sentence: "Il ___ vient ___ ici. (jamais)",          choices: ["ne … jamais", "ne … pas", "n' … plus"],    correctIdx: 0 },
        { sentence: "Elle ___ travaille ___ ici. (plus)",      choices: ["ne … plus", "ne … pas", "n' … jamais"],  correctIdx: 0 },
        { sentence: "Nous ___ avons ___ d'argent. (pas)",      choices: ["n' … pas", "ne … pas", "ne … plus"],    correctIdx: 0 },
        { sentence: "Tu ___ écoutes ___ la radio. (pas)",      choices: ["n' … pas", "ne … pas", "ne … plus"],    correctIdx: 0 },
        { sentence: "Ils ___ mangent ___ de viande. (pas)",    choices: ["ne … pas", "ne … plus", "n' … jamais"], correctIdx: 0 },
        { sentence: "Je ___ fume ___ . (plus)",                choices: ["ne … plus", "ne … pas", "n' … jamais"],  correctIdx: 0 },
        { sentence: "Elle ___ sort ___ le soir. (jamais)",     choices: ["ne … jamais", "ne … pas", "ne … plus"],    correctIdx: 0 },
      ],
    },
  ],
};
