...
export const V9_PAYSAGE_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "forêt", image: "forêt.jpg",    article: "la",  gender: "f", definition: "grande étendue d'arbres" },
    { word: "rivière", image: "rivière.jpg",  article: "la",  gender: "f", definition: "cours d'eau naturel" },
    ...
    { word: "vallée", image: "vallée.jpg",   article: "la",  gender: "f", definition: "espace plat entre deux reliefs" },
    { word: "désert", image: "désert.jpg",   article: "le",  gender: "m", definition: "région très sèche et peu habitée" },
    { word: "île", image: "île.jpg",      article: "l'",  gender: "f", definition: "terre entourée d'eau de tous côtés" },
    ...
    { word: "côte", image: "côte.jpg",     article: "la",  gender: "f", definition: "zone littorale entre terre et mer" },
