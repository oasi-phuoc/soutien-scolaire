  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "L'été prochain, je ___ travailler dans un restaurant.", choices: ["vais", "vas", "va", "vont"], correctIdx: 0 },
        { sentence: "Vite, on ___ rater le train !", choices: ["va", "vais", "vas", "allons"], correctIdx: 0 },
        { sentence: "Il ___ pleuvoir.", choices: ["va", "vais", "vont", "allez"], correctIdx: 0 },
        { sentence: "Tu ___ partir à Bordeaux.", choices: ["vas", "vais", "va", "allez"], correctIdx: 0 },
        { sentence: "Nous ___ vivre en banlieue.", choices: ["allons", "allez", "vont", "vais"], correctIdx: 0 },
        { sentence: "Ils ___ s'installer à la campagne.", choices: ["vont", "allons", "allez", "va"], correctIdx: 0 },
        { sentence: "Nous allons ___ inscrire.", choices: ["nous", "se", "me", "vous"], correctIdx: 0 },
        { sentence: "Je ___ rester ici.", choices: ["ne vais pas", "vais ne pas", "ne pas vais", "pas vais ne"], correctIdx: 0 },
        { sentence: "On ne va pas ___ en banlieue.", choices: ["s'installer", "nous installer", "installer", "s'installe"], correctIdx: 0 },
        { sentence: "Formation : aller au ___ + infinitif.", choices: ["présent", "imparfait", "futur", "passé composé"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
