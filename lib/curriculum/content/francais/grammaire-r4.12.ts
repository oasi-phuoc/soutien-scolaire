...
export const A2_GR_L07: GrammarLesson = {
  ...
  evalExercises: [
    // ── Éval 1 — Fill: Est-ce que / Est-ce qu' ───────────────────────────────
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ tu parles français ?", answer: "Est-ce que", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ elle est médecin ?", answer: "Est-ce qu'", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ vous avez le temps ?", answer: "Est-ce que", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ il aime le café ?", answer: "Est-ce qu'", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ on peut entrer ?", answer: "Est-ce qu'", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ vous travaillez demain ?", answer: "Est-ce que", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ elles sont arrivées ?", answer: "Est-ce qu'", hint: "Est-ce que / Est-ce qu'" },
        { sentence: "___ tu comprends la question ?", answer: "Est-ce que", hint: "Est-ce que / Est-ce qu'" },
      ],
    },
