...
export const A1_GR_MODAUX: GrammarLesson = {
  ...
  theory: [
    ...
    {
      type: "text",
      text: "{a}Vouloir{/a} sert à exprimer un désir ou une volonté.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}Pouvoir{/a} sert à exprimer une capacité, une possibilité, une autorisation ou une interdiction (à la forme négative).",
      transText: {
    ...
    {
      type: "text",
      text: "{a}Devoir{/a} sert à exprimer une obligation, une nécessité, une interdiction (à la forme négative) ou une somme à payer.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}Il faut{/a} sert à exprimer une nécessité générale ou une interdiction (à la forme négative).",
      transText: {
    ...
    {
      type: "text",
      text: "{a}Savoir{/a} sert à exprimer une connaissance ou une compétence.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}Je voudrais{/a} un ticket de métro, s'il vous plaît.",
    },
  ],
