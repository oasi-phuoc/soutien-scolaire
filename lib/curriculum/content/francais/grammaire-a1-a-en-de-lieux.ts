  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "J'habite ___ Londres.", choices: ["à", "en", "au", "de"], correctIdx: 0 },
        { sentence: "J'habite ___ Angleterre.", choices: ["en", "à", "au", "aux"], correctIdx: 0 },
        { sentence: "Je suis née ___ Kenya.", choices: ["au", "en", "à", "du"], correctIdx: 0 },
        { sentence: "Je viens ___ Madrid.", choices: ["de", "à", "en", "du"], correctIdx: 0 },
        { sentence: "Je vais ___ États-Unis.", choices: ["aux", "au", "en", "à"], correctIdx: 0 },
        { sentence: "Je viens ___ États-Unis.", choices: ["des", "du", "de", "aux"], correctIdx: 0 },
        { sentence: "Je suis né ___ France.", choices: ["en", "à", "au", "de"], correctIdx: 0 },
        { sentence: "Il habite ___ Iran.", choices: ["en", "à", "au", "d'"], correctIdx: 0 },
        { sentence: "Elle revient ___ Iran.", choices: ["d'", "de", "du", "en"], correctIdx: 0 },
        { sentence: "Je rentre ___ Allemagne.", choices: ["d'", "de", "en", "à"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
