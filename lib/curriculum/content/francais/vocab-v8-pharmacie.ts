...
export const V8_PHARMACIE_THEME: VocabTheme = {
  ...
  section: "V8",
  words: [
    { word: "médicament", image: "medicament.jpg",  article: "le",  gender: "m", definition: "substance pour traiter une maladie" },
    ...
    { word: "comprimé", image: "comprime.jpg",    article: "le",  gender: "m", definition: "médicament solide en forme de pastille" },
    { word: "gélule", image: "gelule.jpg",      article: "la",  gender: "f", definition: "capsule contenant un médicament en poudre" },
    { word: "pommade", image: "pommade.jpg",     article: "la",  gender: "f", definition: "médicament gras à appliquer sur la peau" },
    { word: "crème", image: "creme.jpg",       article: "la",  gender: "f", definition: "préparation épaisse pour la peau" },
    { word: "pansement", image: "pansement.jpg",   article: "le",  gender: "m", definition: "protection adhésive pour une blessure" },
    { word: "thermomètre", image: "thermometre.jpg", article: "le",  gender: "m", definition: "instrument pour mesurer la température" },
    ...
    { word: "boîte", image: "boite.jpg",       article: "la",  gender: "f", definition: "emballage d'un médicament" },
  ],
  sentences: [
