...
export const A1_GR_PRESENT_PROGRESSIF: GrammarLesson = {
  ...
  theory: [
    ...
    {
      type: "text",
      text: "Verbe {a}être{/a} (présent) + {a}en train de{/a} + infinitif.",
      transText: {
    ...
    {
      type: "text",
      text: "Avec un verbe pronominal, le {a}pronom{/a} se place devant l'infinitif.",
      transText: {
    ...
    {
      type: "text",
      text: "À la forme négative, {a}ne… pas{/a} encadre le verbe être.",
      transText: {
    ...
    {
      type: "text",
      text: "{a}De{/a} devient {a}d'{/a} devant un verbe qui commence par une voyelle ou un h muet.",
      transText: {
