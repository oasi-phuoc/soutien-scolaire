  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "C'est ___ veste. (je)", choices: ["ma", "mon", "mes", "sa"], correctIdx: 0 },
        { sentence: "C'est ___ chapeau. (je)", choices: ["mon", "ma", "mes", "ton"], correctIdx: 0 },
        { sentence: "Je te présente ___ frère. (je)", choices: ["mon", "ma", "mes", "son"], correctIdx: 0 },
        { sentence: "___ appartement est à Lyon. (je)", choices: ["Mon", "Ma", "Mes", "Son"], correctIdx: 0 },
        { sentence: "Elle a ___ pantalon.", choices: ["son", "sa", "ses", "leur"], correctIdx: 0 },
        { sentence: "C'est ___ écharpe. (je, fs + voyelle)", choices: ["mon", "ma", "mes", "sa"], correctIdx: 0 },
        { sentence: "On invite ___ voisin. (on = nous)", choices: ["notre", "nos", "leur", "mon"], correctIdx: 0 },
        { sentence: "On invite ___ amis. (on = nous)", choices: ["nos", "notre", "leurs", "mes"], correctIdx: 0 },
        { sentence: "Voici ___ vêtements. (ils)", choices: ["leurs", "leur", "ses", "vos"], correctIdx: 0 },
        { sentence: "Voici ___ manteau. (vous)", choices: ["votre", "vos", "notre", "ton"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
