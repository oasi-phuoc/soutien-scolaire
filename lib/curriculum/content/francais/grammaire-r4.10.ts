...
export const A2_CONJ_L02: ConjLesson = {
  ...
  evalExercises: [
    ...
    },
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ___ mon travail.",                  choices: ["finis", "finit", "finissons"], correctIdx: 0 },
        { sentence: "Ils ___ demain.",                      choices: ["viennent", "venons", "vient"], correctIdx: 0 },
        { sentence: "Elle ___ une école.",                  choices: ["choisit", "choisis", "choisissons"], correctIdx: 0 },
        { sentence: "Nous ___ à midi.",                     choices: ["partons", "partez", "partent"], correctIdx: 0 },
        { sentence: "Tu ___ tard ?",                        choices: ["dors", "dort", "dormons"], correctIdx: 0 },
        { sentence: "Vous ___ aux règles ?",                choices: ["obéissez", "obéis", "obéit"], correctIdx: 0 },
        { sentence: "Il ___ ce soir.",                      choices: ["sort", "sors", "sortons"], correctIdx: 0 },
        { sentence: "J'___ la fenêtre.",                    choices: ["ouvre", "ouvres", "ouvrons"], correctIdx: 0 },
      ],
    },
  ],
};
