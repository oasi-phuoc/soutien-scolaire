...
export const V7_FRUITS_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "pêche", image: "pêche.jpg",    article: "la",  gender: "f", definition: "fruit juteux à peau veloutée, orange ou jaune" },
    ...
    { word: "pastèque", image: "pastèque.jpg", article: "la",  gender: "f", definition: "grand fruit vert à chair rouge et rafraîchissante" },
