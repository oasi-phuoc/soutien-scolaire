  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "La pièce ___ je t'ai parlé.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
        { sentence: "Le film ___ je parle.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
        { sentence: "L'enfant ___ je m'occupe.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
        { sentence: "Un collègue ___ je suis proche.", choices: ["dont", "qui", "que", "à qui"], correctIdx: 0 },
        { sentence: "Le dossier ___ je suis responsable.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
        { sentence: "Un collègue ___ la femme est actrice.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
        { sentence: "Un document ___ le contenu est confidentiel.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
        { sentence: "J'ai un ami dont ___ femme est actrice.", choices: ["la", "sa", "son", "une"], correctIdx: 0 },
        { sentence: "« Dont » remplace un complément avec ___ .", choices: ["de", "à", "sur", "dans"], correctIdx: 0 },
        { sentence: "Voici le livre ___ j'ai besoin.", choices: ["dont", "qui", "que", "où"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
