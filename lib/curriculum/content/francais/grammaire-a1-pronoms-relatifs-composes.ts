  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Le château ___ il s'est marié.", choices: ["dans lequel", "dans laquelle", "dont", "où lequel"], correctIdx: 0 },
        { sentence: "La mairie ___ a lieu la cérémonie.", choices: ["dans laquelle", "dans lequel", "auquel", "dont"], correctIdx: 0 },
        { sentence: "Les invités ___ il parle.", choices: ["avec lesquels", "avec lesquelles", "dont", "auxquels"], correctIdx: 0 },
        { sentence: "Les amies ___ elle voyage.", choices: ["avec lesquelles", "avec lesquels", "dont", "auxquelles"], correctIdx: 0 },
        { sentence: "Un mariage ___ les journalistes étaient invités.", choices: ["auquel", "à lequel", "dont", "duquel"], correctIdx: 0 },
        { sentence: "Le sujet ___ la presse a écrit. (au sujet de)", choices: ["duquel", "dont", "auquel", "lequel"], correctIdx: 0 },
        { sentence: "Un mariage ___ la presse a parlé. (parler de)", choices: ["dont", "duquel", "auquel", "lequel"], correctIdx: 0 },
        { sentence: "La femme ___ il se marie. (courant)", choices: ["avec qui", "dont", "duquel", "où"], correctIdx: 0 },
        { sentence: "à + lesquels → ___", choices: ["auxquels", "à lesquels", "desquels", "lesquels"], correctIdx: 0 },
        { sentence: "de + lesquelles → ___", choices: ["desquelles", "de lesquelles", "auxquelles", "lesquelles"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
