  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je parle de mes vacances à mes amis. → Je ___ parle.", choices: ["leur en", "en leur", "les leur", "leur les"], correctIdx: 0 },
        { sentence: "Il me prête sa voiture. → Il ___ prête.", choices: ["me la", "la me", "me le", "lui la"], correctIdx: 0 },
        { sentence: "Elle te prête son vélo. → Elle ___ prête.", choices: ["te le", "le te", "te la", "lui le"], correctIdx: 0 },
        { sentence: "Il prête sa voiture à son ami. → Il ___ prête.", choices: ["la lui", "lui la", "le lui", "la leur"], correctIdx: 0 },
        { sentence: "Elle prête ses vêtements à ses sœurs. → Elle ___ prête.", choices: ["les leur", "leur les", "les lui", "leur en"], correctIdx: 0 },
        { sentence: "Il me donne des conseils. → Il ___ donne.", choices: ["m'en", "me en", "en me", "lui en"], correctIdx: 0 },
        { sentence: "Elle offre du parfum à son ami. → Elle ___ offre.", choices: ["lui en", "en lui", "le lui", "lui le"], correctIdx: 0 },
        { sentence: "Il m'emmène à la gare. → Il ___ emmène.", choices: ["m'y", "me y", "y me", "m'en"], correctIdx: 0 },
        { sentence: "Elle conduit son ami à l'aéroport. → Elle ___ conduit.", choices: ["l'y", "le y", "y le", "l'en"], correctIdx: 0 },
        { sentence: "Impératif : ___ !", choices: ["Donne-le-moi", "Donne-moi-le", "Me le donne", "Le me donne"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
