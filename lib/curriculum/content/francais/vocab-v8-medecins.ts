...
export const V8_MEDECINS_THEME: VocabTheme = {
  ...
  section: "V8",
  words: [
    { word: "médecin", image: "médecin.jpg",            article: "le",  gender: "m", definition: "professionnel de santé généraliste" },
    ...
    { word: "pédiatre", image: "pédiatre.jpg",           article: "le",  gender: "m", definition: "médecin spécialiste des enfants" },
    { word: "chirurgien", image: "chirurgien.jpg",         article: "le",  gender: "m", definition: "médecin qui pratique des opérations" },
    { word: "spécialiste", image: "spécialiste.jpg",        article: "le",  gender: "m", definition: "médecin expert dans un domaine" },
    { word: "urgentiste", image: "urgentiste.jpg",         article: "l'",  gender: "m", definition: "médecin des urgences" },
    { word: "kinésithérapeute", image: "kinésithérapeute.jpg",   article: "le",  gender: "m", definition: "professionnel en rééducation physique" },
    { word: "généraliste", image: "généraliste.jpg",        article: "le",  gender: "m", definition: "médecin de premier recours" },
