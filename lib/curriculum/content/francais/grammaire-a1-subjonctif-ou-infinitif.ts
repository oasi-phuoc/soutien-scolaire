  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je voudrais ___ à la piscine. (même sujet)", choices: ["aller", "que j'aille", "que je vais", "aille"], correctIdx: 0 },
        { sentence: "Je voudrais qu'on ___ à la piscine. (sujets différents)", choices: ["aille", "aller", "allons", "va"], correctIdx: 0 },
        { sentence: "Nous sommes contents ___ venus. (même sujet)", choices: ["d'être", "que nous soyons", "que nous sommes", "être"], correctIdx: 0 },
        { sentence: "Nous sommes contents que vous ___ venus.", choices: ["soyez", "êtes", "être", "ayez"], correctIdx: 0 },
        { sentence: "Je suis heureux de ___ en vacances.", choices: ["partir", "que je parte", "parte", "partirai"], correctIdx: 0 },
        { sentence: "Je suis heureux d'___ au Portugal.", choices: ["être allé", "aller", "être alléé", "avoir allé"], correctIdx: 0 },
        { sentence: "Il a peur de ___ réussir.", choices: ["ne pas", "pas ne", "ne", "pas"], correctIdx: 0 },
        { sentence: "Je regrette de ne pas ___ participé.", choices: ["avoir", "être", "avoir été", "avoir à"], correctIdx: 0 },
        { sentence: "Je suis contente ___ au stade.", choices: ["d'aller", "aller", "que j'aille", "d'aille"], correctIdx: 0 },
        { sentence: "Il a peur ___ perdre.", choices: ["de", "à", "que", "pour"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
