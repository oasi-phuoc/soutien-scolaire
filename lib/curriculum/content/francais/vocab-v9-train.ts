...
export const V9_TRAIN_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "départ", image: "départ.jpg",         article: "le",  gender: "m", definition: "moment où le train quitte la gare" },
    { word: "arrivée", image: "arrivée.jpg",        article: "l'",  gender: "f", definition: "moment où le train arrive en gare" },
    { word: "wagon", image: "wagon.jpg",          article: "le",  gender: "m", definition: "voiture d'un train" },
    { word: "contrôleur", image: "contrôleur.jpg",     article: "le",  gender: "m", definition: "agent qui vérifie les billets" },
    { word: "place", image: "place.jpg",          article: "la",  gender: "f", definition: "siège réservé dans le train" },
    { word: "grève", image: "grève.jpg",          article: "la",  gender: "f", definition: "arrêt de travail du personnel de train" },
