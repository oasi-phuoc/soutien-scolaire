  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Le viaduc ___ construit entre 2002 et 2004.", choices: ["a été", "a", "est été", "avait"], correctIdx: 0 },
        { sentence: "Le viaduc ___ construit. (présent)", choices: ["est", "a", "a été", "sera"], correctIdx: 0 },
        { sentence: "Le viaduc ___ construit. (futur)", choices: ["sera", "est", "a été", "va"], correctIdx: 0 },
        { sentence: "Le viaduc ___ être construit. (futur proche)", choices: ["va", "vient", "est", "a"], correctIdx: 0 },
        { sentence: "Construit ___ Eiffage.", choices: ["par", "de", "à", "pour"], correctIdx: 0 },
        { sentence: "La tour Eiffel a été ___ .", choices: ["construite", "construit", "construits", "construites"], correctIdx: 0 },
        { sentence: "Formation : ___ + participe passé.", choices: ["être", "avoir", "aller", "faire"], correctIdx: 0 },
        { sentence: "Le viaduc vient ___ être construit.", choices: ["d'", "de", "à", "par"], correctIdx: 0 },
        { sentence: "✗ J'ai été téléphoné → parce que téléphoner n'a pas de ___ .", choices: ["COD", "sujet", "participe", "auxiliaire"], correctIdx: 0 },
        { sentence: "Les ponts ont été ___ .", choices: ["construits", "construit", "construite", "construire"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
