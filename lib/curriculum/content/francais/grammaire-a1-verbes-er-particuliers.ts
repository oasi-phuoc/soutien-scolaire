...
export const A1_GR_VERBES_ER_PART: GrammarLesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      transRows: {
        en: [["Movement", "Tu {a}vas{/a} où ? / Nous {a}allons{/a} en Espagne."], ["Asking how someone is", "Tu {a}vas{/a} bien ? — Oui, je {a}vais{/a} bien."]],
        ar: [["تنقّل", "Tu {a}vas{/a} où ? / Nous {a}allons{/a} en Espagne."], ["السؤال عن الأحوال", "Tu {a}vas{/a} bien ? — Oui, je {a}vais{/a} bien."]],
        fa: [["جابه‌جایی", "Tu {a}vas{/a} où ? / Nous {a}allons{/a} en Espagne."], ["احوال‌پرسی", "Tu {a}vas{/a} bien ? — Oui, je {a}vais{/a} bien."]],
        ti: [["ምንቅስቓስ", "Tu {a}vas{/a} où ? / Nous {a}allons{/a} en Espagne."], ["ዜና ምሕታት", "Tu {a}vas{/a} bien ? — Oui, je {a}vais{/a} bien."]],
        uk: [["Переміщення", "Tu {a}vas{/a} où ? / Nous {a}allons{/a} en Espagne."], ["Запитання про справи", "Tu {a}vas{/a} bien ? — Oui, je {a}vais{/a} bien."]],
      },
    },
    {
      type: "heading",
