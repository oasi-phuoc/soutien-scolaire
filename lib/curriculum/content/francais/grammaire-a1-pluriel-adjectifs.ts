  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Ils sont ___ .", choices: ["mariés", "marié", "mariées"], correctIdx: 0 },
        { sentence: "Elles sont ___ .", choices: ["heureuses", "heureuse", "heureux"], correctIdx: 0 },
        { sentence: "Ces hommes sont ___ .", choices: ["jaloux", "jalouxes", "jalouse"], correctIdx: 0 },
        { sentence: "Ces pantalons sont ___ .", choices: ["originaux", "original", "originale"], correctIdx: 0 },
        { sentence: "Ces vestes sont ___ .", choices: ["originales", "originaux", "original"], correctIdx: 0 },
        { sentence: "Ces pantalons sont ___ .", choices: ["beaux", "beau", "belle"], correctIdx: 0 },
        { sentence: "Ces vestes sont ___ .", choices: ["belles", "beaux", "beau"], correctIdx: 0 },
        { sentence: "Ce pantalon et cette veste sont ___ .", choices: ["élégants", "élégantes", "élégant"], correctIdx: 0 },
        { sentence: "Elles sont ___ .", choices: ["mariées", "mariés", "marié"], correctIdx: 0 },
        { sentence: "Ces hommes sont ___ .", choices: ["mauvais", "mauvaiss", "mauvaise"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
