  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Nous y sommes ___ . (aller, mixtes)", choices: ["allés", "allé", "allée"], correctIdx: 0 },
        { sentence: "Elle a ___ les places. (réserver)", choices: ["réservé", "réservée", "réservés"], correctIdx: 0 },
        { sentence: "Je les ai ___ . (prendre, places)", choices: ["prises", "pris", "prise"], correctIdx: 0 },
        { sentence: "Je les ai ___ sur Internet. (réserver)", choices: ["réservées", "réservé", "réservée"], correctIdx: 0 },
        { sentence: "Pierre l'a ___ . (inviter, Marie)", choices: ["invitée", "invité", "invités"], correctIdx: 0 },
        { sentence: "Voici les places que j'ai ___ .", choices: ["prises", "pris", "prise"], correctIdx: 0 },
        { sentence: "Des billets, j'en ai ___ plusieurs.", choices: ["réservé", "réservés", "réservée"], correctIdx: 0 },
        { sentence: "Avec être, le participe s'accorde avec ___ .", choices: ["le sujet", "le COD", "rien"], correctIdx: 0 },
        { sentence: "Avec avoir, accord si le COD est ___ .", choices: ["avant", "après", "absent"], correctIdx: 0 },
        { sentence: "Regarde les photos que j'ai ___ !", choices: ["faites", "fait", "faite"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
