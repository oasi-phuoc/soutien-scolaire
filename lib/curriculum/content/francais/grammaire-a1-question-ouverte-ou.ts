  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Vous voulez aller ___ ?", choices: ["où", "quand", "comment", "pourquoi"], correctIdx: 0 },
        { sentence: "___ est-ce que tu arrives ?", choices: ["Quand", "Où", "Combien", "Qui"], correctIdx: 0 },
        { sentence: "___ est-ce que tu vas au bureau ?", choices: ["Comment", "Où", "Quand", "Combien"], correctIdx: 0 },
        { sentence: "Tu parles ___ de langues ?", choices: ["combien", "comment", "où", "pourquoi"], correctIdx: 0 },
        { sentence: "___ est-ce que tu étudies le français ?", choices: ["Pourquoi", "Quand", "Où", "Combien"], correctIdx: 0 },
        { sentence: "___ vous marchez vite ?", choices: ["Pourquoi", "Vous pourquoi", "Marchez pourquoi", "Vite pourquoi"], correctIdx: 0 },
        { sentence: "___ est-ce que vous allez ?", choices: ["Où", "Quand", "Comment", "Combien"], correctIdx: 0 },
        { sentence: "Ça coûte ___ ?", choices: ["combien", "comment", "où", "pourquoi"], correctIdx: 0 },
        { sentence: "Où est-ce ___ il travaille ?", choices: ["qu'", "que", "qui", "quoi"], correctIdx: 0 },
        { sentence: "La réponse à une question ouverte donne ___ .", choices: ["des informations précises", "seulement oui ou non", "rien", "un silence"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
