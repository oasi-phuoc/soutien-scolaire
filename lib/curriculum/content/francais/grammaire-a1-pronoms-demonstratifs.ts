  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ que vous avez est très bien.", choices: ["Celui", "Celle", "Ceux", "Ce"], correctIdx: 0 },
        { sentence: "Il y a aussi ___ ; il est plus léger.", choices: ["celui-ci", "celle-ci", "ceux-ci", "ceci"], correctIdx: 0 },
        { sentence: "___ de Julien est rouge.", choices: ["Celle", "Celui", "Ceux", "Ce"], correctIdx: 0 },
        { sentence: "___ que je préfère sont chers.", choices: ["Ceux", "Celui", "Celle", "Ce"], correctIdx: 0 },
        { sentence: "___ qui coûtent moins cher.", choices: ["Celles", "Ceux", "Celui", "Celle"], correctIdx: 0 },
        { sentence: "Celle-___ ou celle-là ?", choices: ["ci", "là", "de", "en"], correctIdx: 0 },
        { sentence: "Celui ___ cuir ?", choices: ["en", "de", "à", "du"], correctIdx: 0 },
        { sentence: "___ mon ami.", choices: ["C'est", "Ce sont", "Ça", "Ceux"], correctIdx: 0 },
        { sentence: "J'adore ___ que tu as acheté.", choices: ["ce", "celui", "ça", "ceux"], correctIdx: 0 },
        { sentence: "Le chocolat, j'aime ___ .", choices: ["ça", "ce", "celui", "cela-ci"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
