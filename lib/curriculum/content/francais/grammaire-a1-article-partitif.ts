  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je mange ___ poulet. (une part)", choices: ["du", "un", "le", "des"], correctIdx: 0 },
        { sentence: "Je mange ___ pizza. (une part)", choices: ["de la", "une", "la", "des"], correctIdx: 0 },
        { sentence: "Je bois ___ eau.", choices: ["de l'", "du", "de la", "des"], correctIdx: 0 },
        { sentence: "Il faut ___ courage.", choices: ["du", "de la", "de l'", "un"], correctIdx: 0 },
        { sentence: "Elle a ___ chance.", choices: ["de la", "du", "de l'", "une"], correctIdx: 0 },
        { sentence: "Je fais ___ sport.", choices: ["du", "de la", "le", "un"], correctIdx: 0 },
        { sentence: "Elle fait ___ danse.", choices: ["de la", "du", "la", "une"], correctIdx: 0 },
        { sentence: "Il n'y a pas ___ vent.", choices: ["de", "du", "de la", "des"], correctIdx: 0 },
        { sentence: "Elle n'a pas ___ chance.", choices: ["de", "de la", "du", "des"], correctIdx: 0 },
        { sentence: "Ce n'est pas ___ sucre.", choices: ["du", "de", "de la", "un"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
