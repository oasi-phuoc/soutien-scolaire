  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "On travaille le samedi ___ pas le dimanche.", choices: ["mais", "afin que", "pour que"], correctIdx: 0 },
        { sentence: "Les salaires n'ont pas augmenté, ___ l'entreprise a fait des bénéfices.", choices: ["pourtant", "afin que", "pour que"], correctIdx: 0 },
        { sentence: "Cette entreprise gagne, ___ l'autre perd. (formel)", choices: ["en revanche", "afin de", "pour que"], correctIdx: 0 },
        { sentence: "Je travaille 8 h ___ tu ne travailles que 6 h.", choices: ["alors que", "afin que", "pour que"], correctIdx: 0 },
        { sentence: "Travaille ___ discuter !", choices: ["au lieu de", "afin que", "bien que"], correctIdx: 0 },
        { sentence: "On le croit égoïste, ___ il est généreux.", choices: ["en fait", "afin que", "pour que"], correctIdx: 0 },
        { sentence: "___ la crise, mon entreprise fait des bénéfices.", choices: ["Malgré", "Bien que", "Afin que"], correctIdx: 0 },
        { sentence: "Bien que la situation ___ difficile…", choices: ["soit", "est", "sera"], correctIdx: 0 },
        { sentence: "Même si la situation ___ difficile…", choices: ["est", "soit", "sera"], correctIdx: 0 },
        { sentence: "La situation ___ difficile, il faut rester optimistes. (oral)", choices: ["a beau être", "est beau", "a beau est"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
