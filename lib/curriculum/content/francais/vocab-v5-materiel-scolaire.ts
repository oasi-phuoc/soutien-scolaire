...
export const V5_MATERIEL_SCOLAIRE_THEME: VocabTheme = {
  ...
  section: "V5",
  words: [
    { word: "cahier",        article: "le",  gender: "m", definition: "carnet de feuilles pour écrire" },
    { word: "livre",         article: "le",  gender: "m", definition: "ouvrage imprimé relié" },
    { word: "stylo",         article: "le",  gender: "m", definition: "instrument pour écrire à l'encre" },
    { word: "crayon",        article: "le",  gender: "m", definition: "instrument pour écrire et dessiner" },
    { word: "gomme",         article: "la",  gender: "f", definition: "outil pour effacer le crayon" },
    { word: "règle",         article: "la",  gender: "f", definition: "outil pour tracer des lignes droites" },
    { word: "trousse",       article: "la",  gender: "f", definition: "pochette pour ranger les stylos" },
    { word: "sac",           article: "le",  gender: "m", definition: "sac pour porter les affaires scolaires" },
    { word: "classeur",      article: "le",  gender: "m", definition: "pochette rigide pour classer des feuilles" },
    { word: "feuille",       article: "la",  gender: "f", definition: "page de papier pour écrire" },
    ...
    { word: "compas",        article: "le",  gender: "m", definition: "outil pour tracer des cercles" },
    { word: "colle",         article: "la",  gender: "f", definition: "substance pour coller des papiers" },
  ],
  sentences: [
