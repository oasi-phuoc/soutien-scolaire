  ...
  evalExercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ parle français.",         choices: ["Je",   "Mon",   "Mes",  "Tu"],    correctIdx: 0 },
        { sentence: "___ habite en Suisse.",        choices: ["Elle", "Sa",    "Son",  "Leur"],  correctIdx: 0 },
        { sentence: "___ mangeons ensemble.",       choices: ["Nous", "Notre", "Leur", "Il"],    correctIdx: 0 },
        { sentence: "___ travaillent le matin.",    choices: ["Ils",  "Leur",  "Son",  "Elle"],  correctIdx: 0 },
        { sentence: "___ êtes étudiant ?",          choices: ["Vous", "Votre", "Tu",   "Mes"],   correctIdx: 0 },
        { sentence: "___ arrivent à midi.",         choices: ["Elles","Leurs", "Sa",   "Il"],    correctIdx: 0 },
        { sentence: "___ aimes le café ?",          choices: ["Tu",   "Te",    "Ta",   "Ton"],   correctIdx: 0 },
        { sentence: "___ cherche un appartement.", choices: ["Il",   "Ils",   "Son",  "Sa"],    correctIdx: 0 },
        { sentence: "___ avons un cours ce matin.", choices: ["Nous", "Notre", "Mes",  "Vous"],  correctIdx: 0 },
        { sentence: "___ étudie le français.",      choices: ["On",   "Son",   "Sa",   "Leur"],  correctIdx: 0 },
      ],
    },
    {
      type: "fill",
