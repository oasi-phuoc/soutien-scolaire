  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Il joue ___ !", choices: ["bien", "très", "beaucoup", "trop de"], correctIdx: 0 },
        { sentence: "Il s'est ___ entraîné.", choices: ["beaucoup", "très", "trop de", "bien de"], correctIdx: 0 },
        { sentence: "C'est ___ bon.", choices: ["très", "beaucoup", "trop de", "assez de"], correctIdx: 0 },
        { sentence: "On mange ___ .", choices: ["beaucoup", "très", "trop de", "bien de"], correctIdx: 0 },
        { sentence: "Il est ___ bavard. (négatif)", choices: ["trop", "très", "beaucoup", "assez de"], correctIdx: 0 },
        { sentence: "J'ai ___ soif.", choices: ["très", "beaucoup", "trop de", "bien"], correctIdx: 0 },
        { sentence: "Cette course est ___ longue.", choices: ["très", "beaucoup", "trop de", "bien de"], correctIdx: 0 },
        { sentence: "Il s'entraîne ___ . (temps simple)", choices: ["beaucoup", "très", "trop de", "bien de"], correctIdx: 0 },
        { sentence: "Il va ___ s'entraîner.", choices: ["beaucoup", "très", "trop de", "bien de"], correctIdx: 0 },
        { sentence: "Il a couru ___ trop vite.", choices: ["beaucoup", "très", "trop", "bien"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
