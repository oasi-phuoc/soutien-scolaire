...
export const A2_GR_IMPARFAIT_IRREGULIERS: GrammarLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      items: [],
      pool: [
        { sentence: "Il ___ froid cet hiver-là.", choices: ["faisait", "fesait", "faisaient"], correctIdx: 0 },
        { sentence: "J'___ dix ans à cette époque.", choices: ["avais", "aivais", "avait"], correctIdx: 0 },
        { sentence: "Nous ___ toujours ensemble.", choices: ["étions", "étaient", "étais"], correctIdx: 0 },
        { sentence: "Tu ___ souvent en retard.", choices: ["allais", "alais", "allait"], correctIdx: 0 },
        { sentence: "Ils ___ souvent nous voir.", choices: ["venaient", "venait", "venient"], correctIdx: 0 },
        { sentence: "Elle ___ toujours le train.", choices: ["prenait", "prenaient", "prenais"], correctIdx: 0 },
      ],
      poolSize: 5,
    },
    {
