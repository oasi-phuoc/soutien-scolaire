      ...
      tabs: [
        ...
        },
        {
          ...
          content: [
            {
              type: "plain_list",
              items: ["Le {a}c{/a} devient {a}ç{/a} devant {a}o{/a} (forme nous) pour garder le son [s]."],
            },
            {
              type: "verb_toggle",
              verbs: [
        ...
        },
        {
          ...
          content: [
            {
              type: "plain_list",
              items: ["Le {a}t{/a} est doublé ({a}tt{/a}) devant une terminaison muette (je, tu, il, ils)."],
            },
            {
              type: "verb_toggle",
              verbs: [
        ...
        },
        {
          ...
          content: [
            {
              type: "plain_list",
              items: ["Le {a}l{/a} est doublé ({a}ll{/a}) devant une terminaison muette (j', tu, il, ils)."],
            },
            {
              type: "verb_toggle",
              verbs: [
        ...
        },
        {
          ...
          content: [
            {
              type: "plain_list",
              items: ["Ces verbes se conjuguent comme les verbes réguliers en -ER."],
            },
            {
              type: "verb_toggle",
              verbs: [
