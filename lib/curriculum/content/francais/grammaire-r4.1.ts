  ...
  exercises: [
    {
      ...
      pool: [
        ...
        { sentence: "Tu ___ partir en vacances.", hint: "aller → vas", answer: "vas" },
        { sentence: "Il ___ pleuvoir demain.", hint: "aller → va", answer: "va" },
        { sentence: "Elle ___ appeler sa mère.", hint: "aller → va", answer: "va" },
        { sentence: "On ___ commencer bientôt.", hint: "aller → va", answer: "va" },
        { sentence: "Nous ___ étudier ce soir.", hint: "aller → allons", answer: "allons" },
        { sentence: "Vous ___ voyager cet été.", hint: "aller → allez", answer: "allez" },
        { sentence: "Ils ___ arriver dans dix minutes.", hint: "aller → vont", answer: "vont" },
        { sentence: "Elles ___ sortir ce week-end.", hint: "aller → vont", answer: "vont" },
      ],
      poolSize: 6,
    },
    {
      ...
      pool: [
        ...
        { sentence: "Elle ___ venir ce soir. (ne...pas)", hint: "ne va pas", answer: "ne va pas" },
        { sentence: "Ils ___ sortir demain. (ne...pas)", hint: "ne vont pas", answer: "ne vont pas" },
        { sentence: "Nous ___ partir maintenant. (ne...pas)", hint: "n'allons pas", answer: "n'allons pas" },
        { sentence: "Tu ___ réussir comme ça. (ne...pas)", hint: "ne vas pas", answer: "ne vas pas" },
        { sentence: "Vous ___ finir à temps. (ne...pas)", hint: "n'allez pas", answer: "n'allez pas" },
      ],
      poolSize: 5,
    },
    {
      ...
      pool: [
        ...
        { word: "Je mange.", categoryIdx: 1 },
        { word: "Elle va partir.", categoryIdx: 0 },
        { word: "Elle part.", categoryIdx: 1 },
        { word: "Nous allons étudier.", categoryIdx: 0 },
        { word: "Nous étudions.", categoryIdx: 1 },
        { word: "Ils vont travailler.", categoryIdx: 0 },
        { word: "Ils travaillent.", categoryIdx: 1 },
      ],
      poolSize: 6,
    },
    {
      ...
      pool: [
        ...
        { sentence: "Elle va venir ce soir.", words: ["Elle", "va", "venir", "ce", "soir."] },
        { sentence: "Nous allons étudier ensemble.", words: ["Nous", "allons", "étudier", "ensemble."] },
        { sentence: "Ils ne vont pas sortir aujourd'hui.", words: ["Ils", "ne", "vont", "pas", "sortir", "aujourd'hui."] },
        { sentence: "Tu vas réussir ton examen.", words: ["Tu", "vas", "réussir", "ton", "examen."] },
      ],
      poolSize: 4,
    },
    {
      ...
      items: [
        {
          ...
          answers: [null, 0, 1, null, null],
        },
        {
          words: ["Elle", "va", "partir", "en", "vacances."],
          answers: [null, 0, 1, null, null],
        },
        {
          words: ["Ils", "ne", "vont", "pas", "sortir", "demain."],
          answers: [null, null, 0, null, 1, null],
        },
      ],
    },
    {
