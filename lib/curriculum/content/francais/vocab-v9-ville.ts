...
export const V9_VILLE_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "marché", image: "marché.jpg",      article: "le",  gender: "m", definition: "lieu de vente en plein air" },
    ...
    { word: "hôpital", image: "hôpital.jpg",     article: "l'",  gender: "m", definition: "établissement de soins médicaux" },
    ...
    { word: "église", image: "église.jpg",      article: "l'",  gender: "f", definition: "lieu de culte chrétien" },
  ],
  sentences: [
