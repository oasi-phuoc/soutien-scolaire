...
export const V9_VILLE_THEME: VocabTheme = {
  ...
  section: "V9",
  words: [
    { word: "ville", image: "/vocab/images/V4/ville.jpg",       article: "la",  gender: "f", definition: "agglomération urbaine importante" },
    { word: "quartier", image: "quartier.jpg",    article: "le",  gender: "m", definition: "zone d'une ville avec ses habitants" },
    { word: "centre-ville", image: "/vocab/images/V4/centre-ville.jpg",article: "le",  gender: "m", definition: "partie centrale d'une ville" },
    { word: "rue", image: "rue.jpg",         article: "la",  gender: "f", definition: "voie publique entre des bâtiments" },
    { word: "avenue", image: "/vocab/images/V4/avenue.jpg",      article: "l'",  gender: "f", definition: "large voie plantée d'arbres" },
    { word: "place", image: "/vocab/images/V4/place.jpg",       article: "la",  gender: "f", definition: "espace public ouvert en ville" },
