  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ est à l'appareil ?", choices: ["Qui", "Quoi", "Quel"], correctIdx: 0 },
        { sentence: "___ tu veux ?", choices: ["Qu'est-ce que", "Qui", "Lequel"], correctIdx: 0 },
        { sentence: "Tu cherches ___ ?", choices: ["quoi", "qui", "quel"], correctIdx: 0 },
        { sentence: "Vous avez ___ âge ?", choices: ["quel", "quelle", "quels"], correctIdx: 0 },
        { sentence: "___ est votre nationalité ?", choices: ["Quelle", "Quel", "Quels"], correctIdx: 0 },
        { sentence: "___ sont tes films préférés ?", choices: ["Quels", "Quel", "Quelle"], correctIdx: 0 },
        { sentence: "Tu parles ___ langues ?", choices: ["quelles", "quels", "quelle"], correctIdx: 0 },
        { sentence: "Entre ces deux films, ___ tu préfères ?", choices: ["lequel", "laquelle", "quels"], correctIdx: 0 },
        { sentence: "Tu travailles avec ___ ?", choices: ["qui", "quoi", "quel"], correctIdx: 0 },
        { sentence: "La question partielle est une question ___ .", choices: ["ouverte", "fermée", "totale"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
