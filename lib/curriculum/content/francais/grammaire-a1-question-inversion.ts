  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ satisfait ?", choices: ["Êtes-vous", "Vous êtes", "Est-ce êtes-vous", "Êtes vous"], correctIdx: 0 },
        { sentence: "___ souvent ?", choices: ["Venez-vous", "Vous venez", "Venez vous", "Est-ce venez"], correctIdx: 0 },
        { sentence: "___ aimé votre séjour ?", choices: ["Avez-vous", "Vous avez", "Avez vous", "Aimez-vous"], correctIdx: 0 },
        { sentence: "Les animateurs ___ sympathiques ?", choices: ["sont-ils", "sont", "ils sont", "est-ce sont"], correctIdx: 0 },
        { sentence: "___ les centres de vacances ?", choices: ["Aime-t-elle", "Aime-elle", "Aime t elle", "Elle aime"], correctIdx: 0 },
        { sentence: "___ une salle de repos ?", choices: ["Y a-t-il", "Y a-il", "Il y a", "Y a t il"], correctIdx: 0 },
        { sentence: "___ vous poser une question ?", choices: ["Puis-je", "Peux-je", "Je peux", "Puis je"], correctIdx: 0 },
        { sentence: "Que ___ de nos services ?", choices: ["pensez-vous", "vous pensez", "pensez vous", "pensez"], correctIdx: 0 },
        { sentence: "Quand ___ ?", choices: ["vous inscrivez-vous", "inscrivez-vous vous", "vous vous inscrivez", "inscrivez vous"], correctIdx: 0 },
        { sentence: "Registre formel de « Vous êtes satisfait ? » :", choices: ["Êtes-vous satisfait ?", "Est-ce que vous êtes satisfait ?", "Vous êtes satisfait ?", "Si vous êtes satisfait ?"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
