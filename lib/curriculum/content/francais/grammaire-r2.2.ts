...
export const A1_CONJ_L09: ConjLesson = {
  ...
  evalExercises: [
    ...
    },
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ___ lève à 7h.",              choices: ["me", "se", "te"],  correctIdx: 0 },
        { sentence: "Elle ___ habille vite.",          choices: ["s'", "se", "me"],    correctIdx: 0 },
        { sentence: "Nous ___ préparons le matin.",    choices: ["nous", "se", "me"],  correctIdx: 0 },
        { sentence: "Tu ___ couches tard ?",           choices: ["te", "se", "me"],  correctIdx: 0 },
        { sentence: "Ils ___ lèvent tôt.",             choices: ["se", "me", "te"],  correctIdx: 0 },
        { sentence: "Vous ___ réveillez à quelle heure ?", choices: ["vous", "se", "me"],      correctIdx: 0 },
        { sentence: "Il ___ rase le matin.",           choices: ["se", "me", "te"],  correctIdx: 0 },
        { sentence: "Je ___ douche le soir.",          choices: ["me", "se", "te"],  correctIdx: 0 },
      ],
    },
  ],
};
