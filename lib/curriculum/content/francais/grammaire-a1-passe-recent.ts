  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Le train ___ partir !", choices: ["vient de", "vient", "a", "est"], correctIdx: 0 },
        { sentence: "Je ___ rentrer à la maison.", choices: ["viens de", "viens", "suis", "ai"], correctIdx: 0 },
        { sentence: "Nous ___ regarder le journal.", choices: ["venons de", "venons", "avons", "sommes"], correctIdx: 0 },
        { sentence: "Ils ___ mettre un DVD.", choices: ["viennent de", "viennent", "ont", "sont"], correctIdx: 0 },
        { sentence: "Nous venons ___ arriver.", choices: ["d'", "de", "à", "du"], correctIdx: 0 },
        { sentence: "Il vient ___ partir. (consonne)", choices: ["de", "d'", "à", "du"], correctIdx: 0 },
        { sentence: "Le film ___ il y a 3 minutes. (temps précis)", choices: ["a commencé", "vient de commencer", "commençait", "commence"], correctIdx: 0 },
        { sentence: "Je viens de la gare. = ___", choices: ["provenance", "passé récent", "futur", "habitude"], correctIdx: 0 },
        { sentence: "Je viens de rentrer. = ___", choices: ["passé récent", "provenance", "futur proche", "imparfait"], correctIdx: 0 },
        { sentence: "Il vient juste de partir. → « juste » renforce ___ .", choices: ["la proximité", "le futur", "l'habitude", "la négation"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
