...
export const V6_VETEMENTS_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "chaussettes",  article: "les", gender: "f", image: "chaussettes.png", definition: "vêtements qui couvrent les pieds" },
    { word: "chaussures",   article: "les", gender: "f", image: "chaussures.png",  definition: "paire de souliers pour les pieds" },
    { word: "bottes",       article: "les", gender: "f", image: "bottes.png",      definition: "chaussures hautes montant jusqu'aux genoux" },
