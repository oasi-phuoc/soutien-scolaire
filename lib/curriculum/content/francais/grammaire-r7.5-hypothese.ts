  ...
  exercises: [
    ...
    },
    {
      ...
      pool: [
        ...
        { sentence: "S'il pleut, nous ___ à la maison.", choices: ["resterons", "restons", "resterions", "resté"], correctIdx: 0 },
        { sentence: "Si elle ___ le temps, elle nous aidera.", choices: ["a", "aura", "avait", "aurait"], correctIdx: 0 },
        { sentence: "Si vous ___ tôt, vous arriverez à l'heure.", choices: ["partez", "partirez", "partiez", "partieriez"], correctIdx: 0 },
        { sentence: "Si je ___ libre, je viendrai.", choices: ["suis", "serai", "serais", "soit"], correctIdx: 0 },
      ],
      poolSize: 4,
    },
    {
