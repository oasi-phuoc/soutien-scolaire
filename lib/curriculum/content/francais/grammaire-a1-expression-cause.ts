  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ne me repose pas ___ je veux finir.", choices: ["parce que", "comme", "grâce à", "afin que"], correctIdx: 0 },
        { sentence: "___ je veux finir ce soir, je ne m'arrête pas.", choices: ["Comme", "Parce que", "Grâce à", "Afin que"], correctIdx: 0 },
        { sentence: "___ tu es fatigué, va te reposer !", choices: ["Puisque", "Parce que", "Grâce à", "Afin que"], correctIdx: 0 },
        { sentence: "Je suis en retard ___ toi.", choices: ["à cause de", "grâce à", "parce que", "comme"], correctIdx: 0 },
        { sentence: "Je finis plus vite ___ toi.", choices: ["grâce à", "à cause de", "parce que", "comme"], correctIdx: 0 },
        { sentence: "La route est fermée ___ mauvais temps.", choices: ["en raison du", "grâce au", "parce que le", "comme le"], correctIdx: 0 },
        { sentence: "___ est toujours en tête de phrase.", choices: ["Comme", "Parce que", "Afin que", "Pour que"], correctIdx: 0 },
        { sentence: "… parce que je suis fatigué et ___ je dois me lever tôt.", choices: ["que", "parce que", "comme", "puisque"], correctIdx: 0 },
        { sentence: "— Pourquoi ? — ___ j'étais malade.", choices: ["Parce que", "Comme", "Grâce à", "Afin que"], correctIdx: 0 },
        { sentence: "___ soleil, on est sortis. (positif)", choices: ["Grâce au", "À cause du", "Parce que le", "Comme le"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
