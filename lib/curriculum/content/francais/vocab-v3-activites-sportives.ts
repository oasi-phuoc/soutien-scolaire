...
export const V3_ACTIVITES_SPORTIVES_THEME: VocabTheme = {
  ...
  section: "V3",
  words: [
    { word: "jouer", image: "jouer.png",      definition: "participer à un jeu ou un sport" },
    { word: "courir", image: "courir.png",     definition: "se déplacer rapidement à pied" },
    { word: "marcher", image: "marcher.png",    definition: "se déplacer à pied à allure normale" },
    { word: "nager", image: "nager.png",      definition: "se déplacer dans l'eau" },
    { word: "sauter", image: "sauter.png",     definition: "s'élever dans les airs d'un bond" },
    { word: "frapper", image: "frapper.jpg",    definition: "donner un coup sur quelque chose" },
    { word: "lancer", image: "lancer.png",     definition: "projeter quelque chose avec la main" },
    { word: "pratiquer", image: "pratiquer.jpg",  definition: "exercer régulièrement une activité" },
    { word: "entraîner", image: "entrainer.jpg",  definition: "préparer quelqu'un à une compétition" },
    { word: "participer", image: "participer.jpg", definition: "prendre part à une activité ou compétition" },
    { word: "gagner", image: "gagner.png",     definition: "remporter une victoire ou un prix" },
    { word: "perdre", image: "perdre.png",     definition: "ne pas remporter une compétition" },
    { word: "s'échauffer", image: "s-echauffer.png", definition: "faire des exercices légers avant un effort" },
