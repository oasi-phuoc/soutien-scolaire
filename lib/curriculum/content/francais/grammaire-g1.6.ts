...
export const A1_GR_PRONOMINAUX: GrammarLesson = {
  ...
  theory: [
...

    {
      ...
      trans: { en: "Common reflexive verbs", ar: "أفعال انعكاسية شائعة", fa: "افعال انعکاسی پرکاربرد", pt: "Verbos reflexos comuns", so: "Falal iscelin oo caadi ah", ti: "ልሙዳት ናይ ርእሰ-ግሲታት", tr: "Yaygın dönüşlü fiiller", ps: "عام انعکاسي فعلونه", uk: "Поширені зворотні дієслова" },
    },
...

    {
      ...
      sub: true,
      accent: true,
      trans: { en: "Reflexive vs reciprocal", ar: "انعكاسي مقابل متبادل", fa: "انعکاسی در برابر متقابل", pt: "Reflexo vs recíproco", so: "Iscelin iyo isdhaafsi", ti: "ርእሰ-ግሲ ኣንጻር ምልውዋጥ", tr: "Dönüşlü ve karşılıklı", ps: "انعکاسي او متقابل", uk: "Зворотні проти взаємних" },
    },
    {
      type: "grid",
      ...
      transRows: {
        ...
        pt: [["Reflexo", "O sujeito age sobre si próprio.", "Je {a}me{/a} regarde dans le miroir."], ["Recíproco", "Os sujeitos agem uns sobre os outros.", "Nous {a}nous{/a} regardons. (each other)"]],
        so: [["Iscelin", "Faluhu ficilka isaga ayuu ku sameeyaa.", "Je {a}me{/a} regarde dans le miroir."], ["Isdhaafsi", "Falayaashu midba midka kale ayuu ficilka ku sameeyaa.", "Nous {a}nous{/a} regardons. (each other)"]],
        ...
        tr: [["Dönüşlü", "Özne eylemi kendisi üzerinde yapar.", "Je {a}me{/a} regarde dans le miroir."], ["Karşılıklı", "Özneler birbirleri üzerinde eylem yapar.", "Nous {a}nous{/a} regardons. (each other)"]],
        ps: [["انعکاسي", "فاعل عمل پر خپل ځان کوي.", "Je {a}me{/a} regarde dans le miroir."], ["متقابل", "فاعلونه پر یو بل عمل کوي.", "Nous {a}nous{/a} regardons. (each other)"]],
    ...
    },
    {
      ...
      transItems: {
        ...
        pt: ["Quando o verbo começa por vogal ou h, {a}me / te / se{/a} torna-se {a}m' / t' / s'{/a}."],
        so: ["Marka falku ku bilaabmo shaqal ama h, {a}me / te / se{/a} waxay noqdaan {a}m' / t' / s'{/a}."],
        ti: ["እቲ ግሲ ብኣድማጺ ፊደል ወይ h ምስ ዝጅምር፣ {a}me / te / se{/a} ናብ {a}m' / t' / s'{/a} ይቕየር።"],
        tr: ["Fiil bir ünlüyle veya h ile başladığında {a}me / te / se{/a}, {a}m' / t' / s'{/a} olur."],
        ps: ["کله چې فعل په واول یا h پیل شي، {a}me / te / se{/a} په {a}m' / t' / s'{/a} بدلېږي."],
