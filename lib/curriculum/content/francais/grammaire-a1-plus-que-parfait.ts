  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Il a appelé un serrurier parce qu'il ___ ses clés.", choices: ["avait oublié", "a oublié", "oubliait", "oublie"], correctIdx: 0 },
        { sentence: "Le train ___ déjà parti quand je suis arrivé.", choices: ["était", "est", "a", "sera"], correctIdx: 0 },
        { sentence: "Il a appelé un taxi parce qu'il ___ le train.", choices: ["avait manqué", "a manqué", "manquait", "manque"], correctIdx: 0 },
        { sentence: "Je me suis couché quand je ___ rentré. (immédiat)", choices: ["suis", "étais", "avais", "serai"], correctIdx: 0 },
        { sentence: "Je ___ pas pris mes clés.", choices: ["n'avais", "n'ai", "n'étais", "ne suis"], correctIdx: 0 },
        { sentence: "Formation : auxiliaire à l'___ + participe passé.", choices: ["imparfait", "présent", "passé composé", "futur"], correctIdx: 0 },
        { sentence: "Quand je suis arrivé, le train était parti. → parti ___ .", choices: ["avant", "après", "en même temps", "jamais"], correctIdx: 0 },
        { sentence: "Quand je suis arrivé, le train partait. → ___ .", choices: ["en cours", "avant", "après", "habitude future"], correctIdx: 0 },
        { sentence: "Quand je suis arrivé, le train est parti. → parti ___ .", choices: ["après", "avant", "jamais", "toujours avant"], correctIdx: 0 },
        { sentence: "Je m'___ réveillé trop tard.", choices: ["étais", "avais", "ai", "suis"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
