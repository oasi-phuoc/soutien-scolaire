...
export const V4_PANNES_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "réparation", image: "reparation.jpg",    article: "la",  gender: "f", definition: "action de réparer quelque chose" },
    { word: "plombier", image: "plombier.jpg",      article: "le",  gender: "m", definition: "artisan spécialiste des installations d'eau" },
    { word: "électricien", image: "electricien.jpg",   article: "l'",  gender: "m", definition: "artisan spécialiste des installations électriques" },
