  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "— Qui est là ? — ___ !", choices: ["Moi", "Je", "Me"], correctIdx: 0 },
        { sentence: "Je suis français. Et ___ ?", choices: ["toi", "tu", "te"], correctIdx: 0 },
        { sentence: "Stéphane, c'est ___ !", choices: ["lui", "il", "le"], correctIdx: 0 },
        { sentence: "Il habite chez ___ .", choices: ["elle", "la", "lui"], correctIdx: 0 },
        { sentence: "Tu travailles avec ___ ?", choices: ["eux", "ils", "les"], correctIdx: 0 },
        { sentence: "Ces valises sont à ___ .", choices: ["elles", "ils", "les"], correctIdx: 0 },
        { sentence: "J'ai un message pour ___ .", choices: ["vous", "tu", "te"], correctIdx: 0 },
        { sentence: "— J'ai faim ! — ___ aussi !", choices: ["Moi", "Je", "Me"], correctIdx: 0 },
        { sentence: "La valise est à ___ .", choices: ["lui", "il", "le"], correctIdx: 0 },
        { sentence: "___ , je suis lyonnais.", choices: ["Moi", "Je", "Me"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
