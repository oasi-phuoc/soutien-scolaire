  ...
  theory: [
    ...
    },
    {
      ...
      transHeaders: {
        ...
        ar: ["المذكر\nقبل ساكن", "المذكر\nقبل حرف متحرك / h صامت", "المؤنث", "جمع المذكر"],
        fa: ["مذکر\nپیش از همخوان", "مذکر\nپیش از واکه / h بی‌صدا", "مؤنث", "جمع مذکر"],
        pt: ["Masculino\nantes de consoante", "Masculino\nantes de vogal/h mudo", "Feminino", "Plural masculino"],
        so: ["Lab\nka hor shibbane", "Lab\nka hor shaqal/h aan la dhawaaqin", "Dheddig", "Jamac lab"],
        ti: ["ተባዕታይ\nቅድሚ ተናባቢ", "ተባዕታይ\nቅድሚ ናይ ድምጺ ፊደል / h ዝሕባእ", "ኣንስታይ", "ባዙሕ ተባዕታይ"],
        tr: ["Ünsüzden önce\neril", "Ünlü/sessiz h’den önce\neril", "Dişil", "Eril çoğul"],
        ps: ["له بې‌واکه توري مخکې\nمذکر", "له واکې/بې‌غږه h مخکې\nمذکر", "مؤنث", "مذکر جمع"],
        uk: ["Чоловічий рід\nперед приголосною", "Чоловічий рід\nперед голосною/німим h", "Жіночий рід", "Множина чоловічого роду"],
      },
      equalCols: true,
      rows: [
