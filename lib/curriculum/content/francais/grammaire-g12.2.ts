...
export const A1_GR_PRONOMS_COD_COI: GrammarLesson = {
  ...
  theory: [
    ...
    {
      type: "text",
      text: "Avec un verbe sans préposition (aimer, connaître, voir…).",
    },
    {
      type: "grid",
      headers: ["", "Exemple"],
    ...
    { type: "heading", text: "Les pronoms COD et COI", trans: { en: "Direct (COD) and indirect (COI) object pronouns", ar: "ضمائر المفعول المباشر (COD) وغير المباشر (COI)", fa: "ضمایر مفعول مستقیم (COD) و غیرمستقیم (COI)", ti: "ናይ ቀጥታዊ (COD) ከምኡ'ውን ዘይቀጥታዊ (COI) ዕላማ ተውላጠ-ስም", uk: "Прямі (COD) та непрямі (COI) додаткові займенники" } },
    {
      ...
      transText: {
        ...
        ar: "تحلّ الضمائر الشخصية محل {a}اسم سبق ذكره{/a} لتجنّب التكرار.",
        fa: "ضمایر شخصی جای {a}اسمی که قبلاً ذکر شده{/a} را می‌گیرند تا از تکرار جلوگیری شود.",
        ti: "ናይ ሰብ ተውላጠ-ስም ምድግጋም ንምውጋድ {a}ኣቐዲሙ ዝተጠቕሰ ስም{/a} ይትክኡ።",
        uk: "Особові займенники замінюють {a}вже згаданий іменник{/a}, щоб уникнути повторень.",
      },
      items: [
      ...
      transItems: {
        en: [
          "{a}COD{/a} = direct object (no preposition).",
          "{a}COI{/a} = indirect object (with the preposition {a}à{/a}).",
        ],
        ar: [
          "{a}COD{/a} = مفعول به مباشر (بدون حرف جر).",
          "{a}COI{/a} = مفعول به غير مباشر (مع حرف الجر {a}à{/a}).",
        ],
        fa: [
          "{a}COD{/a} = مفعول مستقیم (بدون حرف اضافه).",
          "{a}COI{/a} = مفعول غیرمستقیم (با حرف اضافه {a}à{/a}).",
        ],
        ti: [
          "{a}COD{/a} = ቀጥታዊ ዕላማ (ብዘይ መስተዋድድ)።",
          "{a}COI{/a} = ዘይቀጥታዊ ዕላማ (ምስ መስተዋድድ {a}à{/a})።",
        ],
        uk: [
          "{a}COD{/a} = прямий додаток (без прийменника).",
          "{a}COI{/a} = непрямий додаток (з прийменником {a}à{/a}).",
        ],
      },
    },
    {
    ...
    { type: "heading", text: "Place du pronom", sub: true, accent: true, trans: { en: "Position of the pronoun", ar: "موضع الضمير", fa: "جایگاه ضمیر", ti: "ናይ ተውላጠ-ስም ቦታ", uk: "Місце займенника" } },
    {
      ...
      transText: {
        ...
        ar: "يوضع الضمير {a}قبل{/a} الفعل المصرّف.",
        fa: "ضمیر {a}پیش از{/a} فعل صرف‌شده می‌آید.",
        ti: "ተውላጠ-ስም {a}ቅድሚ{/a} እቲ ዝተሰረዐ ግሲ ይቕመጥ።",
        uk: "Займенник стоїть {a}перед{/a} відмінюваним дієсловом.",
      },
      items: [
      ...
      transItems: {
        en: [
          "In the passé composé: before the auxiliary.",
          "With an infinitive: before the infinitive.",
        ],
        ar: [
          "في الماضي المركّب: قبل الفعل المساعد.",
          "مع المصدر: قبل المصدر.",
        ],
        fa: [
          "در گذشتهٔ نقلی: پیش از فعل کمکی.",
          "با مصدر: پیش از مصدر.",
        ],
        ti: [
          "ኣብ ሕሉፍ ግዜ: ቅድሚ እቲ ሓጋዚ።",
          "ምስ ስም-ግሲ: ቅድሚ እቲ ስም-ግሲ።",
        ],
        uk: [
          "У passé composé: перед допоміжним дієсловом.",
          "З інфінітивом: перед інфінітивом.",
        ],
      },
    },
    {
