  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ , on partage un moment avec ses amis.", choices: ["D'abord", "Enfin", "Donc"], correctIdx: 0 },
        { sentence: "___ , on apprend à suivre des règles.", choices: ["Puis", "D'abord", "Donc"], correctIdx: 0 },
        { sentence: "___ , on entraîne son cerveau.", choices: ["De plus", "D'abord", "Enfin"], correctIdx: 0 },
        { sentence: "___ , on se déconnecte des écrans.", choices: ["Pour finir", "D'abord", "Puis"], correctIdx: 0 },
        { sentence: "___ , les jeux entraînent la mémoire.", choices: ["Par exemple", "D'abord", "Donc"], correctIdx: 0 },
        { sentence: "___ , ils sont utiles. (= reformuler)", choices: ["Autrement dit", "Puis", "D'abord"], correctIdx: 0 },
        { sentence: "___ , je recommande ces jeux.", choices: ["En conclusion", "Puis", "D'abord"], correctIdx: 0 },
        { sentence: "Il pleut ; ___ , on reste.", choices: ["c'est pourquoi", "d'abord", "puis"], correctIdx: 0 },
        { sentence: "D'une part… ___ …", choices: ["d'autre part", "d'abord", "enfin"], correctIdx: 0 },
        { sentence: "___ (= en réalité)", choices: ["En fait", "Puis", "D'abord"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
