...
export const V7_BOULANGERIE_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "gâteau", image: "gâteau.jpg",          article: "le",  gender: "m", definition: "pâtisserie sucrée pour les fêtes" },
    ...
    { word: "pâtisserie", image: "pâtisserie.jpg",      article: "la",  gender: "f", definition: "art de faire des gâteaux et friandises" },
    { word: "éclair", image: "éclair.jpg",          article: "l'",  gender: "m", definition: "gâteau allongé fourré de crème" },
