...
export const A2_GR_SUBJONCTIF: GrammarLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      items: [],
      pool: [
        { sentence: "Je sais qu'il ___ raison.", choices: ["a (ind.)", "ait (subj.)", "aurait (cond.)"], correctIdx: 0 },
        { sentence: "Je veux qu'il ___ ici.", choices: ["soit (subj.)", "est (ind.)", "sera (futur)"], correctIdx: 0 },
        { sentence: "Il faut que tu ___ travailler.", choices: ["travailles (subj.)", "travailles (ind.)", "travailleras"], correctIdx: 0 },
        { sentence: "Je pense qu'il ___ vrai.", choices: ["est (ind.)", "soit (subj.)", "serait (cond.)"], correctIdx: 0 },
        { sentence: "J'espère qu'elle ___.", choices: ["viendra (ind./futur)", "vienne (subj.)", "venait (imp.)"], correctIdx: 0 },
        { sentence: "Bien qu'il ___ froid, il sort.", choices: ["fasse (subj.)", "fait (ind.)", "ferait (cond.)"], correctIdx: 0 },
      ],
      poolSize: 5,
    },
    {
