...
export const V8_MALADIES_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "fièvre", image: "fievre.jpg",        article: "la",  gender: "f", definition: "température corporelle anormalement élevée" },
    ...
    { word: "brûlure", image: "brulure.jpg",       article: "la",  gender: "f", definition: "lésion causée par la chaleur ou le feu" },
    ...
    { word: "mal de tête", image: "mal-de-tete.jpg",   article: "le",  gender: "m", definition: "douleur dans la tête" },
    ...
    { word: "nausée", image: "nausee.jpg",        article: "la",  gender: "f", definition: "sensation d'envie de vomir" },
  ],
  sentences: [
