  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je suis content qu'il ___ les courses. (gagner)", choices: ["ait gagné", "a gagné", "ait gagnés"], correctIdx: 0 },
        { sentence: "Nous sommes fiers qu'il ___ sur le podium. (monter)", choices: ["soit monté", "est monté", "ait monté"], correctIdx: 0 },
        { sentence: "Je suis triste qu'elle ___ la dernière. (arriver)", choices: ["soit arrivée", "est arrivée", "ait arrivé"], correctIdx: 0 },
        { sentence: "C'est dommage que tu ___ trop tard. (s'inscrire)", choices: ["te sois inscrit", "t'es inscrit", "t'aies inscrit"], correctIdx: 0 },
        { sentence: "Je trouve incroyable qu'il ___ trois fois. (gagner)", choices: ["ait gagné", "a gagné", "gagne"], correctIdx: 0 },
        { sentence: "Même sujet : Nous sommes fiers ___ sur le podium.", choices: ["d'être montés", "que nous soyons montés", "qu'on soit montés"], correctIdx: 0 },
        { sentence: "Auxiliaire au ___ + participe passé.", choices: ["subjonctif présent", "indicatif présent", "imparfait"], correctIdx: 0 },
        { sentence: "L'action du verbe 2 est ___ celle du verbe 1.", choices: ["avant", "après", "en même temps que"], correctIdx: 0 },
        { sentence: "Je suis content qu'ils ___ . (partir, être)", choices: ["soient partis", "sont partis", "aient partis"], correctIdx: 0 },
        { sentence: "C'est bien qu'elle ___ . (finir, avoir)", choices: ["ait fini", "a fini", "soit fini"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
