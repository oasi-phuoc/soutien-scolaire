...
export const V2_SAISONS_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "été", image: "été.jpg",           article: "l'",  gender: "m", definition: "saison la plus chaude de l'année" },
    ...
    { word: "période", image: "période.jpg",       article: "la",  gender: "f", definition: "espace de temps défini" },
    ...
    { word: "météo", image: "météo.jpg",         article: "la",  gender: "f", definition: "prévision des conditions atmosphériques" },
    { word: "température", image: "température.jpg",   article: "la",  gender: "f", definition: "mesure du chaud ou du froid en degrés" },
    { word: "se réchauffer", image: "se-réchauffer.jpg",                              definition: "devenir plus chaud, augmenter en température" },
    { word: "se rafraîchir", image: "se-rafraîchir.jpg",                              definition: "devenir plus frais, baisser en température" },
