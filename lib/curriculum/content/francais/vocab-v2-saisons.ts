...
export const V2_SAISONS_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "automne", image: "automne.png",       article: "l'",  gender: "m", definition: "saison entre l'été et l'hiver" },
    ...
    { word: "météo",         article: "la",  gender: "f", definition: "prévision des conditions atmosphériques" },
    { word: "température",   article: "la",  gender: "f", definition: "mesure du chaud ou du froid en degrés" },
    { word: "se réchauffer",                              definition: "devenir plus chaud, augmenter en température" },
    { word: "se rafraîchir",                              definition: "devenir plus frais, baisser en température" },
