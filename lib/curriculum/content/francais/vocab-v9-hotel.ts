...
export const V9_HOTEL_THEME: VocabTheme = {
  ...
  section: "V9",
  words: [
    { word: "réception", image: "reception.jpg",       article: "la",  gender: "f", definition: "accueil principal de l'hôtel" },
    { word: "clé", image: "cle.jpg",             article: "la",  gender: "f", definition: "objet pour ouvrir la chambre" },
    { word: "chambre", image: "/vocab/images/V4/chambre.jpg",         article: "la",  gender: "f", definition: "pièce pour dormir à l'hôtel" },
    ...
    { word: "petit-déjeuner", image: "petit-dejeuner.jpg",  article: "le",  gender: "m", definition: "repas du matin à l'hôtel" },
    { word: "demi-pension", image: "demi-pension.jpg",    article: "la",  gender: "f", definition: "formule hôtel avec petit-déjeuner et dîner" },
    { word: "réservation", image: "reservation.jpg",     article: "la",  gender: "f", definition: "action de retenir une chambre à l'avance" },
    { word: "nuit", image: "/vocab/images/V2/nuit.jpg",            article: "la",  gender: "f", definition: "unité de séjour à l'hôtel" },
    { word: "étage", image: "etage.jpg",           article: "l'",  gender: "m", definition: "niveau du bâtiment" },
