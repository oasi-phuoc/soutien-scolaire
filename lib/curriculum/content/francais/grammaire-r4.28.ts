...
export const A2_GR_L52: GrammarLesson = {
  ...
  theory: [
    { type: "heading", text: "Exprimer la cause", trans: { en: "Expressing cause", ar: "التعبير عن السبب", fa: "بیان علت", ti: "ምኽንያት ምግላጽ", uk: "Вираження причини" } },
    {
      ...
      transItems: {
        en: ["The cause explains {a}why{/a} something happens.", "Cause can be expressed with different words depending on register and position in the sentence."],
        ar: ["السبب يُفسّر {a}لماذا{/a} يحدث شيء ما.", "يمكن التعبير عن السبب بكلمات مختلفة حسب المستوى والموضع في الجملة."],
        fa: ["علت توضیح می‌دهد {a}چرا{/a} چیزی اتفاق می‌افتد.", "می‌توان علت را با کلمات مختلف بسته به سطح زبان و جایگاه در جمله بیان کرد."],
        ti: ["እቲ ምኽንያት {a}ስለምንታይ{/a} ሓደ ነገር ከም ዝፍጸም የብርህ።", "ምኽንያት ብደረጃ ቋንቋን ኣብ ሓረግ ብዘለዎ ቦታን መሰረት ብዝተፈላለዩ ቃላት ክግለጽ ይኽእል።"],
        uk: ["Причина пояснює, {a}чому{/a} щось відбувається.", "Причину можна виразити різними словами залежно від регістру та місця в реченні."],
      },
    },
    {
      type: "grid",
