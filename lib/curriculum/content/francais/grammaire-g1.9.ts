...
export const A1_GR_VERBES_IR: GrammarLesson = {
  ...
  theory: [
    ...
    {
      type: "text",
      text: "{a}1.{/a} On ne prononce pas le {a}s{/a} et le {a}t{/a} finaux au singulier (fini{a}s{/a}, fini{a}t{/a}).",
      transText: {
    ...
    {
      type: "text",
      text: "{a}1.{/a} On ne prononce pas le {a}s{/a} et le {a}t{/a} finaux au singulier.",
      transText: {
