  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "« Mon train a du retard. » → Elle dit ___ son train a du retard.", choices: ["que", "si", "de"], correctIdx: 0 },
        { sentence: "« Est-ce que l'avion a du retard ? » → Elle demande ___ l'avion a du retard.", choices: ["si", "que", "de"], correctIdx: 0 },
        { sentence: "« Qu'est-ce que vous attendez ? » → Elle me demande ___ j'attends.", choices: ["ce que", "si", "que"], correctIdx: 0 },
        { sentence: "« Attendez-moi ! » → Elle nous demande ___ .", choices: ["de l'attendre", "que nous l'attendions", "si on l'attend"], correctIdx: 0 },
        { sentence: "« Ne m'attendez pas ! » → Elle me dit ___ l'attendre.", choices: ["de ne pas", "que ne pas", "ne pas de"], correctIdx: 0 },
        { sentence: "Elle dit qu'elle prendra un taxi et ___ elle n'arrivera pas.", choices: ["qu'", "si", "de"], correctIdx: 0 },
        { sentence: "« Où pars-tu ? » → Elle me demande ___ je pars.", choices: ["où", "si", "que"], correctIdx: 0 },
        { sentence: "On enlève les ___ du discours direct.", choices: ["guillemets / ? / !", "pronoms", "verbes"], correctIdx: 0 },
        { sentence: "« Tu peux me prêter ta valise ? » → … si je peux ___ prêter ___ valise.", choices: ["lui / ma", "me / ta", "lui / ta"], correctIdx: 0 },
        { sentence: "« Je prendrai un taxi. » → Elle dit qu'elle ___ un taxi.", choices: ["prendra", "prenne", "prendrait"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
