  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je n'___ ai plus. (des croissants)", choices: ["en", "y", "les", "des"], correctIdx: 0 },
        { sentence: "Tu veux du café ? — J'___ veux bien.", choices: ["en", "y", "le", "du"], correctIdx: 0 },
        { sentence: "J'ai deux frères. — J'___ ai trois.", choices: ["en", "y", "les", "des"], correctIdx: 0 },
        { sentence: "Il y a beaucoup d'invités. → Il y ___ a beaucoup.", choices: ["en", "les", "des", "y"], correctIdx: 0 },
        { sentence: "J'ai acheté un paquet de café. → J'___ ai acheté un.", choices: ["en", "y", "le", "du"], correctIdx: 0 },
        { sentence: "Tu mets combien d'œufs ? — J'___ mets quatre.", choices: ["en", "y", "les", "des"], correctIdx: 0 },
        { sentence: "Il va ___ inviter trois.", choices: ["en", "y", "les", "des"], correctIdx: 0 },
        { sentence: "Je n'___ ai pas.", choices: ["en", "y", "les", "de"], correctIdx: 0 },
        { sentence: "Il ne va pas ___ acheter.", choices: ["en", "y", "les", "des"], correctIdx: 0 },
        { sentence: "« En » remplace un nom précédé d'une ___ .", choices: ["quantité", "préposition à", "préposition sur", "négation"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
