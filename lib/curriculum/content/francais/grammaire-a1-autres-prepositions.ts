  ...
  exercises: [
    {
      ...
      pool: [
        ...
        { sentence: "La voiture est ___ la maison.", choices: ["devant", "derrière", "sous", "dans"], correctIdx: 0 },
        { sentence: "___ la maison, il y a un jardin.", choices: ["Derrière", "Devant", "Sur", "Dans"], correctIdx: 0 },
        { sentence: "La station est ___ du coiffeur.", choices: ["près", "loin", "sous", "au bout"], correctIdx: 0 },
        { sentence: "Tournez ___ puis à gauche.", choices: ["à droite", "en haut", "dehors", "au fond"], correctIdx: 0 },
        { sentence: "Les toilettes sont ___ du couloir.", choices: ["au fond", "au bord", "en face", "dehors"], correctIdx: 0 },
        { sentence: "La table est ___ le canapé et le fauteuil.", choices: ["entre", "jusqu'à", "devant", "près"], correctIdx: 0 },
        { sentence: "Je t'attends ___ . (= à l'air libre)", choices: ["dehors", "ici", "là-bas", "chez"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
