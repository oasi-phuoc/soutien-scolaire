...
export const V5_STRUCTURE_ECOLE_THEME: VocabTheme = {
  ...
  section: "V5",
  words: [
    { word: "école", image: "école.jpg",          article: "l'",  gender: "f", definition: "établissement où l'on apprend" },
    ...
    { word: "secrétariat", image: "secrétariat.jpg",    article: "le",  gender: "m", definition: "bureau administratif de l'école" },
    { word: "bibliothèque", image: "bibliothèque.jpg",   article: "la",  gender: "f", definition: "salle avec des livres à consulter" },
    { word: "cafétéria", image: "cafétéria.jpg",      article: "la",  gender: "f", definition: "espace pour manger à l'école" },
    ...
    { word: "récréation", image: "récréation.jpg",     article: "la",  gender: "f", definition: "pause entre les cours" },
