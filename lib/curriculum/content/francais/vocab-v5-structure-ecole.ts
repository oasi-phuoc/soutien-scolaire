...
export const V5_STRUCTURE_ECOLE_THEME: VocabTheme = {
  ...
  section: "V5",
  words: [
    { word: "école", image: "ecole.png",          article: "l'",  gender: "f", definition: "établissement où l'on apprend" },
    ...
    { word: "cour", image: "cour.png",           article: "la",  gender: "f", definition: "espace extérieur pour la récréation" },
