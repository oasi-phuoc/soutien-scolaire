  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "J'ai vu ___ les films de Godard.", choices: ["tous", "tout", "toutes", "toute"], correctIdx: 0 },
        { sentence: "Elle écoute cette chanson ___ la journée.", choices: ["toute", "tout", "tous", "toutes"], correctIdx: 0 },
        { sentence: "___ le monde chante.", choices: ["Tout", "Tous", "Toute", "Toutes"], correctIdx: 0 },
        { sentence: "Il a présenté ___ musicien.", choices: ["chaque", "chacun", "tous", "plusieurs"], correctIdx: 0 },
        { sentence: "Il n'y a ___ fille dans le groupe.", choices: ["aucune", "aucun", "chaque", "plusieurs"], correctIdx: 0 },
        { sentence: "J'ai ___ amis musiciens. (plus de deux)", choices: ["plusieurs", "chaque", "aucun", "toute"], correctIdx: 0 },
        { sentence: "J'ai ___ amis musiciens. (pas beaucoup)", choices: ["quelques", "chaque", "tout", "aucune"], correctIdx: 0 },
        { sentence: "J'aime la ___ chanson que toi.", choices: ["même", "mêmes", "autre", "autres"], correctIdx: 0 },
        { sentence: "J'aimerais écouter ___ chansons.", choices: ["d'autres", "des autres", "autres", "d'autre"], correctIdx: 0 },
        { sentence: "Il va au concert ___ trois mois.", choices: ["tous les", "chaque", "toutes les", "tout les"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
