  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ___ français.", choices: ["ne suis pas", "suis ne pas", "ne pas suis"], correctIdx: 0 },
        { sentence: "Je ___ à Lyon.", choices: ["n'habite pas", "ne habite pas", "habite ne pas"], correctIdx: 0 },
        { sentence: "Il n'a ___ frère.", choices: ["pas de", "pas un", "pas des"], correctIdx: 0 },
        { sentence: "Je n'ai ___ sœur.", choices: ["pas de", "pas une", "pas des"], correctIdx: 0 },
        { sentence: "Nous n'avons ___ petits-enfants.", choices: ["pas de", "pas des", "pas les"], correctIdx: 0 },
        { sentence: "Il ___ marié.", choices: ["n'est pas", "ne est pas", "est ne pas"], correctIdx: 0 },
        { sentence: "Il n'a ___ enfants.", choices: ["pas d'", "pas de", "pas des"], correctIdx: 0 },
        { sentence: "Tu ___ dans une banque.", choices: ["ne travailles pas", "travailles ne pas", "ne pas travailles"], correctIdx: 0 },
        { sentence: "Je suis marié. ≠ Je ___ marié.", choices: ["ne suis pas", "suis pas", "ne pas suis"], correctIdx: 0 },
        { sentence: "Devant une voyelle, ne devient ___ .", choices: ["n'", "ne", "pas"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
