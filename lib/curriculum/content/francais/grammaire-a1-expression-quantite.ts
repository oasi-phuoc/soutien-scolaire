  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "___ frites. (quantité excessive)", choices: ["Trop de", "Trop des", "Trop du", "Trop la"], correctIdx: 0 },
        { sentence: "___ frites. (quantité insuffisante)", choices: ["Pas assez de", "Pas assez des", "Pas assez du", "Pas assez la"], correctIdx: 0 },
        { sentence: "Je veux ___ pain.", choices: ["un peu de", "un peu du", "un peu des", "un peu le"], correctIdx: 0 },
        { sentence: "Je mange ___ oranges.", choices: ["beaucoup d'", "beaucoup des", "beaucoup de les", "beaucoup du"], correctIdx: 0 },
        { sentence: "Je mange ___ chocolat.", choices: ["beaucoup de", "beaucoup du", "beaucoup des", "beaucoup le"], correctIdx: 0 },
        { sentence: "Je voudrais ___ café.", choices: ["un peu de", "un peu du", "un peu le", "un peu des"], correctIdx: 0 },
        { sentence: "Il y a ___ sucre.", choices: ["assez de", "assez du", "assez des", "assez le"], correctIdx: 0 },
        { sentence: "___ oranges.", choices: ["Un kilo d'", "Un kilo des", "Un kilo du", "Un kilo de les"], correctIdx: 0 },
        { sentence: "___ huile.", choices: ["Une bouteille d'", "Une bouteille de l'", "Une bouteille du", "Une bouteille des"], correctIdx: 0 },
        { sentence: "Je veux ___ beurre.", choices: ["du", "un peu du", "beaucoup du", "trop du"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
