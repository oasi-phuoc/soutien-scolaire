...
export const V9_ESPACE_CULTUREL_THEME: VocabTheme = {
  ...
  section: "V9",
  words: [
    { word: "théâtre", image: "theatre.jpg",    article: "le",  gender: "m", definition: "lieu pour les représentations scéniques" },
    { word: "cinéma", image: "cinema.jpg",     article: "le",  gender: "m", definition: "lieu pour regarder des films" },
    { word: "musée", image: "musee.jpg",      article: "le",  gender: "m", definition: "lieu pour exposer des œuvres d'art" },
