  ...
  exercises: [
    {
      ...
      pool: [
        ...
        { sentence: "Elle ___ sorti les poubelles.", choices: ["a", "est", "ont", "sont"], correctIdx: 0 },
        { sentence: "Ils ___ montés à l'étage.", choices: ["sont", "ont", "est", "a"], correctIdx: 0 },
        { sentence: "Ils ___ monté les valises.", choices: ["ont", "sont", "a", "est"], correctIdx: 0 },
        { sentence: "Nous ___ descendus rapidement.", choices: ["sommes", "avons", "êtes", "ont"], correctIdx: 0 },
        { sentence: "Nous ___ descendu les bagages.", choices: ["avons", "sommes", "ont", "êtes"], correctIdx: 0 },
        { sentence: "Il ___ retourné chez lui.", choices: ["est", "a", "sont", "ont"], correctIdx: 0 },
        { sentence: "Il ___ retourné la crêpe.", choices: ["a", "est", "ont", "sont"], correctIdx: 0 },
        { sentence: "Elle ___ rentrée tard.", choices: ["est", "a", "sont", "ont"], correctIdx: 0 },
        { sentence: "Ils ___ passés devant la mairie.", choices: ["sont", "ont", "est", "a"], correctIdx: 0 },
        { sentence: "Ils ___ passé l'examen.", choices: ["ont", "sont", "a", "est"], correctIdx: 0 },
        { sentence: "Elle ___ rentré le vélo au garage.", choices: ["a", "est", "ont", "sont"], correctIdx: 0 },
      ],
      poolSize: 6,
    },
    {
