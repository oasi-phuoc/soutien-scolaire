  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Je ne joue ___ aux échecs.", choices: ["jamais", "plus", "rien", "personne"], correctIdx: 0 },
        { sentence: "Je n'habite ___ en France.", choices: ["plus", "jamais", "rien", "que"], correctIdx: 0 },
        { sentence: "Le musée n'est ___ ouvert.", choices: ["pas encore", "jamais", "plus", "rien"], correctIdx: 0 },
        { sentence: "Je n'entends ___ .", choices: ["personne", "rien", "jamais", "plus"], correctIdx: 0 },
        { sentence: "Je ne vois ___ .", choices: ["rien", "personne", "jamais", "plus"], correctIdx: 0 },
        { sentence: "___ ne me connaît.", choices: ["Personne", "Rien", "Jamais", "Plus"], correctIdx: 0 },
        { sentence: "___ ne m'intéresse !", choices: ["Rien", "Personne", "Jamais", "Ni"], correctIdx: 0 },
        { sentence: "Je ne parle ___ français !", choices: ["que", "ni", "rien", "plus"], correctIdx: 0 },
        { sentence: "Je n'aime ___ le rock ___ le rap.", choices: ["ni… ni", "que… que", "pas… pas", "plus… plus"], correctIdx: 0 },
        { sentence: "Toujours / souvent ↔ ___ .", choices: ["jamais", "plus", "rien", "personne"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
