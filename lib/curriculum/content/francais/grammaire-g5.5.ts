  ...
  theory: [
   {
    ...
    },
    {
      ...
      transText: {
        en: "The negation consists of two words placed on either side of the conjugated verb. The negative structure uses {a}ne{/a} + {a}pas{/a}.",
        ar: "يتكوّن النفي من كلمتين توضعان على جانبي الفعل المصرف. تستخدم بنية النفي {a}ne{/a} + {a}pas{/a}.",
        fa: "ساختار منفی از دو کلمه تشکیل می‌شود که در دو طرف فعل صرف‌شده قرار می‌گیرند. ساختار منفی از {a}ne{/a} + {a}pas{/a} استفاده می‌کند.",
        pt: "A negação é composta por duas palavras colocadas de cada lado do verbo conjugado. A estrutura da negação utiliza {a}ne{/a} + {a}pas{/a}.",
        so: "Diidmadu waxay ka kooban tahay laba eray oo la dhigo labada dhinac ee falka la rogay. Qaabka diidmadu wuxuu isticmaalaa {a}ne{/a} + {a}pas{/a}.",
        ti: "ኣሉታዊ ቅርጺ ክልተ ቃላት ካብ ክልቲኡ ሸነኽ ናይቲ ዝተጸረየ ግሲ ዝተቐመጡ ይሓቍፍ። እቲ ኣሉታዊ ቅርጺ {a}ne{/a} + {a}pas{/a} ይጥቀም።",
        tr: "Olumsuzluk, çekimli fiilin iki tarafına yerleştirilen iki kelimeden oluşur. Olumsuzluk yapısı {a}ne{/a} + {a}pas{/a} kullanır.",
        ps: "منفي جوړښت له دوو کلمو څخه جوړ دی چې د صرف شوي فعل دواړو خواوو ته راځي. د منفي جوړښت لپاره {a}ne{/a} + {a}pas{/a} کارول کېږي.",
        uk: "Заперечення складається з двох слів, які ставляться по обидва боки від дієслова в особовій формі. У заперечній конструкції використовуються {a}ne{/a} + {a}pas{/a}.",
        sq: "Mohimi përbëhet nga dy fjalë që vendosen në të dyja anët e foljes së zgjedhuar. Struktura e mohimit përdor {a}ne{/a} + {a}pas{/a}.",
        prs: "ساختار منفی از دو کلمه تشکیل می‌شود که در دو طرف فعل صرف‌شده قرار می‌گیرند. ساختار منفی از {a}ne{/a} + {a}pas{/a} استفاده می‌کند.",
        es: "La negación está formada por dos palabras colocadas a ambos lados del verbo conjugado. La estructura de la negación utiliza {a}ne{/a} + {a}pas{/a}.",
        it: "La negazione è composta da due parole poste ai lati del verbo coniugato. La struttura della negazione utilizza {a}ne{/a} + {a}pas{/a}.",
        ru: "Отрицание состоит из двух слов, которые ставятся по обе стороны от спряжённого глагола. В отрицательной конструкции используются {a}ne{/a} + {a}pas{/a}.",
        am: "ኣሉታዊ ቅርጺ ኣብ ክልቲኡ ሸነኽ ናይቲ ዝተጸረየ ግሲ ዝቕመጡ ክልተ ቃላት ይሓቍፍ። እቲ ኣሉታዊ ቅርጺ {a}ne{/a} + {a}pas{/a} ይጥቀም።",
      },
      items: [
