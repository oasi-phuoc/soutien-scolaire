...
export const V7_RESTAURANT_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "verre", image: "/vocab/images/V6/verre.png",      article: "le",  gender: "m", definition: "récipient pour boire les liquides" },
    { word: "serviette", image: "serviette.jpg",  article: "la",  gender: "f", definition: "tissu pour s'essuyer la bouche" },
    { word: "entrée", image: "/vocab/images/V4/entree.jpg",     article: "l'",  gender: "f", definition: "premier plat d'un repas au restaurant" },
    ...
    { word: "serveur", image: "/vocab/images/V1/serveur.jpg",    article: "le",  gender: "m", definition: "personne qui sert les clients" },
