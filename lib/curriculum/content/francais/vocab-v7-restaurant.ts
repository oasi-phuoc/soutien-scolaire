...
export const V7_RESTAURANT_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "cuillère", image: "cuillère.jpg",   article: "la",  gender: "f", definition: "ustensile pour les soupes et desserts" },
    ...
    { word: "entrée", image: "entrée.jpg",     article: "l'",  gender: "f", definition: "premier plat d'un repas au restaurant" },
