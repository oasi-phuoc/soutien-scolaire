  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Les gens marchent ___ il y a une grève.", choices: ["quand", "avant que", "afin que"], correctIdx: 0 },
        { sentence: "___ la grève a commencé, j'étais dans le métro.", choices: ["Au moment où", "Avant que", "Afin que"], correctIdx: 0 },
        { sentence: "___ la négociation avait lieu, les grévistes sont entrés.", choices: ["Pendant que", "Avant que", "Dès que"], correctIdx: 0 },
        { sentence: "La grève a été annoncée ___ ils ont pris le train.", choices: ["après qu'", "avant que", "jusqu'à ce qu'"], correctIdx: 0 },
        { sentence: "Ils ont pris le train ___ la grève soit annoncée.", choices: ["avant que", "après que", "dès que"], correctIdx: 0 },
        { sentence: "Même sujet : ___ partir, on n'a pas écouté la radio.", choices: ["Avant de", "Avant que", "Après que"], correctIdx: 0 },
        { sentence: "Le trafic reprendra ___ la grève prendra fin.", choices: ["dès que", "avant que", "afin que"], correctIdx: 0 },
        { sentence: "Les négociations continueront ___ un accord soit trouvé.", choices: ["jusqu'à ce qu'", "après qu'", "dès que"], correctIdx: 0 },
        { sentence: "avant que + ___", choices: ["subjonctif", "indicatif", "infinitif"], correctIdx: 0 },
        { sentence: "après que + ___", choices: ["indicatif", "subjonctif", "infinitif"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
