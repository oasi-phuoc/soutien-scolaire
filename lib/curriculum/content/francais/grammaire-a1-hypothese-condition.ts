  ...
  exercises: [
    {
      ...
      poolSize: 5,
      pool: [
        { sentence: "Si j'ai beaucoup d'argent, je ___ loin.", choices: ["partirai", "partirais", "partais", "sois parti"], correctIdx: 0 },
        { sentence: "Si j'avais le temps, je ___ plus de choses.", choices: ["ferais", "ferai", "fais", "fasse"], correctIdx: 0 },
        { sentence: "S'il était parti plus tôt, il ___ à l'heure.", choices: ["serait arrivé", "arrivera", "arrive", "soit arrivé"], correctIdx: 0 },
        { sentence: "Si vous avez un problème, ___ -moi.", choices: ["prévenez", "préviendrez", "préviendriez", "prévenir"], correctIdx: 0 },
        { sentence: "___ avait le temps… (élision)", choices: ["S'il", "Si il", "Si'il", "Sil"], correctIdx: 0 },
        { sentence: "Dans la subordonnée en si, on n'emploie pas le ___ .", choices: ["futur", "présent", "imparfait", "plus-que-parfait"], correctIdx: 0 },
        { sentence: "Je t'appelle ___ problème.", choices: ["en cas de", "à condition que", "si de", "pour que"], correctIdx: 0 },
        { sentence: "J'arriverai à l'heure ___ mon train n'ait pas de retard.", choices: ["à condition que", "si que", "en cas que", "afin de"], correctIdx: 0 },
        { sentence: "Même sujet : à condition ___ partir plus tôt.", choices: ["de", "que", "à", "pour"], correctIdx: 0 },
        { sentence: "Si j'ai le temps, je ___ .", choices: ["viendrai", "viendrais", "venais", "sois venu"], correctIdx: 0 },
      ],
    },
    {
      type: "fill",
