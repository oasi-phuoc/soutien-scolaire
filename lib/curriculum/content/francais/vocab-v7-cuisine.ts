...
export const V7_CUISINE_THEME: VocabTheme = {
  ...
  words: [
    ...
    { word: "mélanger", image: "mélanger.jpg",  definition: "combiner des ingrédients" },
    ...
    { word: "rôtir", image: "rôtir.jpg",     definition: "cuire au four à chaleur sèche" },
    ...
    { word: "goûter", image: "goûter.jpg",    definition: "tester le goût d'un aliment" },
    { word: "laver", image: "laver.jpg",     definition: "nettoyer à l'eau" },
    { word: "éplucher", image: "éplucher.jpg",  definition: "enlever la peau d'un légume ou fruit" },
    { word: "verser", image: "verser.jpg",    definition: "faire couler un liquide d'un récipient" },
    { word: "préparer", image: "préparer.jpg",  definition: "mettre en ordre les ingrédients avant de cuisiner" },
    { word: "réchauffer", image: "réchauffer.jpg",definition: "chauffer à nouveau un plat déjà cuit" },
  ],
  sentences: [
