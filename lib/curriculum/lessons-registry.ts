import type { MathSubmoduleLesson } from "./content/math/math-a1-types";
import { MATH_A1_LESSONS } from "./content/math/math-a1";
import { MATH_A2_LESSONS } from "./content/math/math-a2";
import { MATH_A3_LESSONS } from "./content/math/math-a3";
import { MATH_A4_LESSONS } from "./content/math/math-a4";
import { MATH_A5_LESSONS } from "./content/math/math-a5";
import { MATH_A6_LESSONS } from "./content/math/math-a6";
import { MATH_A7_LESSONS } from "./content/math/math-a7";
import { MATH_A8_LESSONS } from "./content/math/math-a8";
