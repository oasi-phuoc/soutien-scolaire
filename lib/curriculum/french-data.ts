...
export const FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-conj-l08", "C.2",  "Les verbes aller et venir",              "Conjuguer aller et venir au présent + prépositions de lieu (à, au, aux, en).",           "conjugaison"),
  lesson("A1", "a1-conj-l09", "C.3",  "Les verbes pronominaux",                 "Se lever, se coucher, s'appeler : les pronominaux du quotidien.",                        "conjugaison"),
  lesson("A1", "a1-conj-l12", "C.4",  "Les verbes de mouvement",                "Partir, arriver, entrer, sortir, monter, descendre au présent.",                         "conjugaison"),
  lesson("A1", "a1-conj-l15", "C.5",  "Vouloir, pouvoir, devoir",               "Les trois verbes modaux essentiels : conjugaison et emploi au présent.",                  "conjugaison"),
  lesson("A1", "a1-conj-l20", "C.6",  "Le futur proche",                        "Aller + infinitif : parler de ce qui va arriver bientôt.",                               "conjugaison"),
  lesson("A1", "a1-conj-l27", "C.7",  "Pronominaux réfléchis et réciproques",   "Se laver, se regarder, se parler, s'écrire : formes et sens.",                           "conjugaison"),
