...
export const FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-l10",   "G.13", "L'interrogation avec les mots interrogatifs", "Qui, quoi, où, quand, comment, pourquoi, combien + est-ce que.",                        "grammaire"),
  lesson("A1", "a1-gr-l11",   "G.14", "Les prépositions de lieu",                    "Dans, sur, sous, devant, derrière, à côté de, en face de…",                            "grammaire"),
  lesson("A1", "a1-gr-l14",   "G.15", "Les articles partitifs et la quantité",       "Du, de la, de l', des + un kilo de, beaucoup de, un peu de…",                          "grammaire"),
  lesson("A1", "a1-gr-l05",   "G.16", "Le verbe avoir et les adjectifs possessifs",  "J'ai, tu as… + mon, ma, mes / ton, ta, tes / son, sa, ses…",                           "grammaire"),
  lesson("A1", "a1-gr-l17",   "G.17", "Il y a et les prépositions dans la maison",   "Il y a / il n'y a pas de + localiser les meubles et les pièces.",                      "grammaire"),
  lesson("A1", "a1-gr-l18",   "G.18", "Les adjectifs démonstratifs",                 "Ce, cet, cette, ces : désigner et montrer quelque chose.",                              "grammaire"),
  lesson("A1", "a1-gr-l19",   "G.19", "Les adjectifs possessifs",                    "Mon/ma/mes, ton/ta/tes, son/sa/ses… : exprimer l'appartenance.",                        "grammaire"),
  lesson("A1", "a1-gr-l22",   "G.20", "La fréquence",                                "Toujours, souvent, parfois, rarement, jamais : situer une action dans le temps.",      "grammaire"),
  lesson("A1", "a1-gr-l23",   "G.21", "Les adjectifs qualificatifs",                 "Genre, nombre et place de l'adjectif dans la phrase.",                                  "grammaire"),
  lesson("A1", "a1-conj-l20", "G.22", "Le futur proche",                             "Aller + infinitif : parler de ce qui va arriver bientôt.",                               "conjugaison"),
  ...
  lesson("A2", "a2-conj-l01", "G.29", "Les verbes en -er — révision et particularités",  "Verbes en -ger/-cer, deux bases (préférer, acheter, appeler) ; élision et liaisons.",     "conjugaison"),
  lesson("A2", "a2-conj-l02", "G.30", "Les verbes en -ir (2e et 3e groupes)",             "Finir/choisir (2e groupe) vs partir/venir/ouvrir (3e groupe) : formes et différences.",   "conjugaison"),
  lesson("A2", "a2-conj-l03", "G.31", "Les verbes irréguliers courants",                  "Avoir, être, faire, aller, vouloir, pouvoir, devoir, sortir, boire, croire, connaître…",  "conjugaison"),
  lesson("A2", "a2-gr-l07",   "G.32", "L'interrogation (questions fermées)",              "Intonation montante, est-ce que, inversion sujet-verbe (registre formel/informel).",       "grammaire"),
  lesson("A2", "a2-gr-l09",   "G.33", "Répondre aux questions fermées",                  "Oui, non, si ; moi aussi / moi non plus / moi si : nuancer les réponses.",                "grammaire"),
  lesson("A2", "a2-conj-l04", "G.34", "Le conditionnel de politesse",                    "Vouloir, pouvoir, aimer, souhaiter, devoir, falloir au conditionnel : formes et emplois.", "conjugaison"),
  lesson("A2", "a2-conj-l05", "G.35", "L'impératif",                                     "Conjugaison tu/nous/vous ; irréguliers être/avoir/aller ; impératif avec pronoms COD/COI.","conjugaison"),
  lesson("A2", "a2-gr-l18",   "G.36", "Les prépositions de lieu",                        "Dans, sur, sous, à côté de, près de, loin de, en face de, entre, derrière, devant.",      "grammaire"),
  lesson("A2", "a2-gr-l11",   "G.37", "Les adjectifs — généralités",                     "Genre, nombre, accord des adjectifs qualificatifs en contexte.",                           "grammaire"),
  lesson("A2", "a2-gr-l12",   "G.38", "Les adjectifs — cas particuliers et place",       "Nouveau/beau/vieux, adjectifs invariables, place avant ou après le nom.",                  "grammaire"),
  lesson("A2", "a2-gr-l19",   "G.39", "Les pronoms relatifs qui et que",                 "Qui = sujet du verbe relatif ; que = objet du verbe relatif ; relative avec où.",          "grammaire"),
  lesson("A2", "a2-gr-l25",   "G.40", "La négation — ne…pas, ne…plus, ne…que",          "Ne…pas (action absente), ne…plus (arrêt), ne…que (restriction) : formes et sens.",         "grammaire"),
  lesson("A2", "a2-gr-l42",   "G.41", "La négation — ne…jamais, ne…rien, ne…personne",  "Négation totale : formes, place, emploi comme sujet (rien/personne).",                     "grammaire"),
  lesson("A2", "a2-gr-l35",   "G.42", "Les pronoms COD et COI",                          "Me/te/le/la/les/lui/leur : place, négation, construction avec deux verbes.",                "grammaire"),
  lesson("A2", "a2-gr-l36",   "G.43", "Les pronoms Y et EN",                             "Y = à + lieu/chose ; EN = de + nom / partitif : place et emploi.",                         "grammaire"),
  lesson("A2", "a2-conj-l06", "G.44", "Le passé composé — avoir et être",               "Révision complète : participes, double auxiliaire, verbes pronominaux au PC.",              "conjugaison"),
  lesson("A2", "a2-conj-l07", "G.45", "L'imparfait",                                     "Formation (base nous + -ais…), emploi (habitude, description) vs passé composé.",          "conjugaison"),
  lesson("A2", "a2-conj-l08", "G.46", "Le futur simple",                                 "Formation régulière et irrégulière + hypothèse si + présent → futur simple.",              "conjugaison"),
  lesson("A2", "a2-gr-l39",   "G.47", "Le comparatif",                                   "Plus/aussi/moins + adjectif/adverbe/verbe/nom + que : formes régulières.",                 "grammaire"),
  lesson("A2", "a2-gr-l52",   "G.48", "La cause et la conséquence",                      "Parce que/car/comme/à cause de/grâce à ; donc/c'est pourquoi/par conséquent.",            "grammaire"),

  // ── A1 — Vocabulaire ────────────────────────────────────────────────────────
  lesson("A1", "a1-voc-l13", "V.5",  "Les moyens de transport",         "En voiture, à vélo, en avion… + prépositions et verbes de transport.",         "vocabulaire"),
  lesson("A1", "a1-voc-l16", "V.6",  "La nourriture et le restaurant",  "Aliments, repas de la journée, commander et payer au restaurant.",         "vocabulaire"),
  lesson("A1", "a1-voc-l21", "V.7",  "Les expressions de temps",        "Aujourd'hui, demain, après-demain, la semaine prochaine…",                    "vocabulaire"),
  lesson("A1", "a1-voc-l26", "V.8",  "Le corps humain",                 "Parties du corps + avoir mal à + article contracté (au/à la/aux).",            "vocabulaire"),
  ...
  lesson("A2", "a2-voc-l02", "V.14", "La santé et le médecin",          "Rendez-vous médical, symptômes, conseils + verbes de santé.",               "vocabulaire"),
  lesson("A2", "a2-voc-l03", "V.15", "Le monde du travail",             "Métiers, lieu de travail, chercher un emploi, expressions avec avoir.",     "vocabulaire"),
  lesson("A2", "a2-voc-l04", "V.16", "Les sorties et les invitations",  "Sortir, organiser, apéro, expo, pique-nique + formules informelles.",       "vocabulaire"),
  lesson("A2", "a2-voc-l05", "V.17", "La cuisine et les recettes",      "Ingrédients, ustensiles, actions de cuisine + recette simple.",             "vocabulaire"),
