...
const BASE_FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-l03", "G3.7", "Le genre des noms et des adjectifs", "Masculin/féminin : noms courants et adjectifs de nationalité.", "grammaire"),
  lesson("A1", "a1-gr-phrases", "G3.8", "Les phrases", "Structure Sujet + Verbe + Complément : reconnaître et construire une phrase simple.", "grammaire"),
  lesson("A1", "a1-gr-l02", "G3.9", "La négation", "Ne…pas : construire une phrase négative avec être et avoir.", "grammaire"),
  lesson("A1", "a1-gr-interro", "G3.10", "L'interrogation de base", "Est-ce que et l'intonation montante : construire une question simple.", "grammaire"),
  // ── G4 — Chapitre 4 — Unités 31–58 ──
  lesson("A1", "a1-gr-l10", "G4.1", "Les questions ouvertes", "Qui, quoi, où, quand, comment, pourquoi, combien + est-ce que.", "grammaire"),
