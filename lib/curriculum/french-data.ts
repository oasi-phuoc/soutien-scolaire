...
const BASE_FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-genre-adjectifs", "G3.1", "Le genre des adjectifs : cas général", "Accord de l'adjectif qualificatif au féminin : cas général.", "grammaire"),
  lesson("A1", "a1-gr-feminin-adjectifs-particuliers", "G3.2", "Le genre des adjectifs : cas particulier", "Terminaisons particulières et adjectifs irréguliers au féminin.", "grammaire"),
  lesson("A1", "a1-gr-pluriel-adjectifs", "G3.3", "Le pluriel des adjectifs", "Pluriel des adjectifs : -s, -aux, -eaux et mélange de genres.", "grammaire"),
  lesson("A1", "a1-gr-adjectifs-accords-particuliers", "G3.4", "L'accord des adjectifs", "Couleurs, demi et adjectifs numéraux (vingt, cent…).", "grammaire"),
