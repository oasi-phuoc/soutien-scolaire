...
const BASE_FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-phrase-exclamative", "G4.4", "La phrase exclamative", "Quel, que, comme, qu'est-ce que… comme : exprimer un sentiment.", "grammaire"),
  lesson("A1", "a1-gr-a-en-de-lieux", "G4.5", "À, en, de avec les noms de villes, pays et continents", "Prépositions de lieu avec les toponymes.", "grammaire"),
  lesson("A1", "a1-gr-autres-prepositions", "G4.6", "Autres prépositions et adverbes", "À/chez/de, sur/dans/sous, devant/derrière, ici/là/là-bas…", "grammaire"),
  lesson("A1", "a1-gr-passe-compose-avoir", "G4.7", "Le passé composé avec avoir", "Auxiliaire avoir + participe passé ; verbes en -er et formes fréquentes.", "grammaire"),
  lesson("A1", "a1-gr-passe-compose-etre", "G4.8", "Le passé composé avec être", "Verbes de déplacement, accord du participe et verbes pronominaux.", "grammaire"),
  lesson("A1", "a1-gr-imparfait", "G4.9", "L'imparfait", "Description et habitude passées ; formation depuis le nous du présent.", "grammaire"),
  lesson("A1", "a1-gr-passe-recent", "G4.10", "Le passé récent", "Venir de + infinitif : une action toute proche du moment présent.", "grammaire"),
  lesson("A1", "a1-gr-imparfait-passe-compose", "G4.11", "L'imparfait / Le passé composé", "Décor et habitude (imparfait) vs actions délimitées (passé composé).", "grammaire"),
  lesson("A1", "a1-gr-plus-que-parfait", "G4.12", "Le plus-que-parfait", "Action antérieure dans un récit au passé ; auxiliaire à l'imparfait + participe.", "grammaire"),
  lesson("A1", "a1-gr-accord-participe-passe", "G4.13", "L'accord du participe passé", "Accord avec être, avec le COD antéposé après avoir ; exception en.", "grammaire"),
  lesson("A1", "a1-gr-futur-proche", "G4.14", "Le futur proche", "Aller + infinitif : projet et événement immédiat.", "grammaire"),
  lesson("A1", "a1-gr-futur-simple", "G4.15", "Le futur simple", "Prévisions, promesses, programmes ; formation et radicaux irréguliers.", "grammaire"),
  lesson("A1", "a1-gr-futur-anterieur", "G4.16", "Le futur antérieur", "Action antérieure à un futur ou un impératif ; quand, dès que…", "grammaire"),
  lesson("A1", "a1-gr-comparaison-adj-adv", "G4.17", "La comparaison avec un adjectif ou un adverbe", "Plus, moins, aussi… que ; meilleur, mieux, pire.", "grammaire"),
  lesson("A1", "a1-gr-comparaison-nom-verbe", "G4.18", "La comparaison avec un nom ou un verbe", "Plus/moins/autant de… que ; plus/moins/autant que ; le même.", "grammaire"),
  lesson("A1", "a1-gr-superlatif", "G4.19", "Le superlatif", "Le/la/les plus ou moins ; meilleur, mieux, pire.", "grammaire"),
  lesson("A1", "a1-gr-expression-temps-moment", "G4.20", "L'expression du temps : moment précis ou habitude", "À, en, le… ; démonstratifs ; articles pour l'habitude.", "grammaire"),
  lesson("A1", "a1-gr-marqueurs-temps", "G4.21", "L'expression du temps : il y a, dans, depuis, pour, pendant, en…", "Situer une action : durée, début, fin ; il y a / dans / depuis / pour…", "grammaire"),
  lesson("A1", "a1-gr-pronoms-toniques", "G4.22", "Les pronoms toniques", "Moi, toi, lui, elle, nous, vous, eux, elles : formes et emplois.", "grammaire"),
  lesson("A1", "a1-gr-pronoms-cod-coi", "G4.23", "Les pronoms compléments directs et indirects", "Me/te/le/la/les/lui/leur : place, COD, COI et négation.", "grammaire"),
  lesson("A1", "a1-gr-pronom-en", "G4.24", "Le pronom complément en", "Remplacer une quantité : articles, nombres, beaucoup de…", "grammaire"),
  lesson("A1", "a1-gr-pronoms-y-en-lieu", "G4.25", "Les pronoms compléments de lieu y et en", "Y = lieu où l'on est/va ; en = lieu d'où l'on vient.", "grammaire"),
  lesson("A1", "a1-gr-en-y-pronom-tonique", "G4.26", "En ou de + pronom tonique / Y ou à + pronom tonique", "Chose → en/y ; personne → de/à + tonique ; place avec pronominaux.", "grammaire"),
  lesson("A1", "a1-gr-doubles-pronoms", "G4.27", "Les doubles pronoms", "Ordre me/te/nous/vous + le/la/les ; le/la/les + lui/leur ; + en/y.", "grammaire"),
  lesson("A1", "a1-gr-pronoms-demonstratifs", "G4.28", "Les pronoms démonstratifs", "Celui/celle/ceux/celles ; ce, cela, ça.", "grammaire"),
  lesson("A1", "a1-gr-pronoms-possessifs", "G4.29", "Les pronoms possessifs", "Le mien, le tien, le sien, le nôtre, le vôtre, le leur…", "grammaire"),
  lesson("A1", "a1-gr-pronoms-indefinis", "G4.30", "Les pronoms indéfinis", "Tout, chacun, quelques-uns, plusieurs, aucun…", "grammaire"),
  lesson("A1", "a1-gr-pronoms-relatifs-qui-que-ou", "G4.31", "Les pronoms relatifs qui, que, où", "Sujet, COD, lieu ou temps : réunir deux phrases.", "grammaire"),
  lesson("A1", "a1-gr-pronom-relatif-dont", "G4.32", "Le pronom relatif dont", "Remplacer un complément introduit par de.", "grammaire"),
  lesson("A1", "a1-gr-pronoms-relatifs-composes", "G4.33", "Les pronoms relatifs composés", "Lequel / laquelle… ; auquel, duquel ; dont vs duquel.", "grammaire"),
  lesson("A1", "a1-gr-adverbes-intensite", "G4.34", "Les adverbes d'intensité", "Très, beaucoup, trop, assez… : emploi et place.", "grammaire"),
  lesson("A1", "a1-gr-adverbes-ment", "G4.35", "Les adverbes en -ment", "Formation (féminin, -amment/-emment) et place.", "grammaire"),
  lesson("A1", "a1-gr-mots-liaison", "G4.36", "Les mots de liaison", "D'abord, puis, de plus, donc… : organiser le discours.", "grammaire"),
  lesson("A1", "a1-gr-imperatif", "G4.37", "L'impératif", "Ordre, conseil, souhait ; pronoms à l'affirmatif et au négatif.", "grammaire"),
  lesson("A1", "a1-gr-forme-passive", "G4.38", "La forme passive", "Être + participe ; agent avec par ; accord du participe.", "grammaire"),
  lesson("A1", "a1-gr-gerondif", "G4.39", "Le gérondif", "En + participe présent : temps, manière, condition ; négation.", "grammaire"),
  lesson("A1", "a1-gr-subjonctif-present", "G4.40", "Le subjonctif présent", "Formation, irréguliers et emplois après que (nécessité, sentiment…).", "grammaire"),
  lesson("A1", "a1-gr-subjonctif-passe", "G4.41", "Le subjonctif passé", "Auxiliaire au subjonctif présent + participe ; action antérieure.", "grammaire"),
  lesson("A1", "a1-gr-subjonctif-ou-indicatif", "G4.42", "Subjonctif ou indicatif ?", "Réalité vs appréciation ; opinion affirmative/négative/interrogative.", "grammaire"),
  lesson("A1", "a1-gr-subjonctif-ou-infinitif", "G4.43", "Subjonctif ou infinitif ?", "Sujets différents → subjonctif ; même sujet → infinitif (présent/passé).", "grammaire"),
  lesson("A1", "a1-gr-expression-consequence", "G4.44", "L'expression de la conséquence", "Donc, alors, si bien que, tellement/si… que : résultat certain.", "grammaire"),
  lesson("A1", "a1-gr-conjonctions-temps", "G4.45", "Les conjonctions de temps", "Quand, avant que, dès que, jusqu'à ce que… : situer deux événements.", "grammaire"),
  lesson("A1", "a1-gr-expression-but", "G4.46", "L'expression du but", "Pour/afin de + infinitif ; pour que/afin que + subjonctif.", "grammaire"),
  lesson("A1", "a1-gr-opposition-concession", "G4.47", "L'expression de l'opposition et de la concession", "Mais, pourtant, bien que, même si, malgré…", "grammaire"),
  lesson("A1", "a1-gr-hypothese-condition", "G4.48", "L'expression de l'hypothèse avec si et de la condition", "Si + temps ; à condition que / de.", "grammaire"),
  lesson("A1", "a1-gr-discours-indirect-present", "G4.49", "Le discours indirect au présent", "Dire que, demander si/de : rapporter des paroles.", "grammaire"),
  lesson("A1", "a1-gr-l03", "G4.50", "Le genre des noms et des adjectifs", "Masculin/féminin : noms courants et adjectifs de nationalité.", "grammaire"),
  lesson("A1", "a1-gr-phrases", "G4.51", "Les phrases", "Structure Sujet + Verbe + Complément : reconnaître et construire une phrase simple.", "grammaire"),
  lesson("A1", "a1-gr-l02", "G4.52", "La négation", "Ne…pas : construire une phrase négative avec être et avoir.", "grammaire"),
  lesson("A1", "a1-gr-interro", "G4.53", "L'interrogation de base", "Est-ce que et l'intonation montante : construire une question simple.", "grammaire"),
  lesson("A1", "a1-gr-l10", "G4.54", "Les questions ouvertes", "Qui, quoi, où, quand, comment, pourquoi, combien + est-ce que.", "grammaire"),
  lesson("A1", "a1-gr-l11", "G4.55", "Les prépositions de lieu", "Dans, sur, sous, devant, derrière, à côté de, en face de…", "grammaire"),
  lesson("A1", "a1-gr-l14", "G4.56", "Les adjectifs partitifs", "Du, de la, de l', des + un kilo de, beaucoup de, un peu de…", "grammaire"),
  lesson("A1", "a1-gr-l23", "G4.57", "Les adjectifs qualificatifs", "Genre, nombre et place de l'adjectif dans la phrase.", "grammaire"),
  lesson("A2", "a2-gr-l07", "G4.58", "Les questions fermées", "Intonation montante, est-ce que, inversion sujet-verbe (registre formel/informel).", "grammaire"),
  lesson("A2", "a2-gr-l09", "G4.59", "Répondre aux questions fermées", "Oui, non, si ; moi aussi / moi non plus / moi si : nuancer les réponses.", "grammaire"),
  lesson("A1", "a1-gr-expressions-temps", "G4.60", "Les expressions de temps", "Aujourd'hui, demain, après-demain, la semaine prochaine…", "grammaire"),
  lesson("A1", "a1-gr-l22", "G4.61", "Les adverbes de fréquence", "Toujours, souvent, parfois, rarement, jamais : situer une action dans le temps.", "grammaire"),
  lesson("A2", "a2-gr-l39", "G4.62", "Le comparatif", "Comparer des adjectifs, adverbes, verbes et noms avec plus, aussi, autant ou moins.", "grammaire"),
  lesson("A2", "a2-gr-bon-bien-meilleur-mieux", "G4.63", "Bon ou bien, meilleur ou mieux ?", "Adjectif, adverbe et formes irrégulières du comparatif et du superlatif.", "grammaire"),
  lesson("A2", "a2-gr-superlatif", "G4.64", "Le superlatif", "Le, la ou les plus et moins ; le meilleur, le mieux et le pire.", "grammaire"),
  lesson("A2", "a2-gr-l42", "G4.65", "La négation (2/2)", "Ne…jamais, ne…rien, ne…personne ; rien et personne comme sujets.", "grammaire"),
  lesson("A2", "a2-gr-l19", "G4.66", "Les pronoms relatifs qui et que", "Qui = sujet du verbe relatif ; que = objet du verbe relatif ; relative avec où.", "grammaire"),
  lesson("A2", "a2-gr-l35", "G4.67", "Les pronoms COD et COI", "Me/te/le/la/les/lui/leur : place, négation, construction avec deux verbes.", "grammaire"),
  lesson("A2", "a2-gr-l36", "G4.68", "Les pronoms Y et EN", "Y = à + lieu/chose ; EN = de + nom / partitif : place et emploi.", "grammaire"),
  lesson("A2", "gr-marqueurs-temps-complet", "G4.69", "Les marqueurs de temps", "Présent, passé, futur : depuis, il y a, pendant, dans, pour, hier, demain, la veille…", "grammaire"),
  lesson("A2", "a2-gr-l52", "G4.70", "Les relations logiques — Cause et conséquence", "Parce que, car, comme, à cause de, grâce à, donc, c'est pourquoi et par conséquent.", "grammaire"),
  lesson("A2", "a2-gr-adverbes-types", "G4.71", "Les adverbes", "Adverbes de lieu, de temps, de manière et l'adverbe tout.", "grammaire"),
  lesson("A1", "a1-gr-verbes-double-auxiliaire", "G4.72", "Les verbes à double auxiliaire", "Sortir, rentrer, entrer, passer, monter, descendre et retourner : être ou avoir.", "grammaire"),
  lesson("A1", "a1-gr-pronominaux-passe-compose", "G4.73", "Les verbes pronominaux au passé composé", "Auxiliaire être, accord avec le sujet réel et négation.", "grammaire"),
  lesson("A2", "a2-gr-passe-compose-ou-imparfait", "G4.74", "Passé composé ou imparfait ?", "Événement ponctuel, habitude, description, contexte et simultanéité.", "grammaire"),
  lesson("A2", "a2-gr-imparfait-irreguliers", "G4.75", "Les verbes irréguliers à l'imparfait", "Être et les bases particulières des verbes fréquents.", "grammaire"),
  lesson("A2", "a2-gr-futur-irreguliers", "G4.76", "Les verbes irréguliers au futur simple", "Les quinze bases irrégulières essentielles.", "grammaire"),
  lesson("A2", "a2-gr-futur-simple-ou-proche", "G4.77", "Futur simple ou futur proche ?", "Choisir selon la proximité, l'intention, la promesse ou la prévision.", "grammaire"),
  lesson("A2", "a2-gr-hypothese-futur", "G4.78", "L'hypothèse sur le futur", "Si + présent, puis futur simple ; condition, conséquence et élision avec il.", "grammaire"),
  lesson("A2", "a2-gr-conditionnel", "G4.79", "Le conditionnel", "Conditionnel présent et passé ; phrases hypothétiques avec si.", "grammaire"),
  lesson("A2", "a2-gr-gerondif", "G4.80", "Le gérondif", "En + participe présent : simultanéité, manière, condition et cause.", "grammaire"),
  lesson("A2", "a2-gr-subjonctif", "G4.81", "Le subjonctif", "Formation, irréguliers et emplois : vouloir que, il faut que, bien que…", "grammaire"),
...
const REORGANIZED_GRAMMAR_CODES: Record<string, string> = {
  ...
  "a1-gr-expression-consequence": "G4.44",
  "a1-gr-conjonctions-temps": "G4.45",
  "a1-gr-expression-but": "G4.46",
  "a1-gr-opposition-concession": "G4.47",
  "a1-gr-hypothese-condition": "G4.48",
  "a1-gr-discours-indirect-present": "G4.49",
  "a1-gr-l03": "G4.50",
  "a1-gr-phrases": "G4.51",
  "a1-gr-l02": "G4.52",
  "a1-gr-interro": "G4.53",
  ...
  "a2-gr-l07": "G4.58",
  "a2-gr-l09": "G4.59",
  "a1-gr-expressions-temps": "G4.60",
  "a1-gr-l22": "G4.61",
  "a2-gr-l39": "G4.62",
  "a2-gr-bon-bien-meilleur-mieux": "G4.63",
  "a2-gr-superlatif": "G4.64",
  "a2-gr-l42": "G4.65",
  "a2-gr-l19": "G4.66",
  "a2-gr-l35": "G4.67",
  "a2-gr-l36": "G4.68",
  "gr-marqueurs-temps-complet": "G4.69",
  "a2-gr-l52": "G4.70",
  "a2-gr-adverbes-types": "G4.71",
  "a1-gr-verbes-double-auxiliaire": "G4.72",
  "a1-gr-pronominaux-passe-compose": "G4.73",
  "a2-gr-passe-compose-ou-imparfait": "G4.74",
  "a2-gr-imparfait-irreguliers": "G4.75",
  "a2-gr-futur-irreguliers": "G4.76",
  "a2-gr-futur-simple-ou-proche": "G4.77",
  "a2-gr-hypothese-futur": "G4.78",
  "a2-gr-conditionnel": "G4.79",
  "a2-gr-gerondif": "G4.80",
  "a2-gr-subjonctif": "G4.81",
