...
const BASE_FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-interro", "G5.2", "L'interrogation de base", "Est-ce que et l'intonation montante : construire une question simple.", "grammaire"),
  lesson("A1", "a1-gr-question-totale", "G5.3", "Les questions fermées", "Intonation, est-ce que, inversion ; répondre oui / non / si.", "grammaire"),
  lesson("A1", "a1-gr-question-ouverte-qui", "G5.4", "Les questions ouvertes", "Qui, quoi, où, quand, comment, pourquoi, combien, quel / lequel.", "grammaire"),
  lesson("A1", "a1-gr-negation-ne-pas", "G5.5", "La négation", "Ne… pas et formes de base de la négation.", "grammaire"),
  lesson("A1", "a1-gr-autres-negations", "G5.6", "Les autres négations", "Jamais, plus, rien, personne, ne… que, ni… ni.", "grammaire"),
  ...
  lesson("A1", "a1-gr-pronoms-cod-coi", "G12.2", "Les pronoms COD et COI", "Me/te/le/la/les/lui/leur : place, négation, construction avec deux verbes.", "grammaire"),
