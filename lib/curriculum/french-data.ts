...
const BASE_FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-l04", "G2.9", "Les articles définis et indéfinis", "Le, la, l', les / un, une, des : choisir le bon article selon le contexte.", "grammaire"),
  lesson("A1", "a1-gr-l03", "G2.10", "Le genre des noms et des adjectifs", "Masculin/féminin : noms courants et adjectifs de nationalité.", "grammaire"),
  // ── G3 — Chapitre 3 — Unités 21–30 ──
  lesson("A1", "a1-gr-phrases", "G3.1", "Les phrases", "Structure Sujet + Verbe + Complément : reconnaître et construire une phrase simple.", "grammaire"),
  lesson("A1", "a1-gr-l02", "G3.2", "La négation", "Ne…pas : construire une phrase négative avec être et avoir.", "grammaire"),
  lesson("A1", "a1-gr-interro", "G3.3", "L'interrogation de base", "Est-ce que et l'intonation montante : construire une question simple.", "grammaire"),
  lesson("A1", "a1-gr-l10", "G3.4", "Les questions ouvertes", "Qui, quoi, où, quand, comment, pourquoi, combien + est-ce que.", "grammaire"),
  lesson("A1", "a1-gr-l19", "G3.5", "Les adjectifs possessifs", "Mon/ma/mes, ton/ta/tes, son/sa/ses… : exprimer l'appartenance.", "grammaire"),
  lesson("A1", "a1-gr-l18", "G3.6", "Les adjectifs démonstratifs", "Ce, cet, cette, ces : désigner et montrer quelque chose.", "grammaire"),
  lesson("A1", "a1-gr-l11", "G3.7", "Les prépositions de lieu", "Dans, sur, sous, devant, derrière, à côté de, en face de…", "grammaire"),
  lesson("A1", "a1-gr-l14", "G3.8", "Les adjectifs partitifs", "Du, de la, de l', des + un kilo de, beaucoup de, un peu de…", "grammaire"),
  lesson("A1", "a1-gr-l23", "G3.9", "Les adjectifs qualificatifs", "Genre, nombre et place de l'adjectif dans la phrase.", "grammaire"),
  lesson("A2", "a2-gr-l07", "G3.10", "Les questions fermées", "Intonation montante, est-ce que, inversion sujet-verbe (registre formel/informel).", "grammaire"),
  // ── G4 — Chapitre 4 — Unités 31–53 ──
  lesson("A2", "a2-gr-l09", "G4.1", "Répondre aux questions fermées", "Oui, non, si ; moi aussi / moi non plus / moi si : nuancer les réponses.", "grammaire"),
  lesson("A1", "a1-gr-expressions-temps", "G4.2", "Les expressions de temps", "Aujourd'hui, demain, après-demain, la semaine prochaine…", "grammaire"),
  lesson("A1", "a1-gr-l22", "G4.3", "Les adverbes de fréquence", "Toujours, souvent, parfois, rarement, jamais : situer une action dans le temps.", "grammaire"),
  lesson("A2", "a2-gr-l39", "G4.4", "Le comparatif", "Comparer des adjectifs, adverbes, verbes et noms avec plus, aussi, autant ou moins.", "grammaire"),
  lesson("A2", "a2-gr-bon-bien-meilleur-mieux", "G4.5", "Bon ou bien, meilleur ou mieux ?", "Adjectif, adverbe et formes irrégulières du comparatif et du superlatif.", "grammaire"),
  lesson("A2", "a2-gr-superlatif", "G4.6", "Le superlatif", "Le, la ou les plus et moins ; le meilleur, le mieux et le pire.", "grammaire"),
  lesson("A2", "a2-gr-l42", "G4.7", "La négation (2/2)", "Ne…jamais, ne…rien, ne…personne ; rien et personne comme sujets.", "grammaire"),
  lesson("A2", "a2-gr-l19", "G4.8", "Les pronoms relatifs qui et que", "Qui = sujet du verbe relatif ; que = objet du verbe relatif ; relative avec où.", "grammaire"),
  lesson("A2", "a2-gr-l35", "G4.9", "Les pronoms COD et COI", "Me/te/le/la/les/lui/leur : place, négation, construction avec deux verbes.", "grammaire"),
  lesson("A2", "a2-gr-l36", "G4.10", "Les pronoms Y et EN", "Y = à + lieu/chose ; EN = de + nom / partitif : place et emploi.", "grammaire"),
  lesson("A2", "gr-marqueurs-temps-complet", "G4.11", "Les marqueurs de temps", "Présent, passé, futur : depuis, il y a, pendant, dans, pour, hier, demain, la veille…", "grammaire"),
  lesson("A2", "a2-gr-l52", "G4.12", "Les relations logiques — Cause et conséquence", "Parce que, car, comme, à cause de, grâce à, donc, c'est pourquoi et par conséquent.", "grammaire"),
  lesson("A2", "a2-gr-adverbes-types", "G4.13", "Les adverbes", "Adverbes de lieu, de temps, de manière et l'adverbe tout.", "grammaire"),
  lesson("A1", "a1-gr-verbes-double-auxiliaire", "G4.14", "Les verbes à double auxiliaire", "Sortir, rentrer, entrer, passer, monter, descendre et retourner : être ou avoir.", "grammaire"),
  lesson("A1", "a1-gr-pronominaux-passe-compose", "G4.15", "Les verbes pronominaux au passé composé", "Auxiliaire être, accord avec le sujet réel et négation.", "grammaire"),
  lesson("A2", "a2-gr-passe-compose-ou-imparfait", "G4.16", "Passé composé ou imparfait ?", "Événement ponctuel, habitude, description, contexte et simultanéité.", "grammaire"),
  lesson("A2", "a2-gr-imparfait-irreguliers", "G4.17", "Les verbes irréguliers à l'imparfait", "Être et les bases particulières des verbes fréquents.", "grammaire"),
  lesson("A2", "a2-gr-futur-irreguliers", "G4.18", "Les verbes irréguliers au futur simple", "Les quinze bases irrégulières essentielles.", "grammaire"),
  lesson("A2", "a2-gr-futur-simple-ou-proche", "G4.19", "Futur simple ou futur proche ?", "Choisir selon la proximité, l'intention, la promesse ou la prévision.", "grammaire"),
  lesson("A2", "a2-gr-hypothese-futur", "G4.20", "L'hypothèse sur le futur", "Si + présent, puis futur simple ; condition, conséquence et élision avec il.", "grammaire"),
  lesson("A2", "a2-gr-conditionnel", "G4.21", "Le conditionnel", "Conditionnel présent et passé ; phrases hypothétiques avec si.", "grammaire"),
  lesson("A2", "a2-gr-gerondif", "G4.22", "Le gérondif", "En + participe présent : simultanéité, manière, condition et cause.", "grammaire"),
  lesson("A2", "a2-gr-subjonctif", "G4.23", "Le subjonctif", "Formation, irréguliers et emplois : vouloir que, il faut que, bien que…", "grammaire"),
...
const REORGANIZED_GRAMMAR_CODES: Record<string, string> = {
  ...
  // G4 — Chapitre 4 (unités 31–53)
  "a2-gr-l09": "G4.1",
  "a1-gr-expressions-temps": "G4.2",
  "a1-gr-l22": "G4.3",
  "a2-gr-l39": "G4.4",
  "a2-gr-bon-bien-meilleur-mieux": "G4.5",
  "a2-gr-superlatif": "G4.6",
  "a2-gr-l42": "G4.7",
  "a2-gr-l19": "G4.8",
  "a2-gr-l35": "G4.9",
  "a2-gr-l36": "G4.10",
  "gr-marqueurs-temps-complet": "G4.11",
  "a2-gr-l52": "G4.12",
  "a2-gr-adverbes-types": "G4.13",
  "a1-gr-verbes-double-auxiliaire": "G4.14",
  "a1-gr-pronominaux-passe-compose": "G4.15",
  "a2-gr-passe-compose-ou-imparfait": "G4.16",
  "a2-gr-imparfait-irreguliers": "G4.17",
  "a2-gr-futur-irreguliers": "G4.18",
  "a2-gr-futur-simple-ou-proche": "G4.19",
  "a2-gr-hypothese-futur": "G4.20",
  "a2-gr-conditionnel": "G4.21",
  "a2-gr-gerondif": "G4.22",
  "a2-gr-subjonctif": "G4.23",
