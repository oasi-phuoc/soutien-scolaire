...
export const FRENCH_THEMES: FrenchTheme[] = [
  ...
  // ── G1 — Fondamentaux A1 (G1.1–G1.9) ───────────────────────────────────────
  lesson("A1", "a1-conj-l00", "G1.1", "Les pronoms personnels sujets",               "Je, tu, il, elle, on, nous, vous, ils, elles — choisir et utiliser le bon pronom.",     "conjugaison"),
  lesson("A1", "a1-conj-l01", "G1.2", "Les verbes être et avoir",                    "Conjugaison complète de être et avoir au présent + expressions courantes.",              "conjugaison"),
  lesson("A1", "a1-gr-l04",   "G1.3", "Les articles définis et indéfinis",           "Le, la, l', les / un, une, des : choisir le bon article selon le contexte.",            "grammaire"),
  lesson("A1", "a1-gr-l03",   "G1.4", "Le genre des noms et des adjectifs",          "Masculin/féminin : noms courants et adjectifs de nationalité.",                         "grammaire"),
  lesson("A1", "a1-conj-l07", "G1.5", "Les verbes en -er au présent",                "Conjuguer les verbes du 1er groupe : parler, aimer, habiter, travailler…",              "conjugaison"),
  lesson("A1", "a1-gr-phrases", "G1.6", "Les phrases",                               "Structure Sujet + Verbe + Complément : reconnaître et construire une phrase simple.",     "grammaire"),
  lesson("A1", "a1-gr-l02",   "G1.7", "La négation",                                 "Ne…pas : construire une phrase négative avec être et avoir.",                           "grammaire"),
  lesson("A1", "a1-gr-interro", "G1.8", "L'interrogation de base",                   "Est-ce que et l'intonation montante : construire une question simple.",                  "grammaire"),
  lesson("A1", "a1-gr-cest-il-est", "G1.9", "C'est ou il est ?",                     "Distinguer c'est + nom/pronom de il est/elle est + adjectif ou profession.",            "grammaire"),

  // ── G2 — Verbes essentiels A1 (G2.1–G2.5) ───────────────────────────────────
  lesson("A1", "a1-conj-l08", "G2.1", "Les verbes de mouvement",                     "Aller, venir, partir, arriver, entrer, sortir, monter, descendre, marcher, courir au présent.", "conjugaison"),
  lesson("A1", "a1-conj-l09", "G2.2", "Les verbes pronominaux",                      "Se lever, se coucher, s'appeler : les pronominaux du quotidien.",                        "conjugaison"),
  lesson("A1", "a1-conj-l15", "G2.3", "Les verbes modaux",                           "Les verbes modaux : conjugaison et emploi au présent.",                                  "conjugaison"),
  lesson("A1", "a1-gr-l10",   "G2.4", "Les mots interrogatifs",                      "Qui, quoi, où, quand, comment, pourquoi, combien + est-ce que.",                        "grammaire"),
  lesson("A1", "a1-gr-l11",   "G2.5", "Les prépositions de lieu",                    "Dans, sur, sous, devant, derrière, à côté de, en face de…",                            "grammaire"),

  // ── G3 — Articles et adjectifs A1 (G3.1–G3.7) ───────────────────────────────
  lesson("A1", "a1-gr-l14",   "G3.1", "Les articles partitifs et la quantité",       "Du, de la, de l', des + un kilo de, beaucoup de, un peu de…",                          "grammaire"),
  lesson("A1", "a1-gr-l05",   "G3.2", "Le verbe avoir et les adjectifs possessifs",  "J'ai, tu as… + mon, ma, mes / ton, ta, tes / son, sa, ses…",                           "grammaire"),
  lesson("A1", "a1-gr-l17",   "G3.3", "Il y a et les prépositions dans la maison",   "Il y a / il n'y a pas de + localiser les meubles et les pièces.",                      "grammaire"),
  lesson("A1", "a1-gr-l18",   "G3.4", "Les adjectifs démonstratifs",                 "Ce, cet, cette, ces : désigner et montrer quelque chose.",                              "grammaire"),
  lesson("A1", "a1-gr-l19",   "G3.5", "Les adjectifs possessifs",                    "Mon/ma/mes, ton/ta/tes, son/sa/ses… : exprimer l'appartenance.",                        "grammaire"),
  lesson("A1", "a1-gr-l22",   "G3.6", "La fréquence",                                "Toujours, souvent, parfois, rarement, jamais : situer une action dans le temps.",      "grammaire"),
  lesson("A1", "a1-gr-l23",   "G3.7", "Les adjectifs qualificatifs",                 "Genre, nombre et place de l'adjectif dans la phrase.",                                  "grammaire"),

  // ── G4 — Temps et structures A1/A2 (G4.1–G4.28) ────────────────────────────
  lesson("A1", "a1-conj-l20", "G4.1",  "Le futur proche",                             "Aller + infinitif : parler de ce qui va arriver bientôt.",                               "conjugaison"),
  lesson("A1", "a1-conj-l27", "G4.2",  "Pronominaux réfléchis et réciproques",        "Se laver, se regarder, se parler, s'écrire : formes et sens.",                           "conjugaison"),
  lesson("A1", "a1-conj-l28", "G4.3",  "Passé récent et présent continu",             "Venir de + infinitif (ce qui vient de se passer) ; être en train de + infinitif.",       "conjugaison"),
  lesson("A1", "a1-conj-l29", "G4.4",  "Passé composé avec avoir",                   "Participes passés réguliers (-é/-i) et irréguliers (fait, dit, pris…).",                 "conjugaison"),
  lesson("A1", "a1-conj-l30", "G4.5",  "Passé composé avec être",                    "17 verbes (aller, venir, partir…) + accord du participe passé avec le sujet.",           "conjugaison"),
  lesson("A1", "a1ConjL31",   "G4.6",  "Négation au passé composé",                  "Ne…pas, jamais, plus, rien : encadrer l'auxiliaire et placer les mots négatifs.",         "conjugaison"),
  lesson("A1", "a1-gr-l24",   "G4.7",  "Le comparatif et le superlatif",              "Plus…que, moins…que, aussi…que + le plus / le moins.",                                  "grammaire"),
  lesson("A1", "a1-gr-l25",   "G4.8",  "Savoir ou connaître ?",                       "Distinguer les deux verbes : savoir + infinitif vs connaître + nom.",                   "grammaire"),
  lesson("A2", "a2-conj-l01", "G4.9",  "Les verbes en -er — révision et particularités",  "Verbes en -ger/-cer, deux bases (préférer, acheter, appeler) ; élision et liaisons.",     "conjugaison"),
  lesson("A2", "a2-conj-l02", "G4.10", "Les verbes en -ir (2e et 3e groupes)",             "Finir/choisir (2e groupe) vs partir/venir/ouvrir (3e groupe) : formes et différences.",   "conjugaison"),
  lesson("A2", "a2-conj-l03", "G4.11", "Les verbes irréguliers courants",                  "Avoir, être, faire, aller, vouloir, pouvoir, devoir, sortir, boire, croire, connaître…",  "conjugaison"),
  lesson("A2", "a2-gr-l07",   "G4.12", "L'interrogation (questions fermées)",              "Intonation montante, est-ce que, inversion sujet-verbe (registre formel/informel).",       "grammaire"),
  ...
  lesson("A2", "a2-conj-l04", "G4.14", "Le conditionnel de politesse",                    "Vouloir, pouvoir, aimer, souhaiter, devoir, falloir au conditionnel : formes et emplois.", "conjugaison"),
  lesson("A2", "a2-conj-l05", "G4.15", "L'impératif",                                     "Conjugaison tu/nous/vous ; irréguliers être/avoir/aller ; impératif avec pronoms COD/COI.","conjugaison"),
  lesson("A2", "a2-gr-l18",   "G4.16", "Les prépositions de lieu",                        "Dans, sur, sous, à côté de, près de, loin de, en face de, entre, derrière, devant.",      "grammaire"),
  lesson("A2", "a2-gr-l11",   "G4.17", "Les adjectifs — généralités",                     "Genre, nombre, accord des adjectifs qualificatifs en contexte.",                           "grammaire"),
  lesson("A2", "a2-gr-l12",   "G4.18", "Les adjectifs — cas particuliers et place",       "Nouveau/beau/vieux, adjectifs invariables, place avant ou après le nom.",                  "grammaire"),
  lesson("A2", "a2-gr-l19",   "G4.19", "Les pronoms relatifs qui et que",                 "Qui = sujet du verbe relatif ; que = objet du verbe relatif ; relative avec où.",          "grammaire"),
  lesson("A2", "a2-gr-l25",   "G4.20", "La négation — ne…pas, ne…plus, ne…que",          "Ne…pas (action absente), ne…plus (arrêt), ne…que (restriction) : formes et sens.",         "grammaire"),
  lesson("A2", "a2-gr-l42",   "G4.21", "La négation — ne…jamais, ne…rien, ne…personne",  "Négation totale : formes, place, emploi comme sujet (rien/personne).",                     "grammaire"),
  lesson("A2", "a2-gr-l35",   "G4.22", "Les pronoms COD et COI",                          "Me/te/le/la/les/lui/leur : place, négation, construction avec deux verbes.",                "grammaire"),
  lesson("A2", "a2-gr-l36",   "G4.23", "Les pronoms Y et EN",                             "Y = à + lieu/chose ; EN = de + nom / partitif : place et emploi.",                         "grammaire"),
  lesson("A2", "a2-conj-l06", "G4.24", "Le passé composé — avoir et être",               "Révision complète : participes, double auxiliaire, verbes pronominaux au PC.",              "conjugaison"),
  lesson("A2", "a2-conj-l07", "G4.25", "L'imparfait",                                     "Formation (base nous + -ais…), emploi (habitude, description) vs passé composé.",          "conjugaison"),
  lesson("A2", "a2-conj-l08", "G4.26", "Le futur simple",                                 "Formation régulière et irrégulière + hypothèse si + présent → futur simple.",              "conjugaison"),
  lesson("A2", "a2-gr-l39",   "G4.27", "Le comparatif",                                   "Plus/aussi/moins + adjectif/adverbe/verbe/nom + que : formes régulières.",                 "grammaire"),
  lesson("A2", "a2-gr-l52",   "G4.28", "La cause et la conséquence",                      "Parce que/car/comme/à cause de/grâce à ; donc/c'est pourquoi/par conséquent.",            "grammaire"),
