...
export const FRENCH_THEMES: FrenchTheme[] = [
  ...
  lesson("A1", "a1-gr-l01", "G.1",  "Pronoms sujets et le verbe être",             "Je suis, tu es, il/elle est… : bases de l'identification et de la présentation.",     "grammaire"),
  lesson("A1", "a1-gr-l02", "G.2",  "La négation et l'interrogation de base",      "Ne…pas et est-ce que : construire une phrase négative et une question simple.",        "grammaire"),
  lesson("A1", "a1-gr-l03", "G.3",  "Le genre des noms et des adjectifs",          "Masculin/féminin : noms courants et adjectifs de nationalité.",                        "grammaire"),
  lesson("A1", "a1-gr-l04", "G.4",  "Les articles définis et indéfinis",           "Le, la, l', les / un, une, des : choisir le bon article selon le contexte.",           "grammaire"),
  lesson("A1", "a1-gr-l05", "G.5",  "Le verbe avoir et les adjectifs possessifs",  "J'ai, tu as… + mon, ma, mes / ton, ta, tes / son, sa, ses…",                          "grammaire"),
  lesson("A1", "a1-gr-l06", "G.6",  "Être et avoir — révision et approfondissement","Consolider les deux verbes essentiels dans des contextes variés.",                    "grammaire"),
  lesson("A1", "a1-gr-l10", "G.7",  "L'interrogation avec les mots interrogatifs", "Qui, quoi, où, quand, comment, pourquoi, combien + est-ce que.",                       "grammaire"),
  lesson("A1", "a1-gr-l11", "G.8",  "Les prépositions de lieu",                    "Dans, sur, sous, devant, derrière, à côté de, en face de…",                           "grammaire"),
  lesson("A1", "a1-gr-l14", "G.9",  "Les articles partitifs et la quantité",       "Du, de la, de l', des + un kilo de, beaucoup de, un peu de…",                         "grammaire"),
  lesson("A1", "a1-gr-l17", "G.10", "Il y a et les prépositions dans la maison",   "Il y a / il n'y a pas de + localiser les meubles et les pièces.",                     "grammaire"),
  lesson("A1", "a1-gr-l18", "G.11", "Les adjectifs démonstratifs",                 "Ce, cet, cette, ces : désigner et montrer quelque chose.",                             "grammaire"),
  lesson("A1", "a1-gr-l19", "G.12", "Les adjectifs possessifs",                    "Mon/ma/mes, ton/ta/tes, son/sa/ses… : exprimer l'appartenance.",                       "grammaire"),
  lesson("A1", "a1-gr-l22", "G.13", "La fréquence",                                "Toujours, souvent, parfois, rarement, jamais : situer une action dans le temps.",     "grammaire"),
  lesson("A1", "a1-gr-l23", "G.14", "Les adjectifs qualificatifs",                 "Genre, nombre et place de l'adjectif dans la phrase.",                                 "grammaire"),
  ...
  lesson("A1", "a1-conj-l00", "C.1",  "Les pronoms personnels sujets",          "Je, tu, il, elle, on, nous, vous, ils, elles — choisir et utiliser le bon pronom.",     "conjugaison"),
  lesson("A1", "a1-conj-l01", "C.2",  "Les verbes être et avoir",               "Conjugaison complète de être et avoir au présent + expressions courantes.",              "conjugaison"),
  lesson("A1", "a1-conj-l07", "C.3",  "Les verbes en -er au présent",           "Conjuguer les verbes du 1er groupe : parler, aimer, habiter, travailler…",              "conjugaison"),
  lesson("A1", "a1-conj-l08", "C.4",  "Les verbes aller et venir",              "Conjuguer aller et venir au présent + prépositions de lieu (à, au, aux, en).",           "conjugaison"),
  lesson("A1", "a1-conj-l09", "C.5",  "Les verbes pronominaux",                 "Se lever, se coucher, s'appeler : les pronominaux du quotidien.",                        "conjugaison"),
  lesson("A1", "a1-conj-l12", "C.6",  "Les verbes de mouvement",                "Partir, arriver, entrer, sortir, monter, descendre au présent.",                         "conjugaison"),
  lesson("A1", "a1-conj-l15", "C.7",  "Vouloir, pouvoir, devoir",               "Les trois verbes modaux essentiels : conjugaison et emploi au présent.",                  "conjugaison"),
  lesson("A1", "a1-conj-l20", "C.8",  "Le futur proche",                        "Aller + infinitif : parler de ce qui va arriver bientôt.",                               "conjugaison"),
  lesson("A1", "a1-conj-l27", "C.9",  "Pronominaux réfléchis et réciproques",   "Se laver, se regarder, se parler, s'écrire : formes et sens.",                           "conjugaison"),
  lesson("A1", "a1-conj-l28", "C.10", "Passé récent et présent continu",        "Venir de + infinitif (ce qui vient de se passer) ; être en train de + infinitif.",       "conjugaison"),
  lesson("A1", "a1-conj-l29", "C.11", "Passé composé avec avoir",               "Participes passés réguliers (-é/-i) et irréguliers (fait, dit, pris…).",                 "conjugaison"),
  lesson("A1", "a1-conj-l30", "C.12", "Passé composé avec être",                "17 verbes (aller, venir, partir…) + accord du participe passé avec le sujet.",           "conjugaison"),

  // ── A2 — Grammaire au quotidien A2 — Conjugaison ─────────────────────────
  lesson("A2", "a2-conj-l01", "C.13", "Les verbes en -er — révision et particularités",   "Verbes en -ger/-cer, deux bases (préférer, acheter, appeler) ; élision et liaisons.",    "conjugaison"),
  lesson("A2", "a2-conj-l02", "C.14", "Les verbes en -ir (2e et 3e groupes)",              "Finir/choisir (2e groupe) vs partir/venir/ouvrir (3e groupe) : formes et différences.",  "conjugaison"),
  lesson("A2", "a2-conj-l03", "C.15", "Les verbes irréguliers courants",                   "Avoir, être, faire, aller, vouloir, pouvoir, devoir, sortir, boire, croire, connaître…", "conjugaison"),
  lesson("A2", "a2-conj-l04", "C.16", "Le conditionnel de politesse",                      "Vouloir, pouvoir, aimer, souhaiter, devoir, falloir au conditionnel : formes et emplois.","conjugaison"),
  lesson("A2", "a2-conj-l05", "C.17", "L'impératif",                                       "Conjugaison tu/nous/vous ; irréguliers être/avoir/aller ; impératif avec pronoms COD/COI.","conjugaison"),
  lesson("A2", "a2-conj-l06", "C.18", "Le passé composé — avoir et être",                 "Révision complète : participes, double auxiliaire, verbes pronominaux au PC.",            "conjugaison"),
  lesson("A2", "a2-conj-l07", "C.19", "L'imparfait",                                       "Formation (base nous + -ais…), emploi (habitude, description) vs passé composé.",        "conjugaison"),
  lesson("A2", "a2-conj-l08", "C.20", "Le futur simple",                                   "Formation régulière et irrégulière + hypothèse si + présent → futur simple.",            "conjugaison"),
];
