...
export const MATH_MODULES: MathModule[] = [
  ...
  },
  {
    ...
    prerequisiteIds: ["A2"],
    submodules: [
      sm("A3.1", "Tables 1 à 10"),
      sm("A3.2", "Multiplication posée"),
      sm("A3.3", "Division euclidienne"),
      sm("A3.4", "Diviseurs et multiples"),
      sm("A3.5", "Critères de divisibilité"),
  ...
  },
  {
    ...
    submodules: [
      ...
      sm("A4.5", "± dénominateurs différents (PPCM)"),
      sm("A4.6", "Multiplication"),
      sm("A4.7", "Division (inverse)"),
  ...
  },
  {
    ...
    submodules: [
      ...
      sm("A6.4", "Augmentation / réduction en %"),
