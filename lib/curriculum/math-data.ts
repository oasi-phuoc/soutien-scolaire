...
export const MATH_MODULES: MathModule[] = [
  ...
  },
  {
    ...
    prerequisiteIds: ["G1"],
    submodules: [
      sm("G5.1", "Outils : règle, compas…"),
      sm("G5.2", "Perpendiculaire, parallèle"),
      sm("G5.3", "Triangles"),
      sm("G5.4", "Carré, rectangle, losange"),
      sm("G5.5", "Cercle de rayon donné"),
      sm("G5.6", "Médiatrice, bissectrice…"),
    ],
  },
  {
    id: "G6",
  ...
  },
  {
    ...
    branch: "geometry",
    comingSoon: true,
    prerequisiteIds: ["G4", "G8", "A8"],
    algebraRefs: ["A3", "A8", "A4", "A5", "G4"],
    submodules: [
      sm("G9.1", "Reconnaître les solides"),
      sm("G9.2", "Patrons"),
      sm("G9.3", "Aires latérale et totale"),
      sm("G9.4", "Volume du cube"),
      sm("G9.5", "Pavé droit"),
      sm("G9.6", "Prisme"),
      sm("G9.7", "Cylindre"),
      sm("G9.8", "Pyramide"),
      sm("G9.9", "Cône et sphère"),
      sm("G9.10", "Conversions de volumes"),
    ],
  },
  {
    id: "G10",
