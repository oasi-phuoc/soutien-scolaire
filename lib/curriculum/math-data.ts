...
export const MATH_MODULES: MathModule[] = [
  ...
  },
  {
    ...
    algebraRefs: ["A3", "A6"],
    submodules: [
      sm("G6.1", "Symétrie axiale"),
      sm("G6.2", "Symétrie centrale"),
      sm("G6.3", "Translation"),
      sm("G6.4", "Rotation"),
      sm("G6.5", "Homothétie"),
      sm("G6.6", "Isométries"),
      sm("G6.7", "Homothétie et longueurs"),
    ],
  },
  {
    id: "G7",
    ...
    submodules: [
      sm("G7.1", "Notion d'échelle"),
      sm("G7.2", "Lire une échelle"),
      sm("G7.3", "Distance réelle"),
      sm("G7.4", "Représentation"),
      sm("G7.5", "Agrandir / réduire"),
    ],
  },
  {
    id: "G8",
