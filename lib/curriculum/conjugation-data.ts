...
const a1ConjL01: ConjLesson = {
  ...
  exercises: [
    {
      type: "fill",
      title: "Exercice 5 — Être ou avoir ?",
      instruction: "Écris la bonne forme du verbe être ou avoir.",
      items: [],
      poolSize: 8,
      pool: [
        { sentence: "J'___ 25 ans.", hint: "âge → avoir : ai", answer: "ai" },
        { sentence: "Je ___ française.", hint: "nationalité → être : suis", answer: "suis" },
        { sentence: "Tu ___ froid ?", hint: "sensation → avoir : as", answer: "as" },
        { sentence: "Il ___ médecin.", hint: "profession → être : est", answer: "est" },
        { sentence: "Nous ___ faim.", hint: "sensation → avoir : avons", answer: "avons" },
        { sentence: "Elle ___ à Genève.", hint: "lieu → être : est", answer: "est" },
        { sentence: "Vous ___ raison.", hint: "expression → avoir : avez", answer: "avez" },
        { sentence: "Ils ___ algériens.", hint: "nationalité → être : sont", answer: "sont" },
        { sentence: "J'___ peur.", hint: "sensation → avoir : ai", answer: "ai" },
        { sentence: "On ___ content.", hint: "état → être : est", answer: "est" },
        { sentence: "Tu ___ étudiant(e) ?", hint: "profession → être : es", answer: "es" },
        { sentence: "Elle ___ un téléphone.", hint: "possession → avoir : a", answer: "a" },
        { sentence: "Nous ___ ukrainiens.", hint: "nationalité → être : sommes", answer: "sommes" },
        { sentence: "Il ___ soif.", hint: "sensation → avoir : a", answer: "a" },
        { sentence: "Vous ___ fatigués ?", hint: "état → être : êtes", answer: "êtes" },
        { sentence: "Elles ___ peur.", hint: "sensation → avoir : ont", answer: "ont" },
        { sentence: "Je ___ grand(e).", hint: "description → être : suis", answer: "suis" },
        { sentence: "Tu ___ 18 ans ?", hint: "âge → avoir : as", answer: "as" },
        { sentence: "Il ___ ici.", hint: "lieu → être : est", answer: "est" },
        { sentence: "Nous ___ de la chance.", hint: "expression → avoir : avons", answer: "avons" },
        { sentence: "Elle ___ congolaise.", hint: "nationalité → être : est", answer: "est" },
        { sentence: "Vous ___ un rendez-vous ?", hint: "possession → avoir : avez", answer: "avez" },
        { sentence: "Ils ___ en retard.", hint: "état → être : sont", answer: "sont" },
        { sentence: "J'___ chaud.", hint: "sensation → avoir : ai", answer: "ai" },
        { sentence: "On ___ à Paris.", hint: "lieu → être : est", answer: "est" },
        { sentence: "Tu ___ tort.", hint: "expression → avoir : as", answer: "as" },
        { sentence: "Elle ___ 30 ans.", hint: "âge → avoir : a", answer: "a" },
        { sentence: "Nous ___ prêts.", hint: "état → être : sommes", answer: "sommes" },
        { sentence: "Ils ___ faim.", hint: "sensation → avoir : ont", answer: "ont" },
        { sentence: "Je ___ belge.", hint: "nationalité → être : suis", answer: "suis" },
        { sentence: "Tu ___ soif ?", hint: "sensation → avoir : as", answer: "as" },
        { sentence: "Il ___ ingénieur.", hint: "profession → être : est", answer: "est" },
        { sentence: "Elles ___ à Lyon.", hint: "lieu → être : sont", answer: "sont" },
        { sentence: "Vous ___ chaud ?", hint: "sensation → avoir : avez", answer: "avez" },
        { sentence: "J'___ raison.", hint: "expression → avoir : ai", answer: "ai" },
        { sentence: "On ___ afghan.", hint: "nationalité → être : est", answer: "est" },
        { sentence: "Tu ___ une voiture ?", hint: "possession → avoir : as", answer: "as" },
        { sentence: "Elle ___ petite.", hint: "description → être : est", answer: "est" },
        { sentence: "Nous ___ soif.", hint: "sensation → avoir : avons", answer: "avons" },
        { sentence: "Ils ___ étudiants.", hint: "profession → être : sont", answer: "sont" },
        { sentence: "J'___ mal.", hint: "sensation → avoir : ai", answer: "ai" },
        { sentence: "Tu ___ absent(e) ?", hint: "état → être : es", answer: "es" },
        { sentence: "Il ___ 40 ans.", hint: "âge → avoir : a", answer: "a" },
        { sentence: "Nous ___ contents.", hint: "état → être : sommes", answer: "sommes" },
        { sentence: "Elle ___ peur.", hint: "sensation → avoir : a", answer: "a" },
        { sentence: "Vous ___ érythréens.", hint: "nationalité → être : êtes", answer: "êtes" },
        { sentence: "Elles ___ faim.", hint: "sensation → avoir : ont", answer: "ont" },
        { sentence: "Je ___ disponible.", hint: "état → être : suis", answer: "suis" },
        { sentence: "Tu ___ libre ?", hint: "état → être : es", answer: "es" },
        { sentence: "Il ___ une sœur.", hint: "possession → avoir : a", answer: "a" },
      ],
    },
    {
      type: "write",
      title: "Exercice 6 — Écrivez avec être",
      instruction: "Écrivez 2 phrases avec le verbe être.",
      prompts: ["Phrase 1 :", "Phrase 2 :"],
    },
    {
      type: "write",
      title: "Exercice 7 — Écrivez avec avoir",
      instruction: "Écrivez 2 phrases avec le verbe avoir.",
      prompts: ["Phrase 1 :", "Phrase 2 :"],
    },
    {
      type: "qcm",
      title: "Exercice 8 — Forme négative",
    ...
    {
      type: "fill",
      title: "Exercice 9 — Mets à la forme négative",
