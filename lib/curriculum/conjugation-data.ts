  ...
  midExercises: [
    ...
    },
    {
      ...
      pool: [
        ...
        { sentence: "Vous ___ érythréens. (être)", hint: "vous → êtes", answer: "êtes" },
        { sentence: "Elles ___ congolaises. (être)", hint: "elles → sont", answer: "sont" },
        { sentence: "Je ___ à Lyon. (être)", hint: "je → suis", answer: "suis" },
        { sentence: "On ___ froid. (avoir)", hint: "on → a", answer: "a" },
        { sentence: "Tu ___ 22 ans. (avoir)", hint: "tu → as", answer: "as" },
        { sentence: "Ils ___ peur. (avoir)", hint: "ils → ont", answer: "ont" },
        { sentence: "Elle ___ grande. (être)", hint: "elle → est", answer: "est" },
        { sentence: "Nous ___ prêts. (être)", hint: "nous → sommes", answer: "sommes" },
        { sentence: "J'___ chaud. (avoir)", hint: "j' → ai", answer: "ai" },
        { sentence: "Vous ___ raison. (avoir)", hint: "vous → avez", answer: "avez" },
        { sentence: "Ils ___ à Genève. (être)", hint: "ils → sont", answer: "sont" },
        { sentence: "Elle ___ 30 ans. (avoir)", hint: "elle → a", answer: "a" },
        { sentence: "Je ___ faim. (avoir)", hint: "j' → ai", answer: "ai" },
        { sentence: "Tu ___ à Paris. (être)", hint: "tu → es", answer: "es" },
        { sentence: "On ___ algérien. (être)", hint: "on → est", answer: "est" },
        { sentence: "Nous ___ mal. (avoir)", hint: "nous → avons", answer: "avons" },
        { sentence: "Vous ___ à l'école. (être)", hint: "vous → êtes", answer: "êtes" },
        { sentence: "Elles ___ soif. (avoir)", hint: "elles → ont", answer: "ont" },
        { sentence: "Il ___ infirmier. (être)", hint: "il → est", answer: "est" },
        { sentence: "Je ___ suisse. (être)", hint: "je → suis", answer: "suis" },
        { sentence: "Tu ___ de la chance. (avoir)", hint: "tu → as", answer: "as" },
        { sentence: "Elle ___ professeure. (être)", hint: "elle → est", answer: "est" },
        { sentence: "Ils ___ un appartement. (avoir)", hint: "ils → ont", answer: "ont" },
        { sentence: "Nous ___ contents. (être)", hint: "nous → sommes", answer: "sommes" },
        { sentence: "J'___ raison. (avoir)", hint: "j' → ai", answer: "ai" },
        { sentence: "Vous ___ fatigués. (être)", hint: "vous → êtes", answer: "êtes" },
        { sentence: "On ___ chaud. (avoir)", hint: "on → a", answer: "a" },
        { sentence: "Elles ___ françaises. (être)", hint: "elles → sont", answer: "sont" },
        { sentence: "Il ___ un frère. (avoir)", hint: "il → a", answer: "a" },
        { sentence: "Tu ___ belge ? (être)", hint: "tu → es", answer: "es" },
        { sentence: "Nous ___ une voiture. (avoir)", hint: "nous → avons", answer: "avons" },
        { sentence: "Je ___ en retard. (être)", hint: "je → suis", answer: "suis" },
        { sentence: "Elle ___ peur. (avoir)", hint: "elle → a", answer: "a" },
        { sentence: "Ils ___ étudiants. (être)", hint: "ils → sont", answer: "sont" },
        { sentence: "J'___ mal à la tête. (avoir)", hint: "j' → ai", answer: "ai" },
      ],
    },
  ],
  exercises: [
