...
const a1ConjL01: ConjLesson = {
  ...
  theory2: [
    ...
    },
    {
      ...
      rows: [
        ["ÊTRE", "Je suis fatigué.", "Je ne suis pas fatigué."],
        ["ÊTRE", "Tu es à Genève.", "Tu n'es pas à Genève."],
        ["ÊTRE", "Elle est médecin.", "Elle n'est pas médecin."],
        ["AVOIR", "J'ai un téléphone.", "Je n'ai pas de téléphone."],
        ["AVOIR", "Elle a 25 ans.", "Elle n'a pas d'enfant."],
        ["AVOIR", "Nous avons faim.", "Nous n'avons pas faim."],
      ],
      transHeaders: {
        en: ["Verb", "Affirmative", "Negative"],
        ar: ["الفعل", "المثبت", "المنفي"],
        fa: ["فعل", "مثبت", "منفی"],
        ti: ["ግሲ", "ኣወንታዊ", "ኣሉታዊ"],
        uk: ["Дієслово", "Ствердна форма", "Заперечна форма"],
      },
      transRows: {
        en: [["TO BE", "I am tired.", "I am not tired."], ["TO BE", "You are in Geneva.", "You are not in Geneva."], ["TO BE", "She is a doctor.", "She is not a doctor."], ["TO HAVE", "I have a phone.", "I don't have a phone."], ["TO HAVE", "She is 25 years old.", "She doesn't have a child."], ["TO HAVE", "We are hungry.", "We are not hungry."]],
        ar: [["يكون", "أنا متعب.", "أنا لست متعباً."], ["يكون", "أنت في جنيف.", "أنت لست في جنيف."], ["يكون", "هي طبيبة.", "هي ليست طبيبة."], ["يملك", "لدي هاتف.", "ليس لدي هاتف."], ["يملك", "عمرها 25 سنة.", "ليس لها أطفال."], ["يملك", "نحن جائعون.", "لسنا جائعين."]],
        fa: [["بودن", "من خسته‌ام.", "من خسته نیستم."], ["بودن", "تو در ژنو هستی.", "تو در ژنو نیستی."], ["بودن", "او پزشک است.", "او پزشک نیست."], ["داشتن", "من یک تلفن دارم.", "من تلفن ندارم."], ["داشتن", "او ۲۵ ساله است.", "او بچه ندارد."], ["داشتن", "ما گرسنه هستیم.", "ما گرسنه نیستیم."]],
        ti: [["ምዃን", "ኣነ ደኺመ ኣሎኹ.", "ኣነ ደኺመ ኣይኮንኩን."], ["ምዃን", "ንስኻ ኣብ ጀኔቫ ኢኻ.", "ንስኻ ኣብ ጀኔቫ ኣይኮንካን."], ["ምዃን", "ንሳ ዶክቶር እያ.", "ንሳ ዶክቶር ኣይኮነትን."], ["ምሓዝ", "ሓደ ስልኪ ኣሎኒ.", "ስልኪ የብለይን."], ["ምሓዝ", "ዕድሚኣ 25 ዓመት እዩ.", "ቆልዓ የብላን."], ["ምሓዝ", "ንሕና ጠሚና ኣሎና.", "ንሕና ኣይጠሚናን."]],
        uk: [["БУТИ", "Я втомлений.", "Я не втомлений."], ["БУТИ", "Ти у Женеві.", "Ти не у Женеві."], ["БУТИ", "Вона лікар.", "Вона не лікар."], ["МАТИ", "У мене є телефон.", "У мене немає телефону."], ["МАТИ", "Їй 25 років.", "У неї немає дитини."], ["МАТИ", "Ми голодні.", "Ми не голодні."]],
      },
    },
    {
      type: "highlight",
      label: "Astuce",
      items: [
        "ne → n' devant voyelle : n'est pas, n'ai pas, n'avons pas",
        "À l'oral, le « ne » est souvent omis : Je suis pas là.",
      ],
      transLabel: { en: "Tip", ar: "نصيحة", fa: "نکته", ti: "ሓጋዚ ሓሳብ", uk: "Порада" },
      transItems: {
        en: ["ne → n' before a vowel: n'est pas, n'ai pas, n'avons pas", "In spoken French, «ne» is often dropped: Je suis pas là."],
        ar: ["ne → n' قبل حرف علة: n'est pas, n'ai pas, n'avons pas", "في الكلام اليومي، غالباً ما يُحذف «ne»: Je suis pas là."],
        fa: ["ne → n' قبل از حرف صدادار: n'est pas, n'ai pas, n'avons pas", "در فرانسه محاوره‌ای، «ne» اغلب حذف می‌شود: Je suis pas là."],
        ti: ["ne → n' ቅድሚ ድምጻዊ ፊደል: n'est pas, n'ai pas, n'avons pas", "ኣብ ዝዝረቦ ፈረንሳዊ፣ «ne» ብዙሕ ግዜ ይቁረጽ: Je suis pas là."],
        uk: ["ne → n' перед голосною: n'est pas, n'ai pas, n'avons pas", "В усній французькій «ne» часто опускається: Je suis pas là."],
      },
    },
  ],
  midExercises: [
