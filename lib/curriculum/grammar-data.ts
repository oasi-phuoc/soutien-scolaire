...
const a1GrL03: GrammarLesson = {
  ...
  theory: [
    ...
    { type: "plain_list", items: ["En français, les noms ont un genre."] },
    { type: "plain_list", items: ["Un nom peut être :", "masculin", "féminin"] },
    { type: "plain_list", items: ["Les adjectifs changent aussi selon le genre."] },
    ...
    { type: "heading", text: "Souvent masculins", sub: true, accent: true },
    {
      type: "grid",
      headers: ["Fin du mot", "Exemple"],
      rows: [
        ["{a}-age{/a}", "le village"],
    ...
    { type: "heading", text: "Souvent féminins", sub: true, accent: true },
    {
      type: "grid",
      headers: ["Fin du mot", "Exemple"],
      rows: [
    ...
    { type: "plain_list", items: ["L'adjectif donne une information sur le nom."] },
    {
      type: "highlight",
      label: "Exemples :",
      items: ["un grand sac"],
