...
const a1GrL03: GrammarLesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      transItems: {
        en: ["{a}-tion{/a} → la question (question)", "{a}-ette{/a} → la tablette (tablet)", "{a}-ure{/a} → la voiture (car)"],
        ar: ["{a}-tion{/a} → la question (سؤال)", "{a}-ette{/a} → la tablette (لوح)", "{a}-ure{/a} → la voiture (سيارة)"],
        fa: ["{a}-tion{/a} → la question (سوال)", "{a}-ette{/a} → la tablette (تبلت)", "{a}-ure{/a} → la voiture (ماشین)"],
        ti: ["{a}-tion{/a} → la question (ሕቶ)", "{a}-ette{/a} → la tablette (ታብሌት)", "{a}-ure{/a} → la voiture (መኪና)"],
        uk: ["{a}-tion{/a} → la question (питання)", "{a}-ette{/a} → la tablette (планшет)", "{a}-ure{/a} → la voiture (автомобіль)"],
      },
      inlineArrows: true,
    },
    {
