...
import { A1_GR_L01 } from "./content/francais/gramm-g1.1";
import { A1_GR_ETRE } from "./content/francais/gramm-g1.2";
import { A1_GR_AVOIR } from "./content/francais/gramm-g1.3";
import { A1_GR_VERBES_ER } from "./content/francais/gramm-g1.5";
import { A1_GR_PRONOMINAUX } from "./content/francais/gramm-g1.6";
import { A1_GR_MODAUX } from "./content/francais/gramm-g1.7";
import { A1_GR_VERBES_IR } from "./content/francais/gramm-g1.9";
import { A1_GR_VERBES_RE_OIR } from "./content/francais/gramm-g1.10";
import { A1_GR_GENRE_CHOSES } from "./content/francais/gramm-g2.2";
import { A1_GR_GENRE_ADJECTIFS } from "./content/francais/gramm-g3.1";
import { A1_GR_ADJ_ACCORDS_PART } from "./content/francais/gramm-g3.3";
import { A1_GR_PLURIEL_ADJECTIFS } from "./content/francais/gramm-g3.2";
import { A1_GR_PLACE_ADJECTIF } from "./content/francais/gramm-g3.4";
import { A1_GR_ARTICLES_CONTRACTES } from "./content/francais/gramm-g4.2";
import { A1_GR_ARTICLE_PARTITIF } from "./content/francais/gramm-g4.3";
import { A1_GR_EXPRESSION_QUANTITE } from "./content/francais/gramm-g4.4";
import { A1_GR_ADJECTIFS_INDEFINIS } from "./content/francais/gramm-g4.7";
import { A1_GR_QUESTION_TOTALE } from "./content/francais/gramm-g5.3";
import { A1_GR_QUESTION_OUVERTE_QUI } from "./content/francais/gramm-g5.4";
import { A1_GR_NEGATION_NE_PAS } from "./content/francais/gramm-g5.5";
import { A1_GR_AUTRES_NEGATIONS } from "./content/francais/gramm-g5.6";
import { A1_GR_PHRASE_EXCLAMATIVE } from "./content/francais/gramm-g5.7";
import { A1_GR_A_EN_DE_LIEUX } from "./content/francais/gramm-g7.1";
import { A1_GR_AUTRES_PREPOSITIONS } from "./content/francais/gramm-g7.2";
import { A1_GR_PASSE_COMPOSE_AVOIR } from "./content/francais/gramm-g8.1";
import { A1_GR_PASSE_COMPOSE_ETRE } from "./content/francais/gramm-g8.2";
import { A1_GR_IMPARFAIT } from "./content/francais/gramm-g8.5";
import { A1_GR_PASSE_RECENT } from "./content/francais/gramm-g8.6";
import { A1_GR_IMPARFAIT_PASSE_COMPOSE } from "./content/francais/gramm-g8.7";
import { A1_GR_PLUS_QUE_PARFAIT } from "./content/francais/gramm-g8.8";
import { A1_GR_ACCORD_PARTICIPE_PASSE } from "./content/francais/gramm-g8.9";
import { A1_GR_FUTUR_PROCHE } from "./content/francais/gramm-g9.1";
import { A1_GR_FUTUR_SIMPLE } from "./content/francais/gramm-g9.2";
import { A1_GR_FUTUR_ANTERIEUR } from "./content/francais/gramm-g9.5";
import { A1_GR_COMPARAISON_ADJ_ADV } from "./content/francais/gramm-g10.1";
import { A1_GR_COMPARAISON_NOM_VERBE } from "./content/francais/gramm-g10.2";
import { A1_GR_SUPERLATIF } from "./content/francais/gramm-g10.3";
import { A1_GR_EXPRESSION_TEMPS_MOMENT } from "./content/francais/gramm-g11.1";
import { A1_GR_MARQUEURS_TEMPS } from "./content/francais/gramm-g11.2";
import { A1_GR_PRONOMS_TONIQUES } from "./content/francais/gramm-g12.1";
import { A1_GR_PRONOMS_COD_COI } from "./content/francais/gramm-g12.2";
import { A1_GR_PRONOM_EN } from "./content/francais/gramm-g12.3";
import { A1_GR_PRONOMS_Y_EN_LIEU } from "./content/francais/gramm-g12.4";
import { A1_GR_EN_Y_PRONOM_TONIQUE } from "./content/francais/gramm-g12.5";
import { A1_GR_DOUBLES_PRONOMS } from "./content/francais/gramm-g12.6";
import { A1_GR_PRONOMS_DEMONSTRATIFS } from "./content/francais/gramm-g12.7";
import { A1_GR_PRONOMS_POSSESSIFS } from "./content/francais/gramm-g12.8";
import { A1_GR_PRONOMS_INDEFINIS } from "./content/francais/gramm-g12.9";
import { A1_GR_PRONOMS_RELATIFS_QUI_QUE_OU } from "./content/francais/gramm-g12.10";
import { A1_GR_PRONOM_RELATIF_DONT } from "./content/francais/gramm-g12.11";
import { A1_GR_PRONOMS_RELATIFS_COMPOSES } from "./content/francais/gramm-g12.12";
import { A1_GR_ADVERBES_INTENSITE } from "./content/francais/gramm-g14.1";
import { A1_GR_ADVERBES_MENT } from "./content/francais/gramm-g14.2";
import { A1_GR_MOTS_LIAISON } from "./content/francais/gramm-g15.1";
import { A1_GR_IMPERATIF } from "./content/francais/gramm-g16.1";
import { A1_GR_FORME_PASSIVE } from "./content/francais/gramm-g16.2";
import { A1_GR_GERONDIF } from "./content/francais/gramm-g16.3";
import { A1_GR_SUBJONCTIF_PRESENT } from "./content/francais/gramm-g16.4";
import { A1_GR_SUBJONCTIF_PASSE } from "./content/francais/gramm-g16.5";
import { A1_GR_SUBJONCTIF_OU_INDICATIF } from "./content/francais/gramm-g16.6";
import { A1_GR_SUBJONCTIF_OU_INFINITIF } from "./content/francais/gramm-g16.7";
import { A1_GR_CONDITIONNEL_PRESENT } from "./content/francais/gramm-g16.8";
import { A1_GR_CONDITIONNEL_PASSE } from "./content/francais/gramm-g16.9";
import { A1_GR_EXPRESSION_CAUSE } from "./content/francais/gramm-g17.1";
import { A1_GR_EXPRESSION_CONSEQUENCE } from "./content/francais/gramm-g17.2";
import { A1_GR_CONJONCTIONS_TEMPS } from "./content/francais/gramm-g17.3";
import { A1_GR_EXPRESSION_BUT } from "./content/francais/gramm-g17.4";
import { A1_GR_OPPOSITION_CONCESSION } from "./content/francais/gramm-g17.5";
import { A1_GR_HYPOTHESE_CONDITION } from "./content/francais/gramm-g17.6";
import { A1_GR_DISCOURS_INDIRECT_PRESENT } from "./content/francais/gramm-g17.7";
import { A1_GR_BILAN_A1 } from "./content/francais/gramm-g6.1";
import { A1_GR_BILAN_A2 } from "./content/francais/gramm-g13.1";
import { A1_GR_BILAN_B1 } from "./content/francais/gramm-g18.1";
import { A1_GR_NOMS_COMPOSES } from "./content/francais/gramm-g2.4";
import { A1_GR_PLURIEL_NOMS } from "./content/francais/gramm-g2.3";
import { A1_GR_GENRE_PERSONNES } from "./content/francais/gramm-g2.1";
import { A1_GR_PRESENT_PROGRESSIF } from "./content/francais/gramm-g1.11";
import { A1_GR_VERBES_ER_PART } from "./content/francais/gramm-g1.8";
import { A1_GR_CEST } from "./content/francais/gramm-g1.4";
import { A1_GR_PHRASES } from "./content/francais/gramm-g5.1";
import { A1_GR_INTERRO } from "./content/francais/gramm-g5.2";
import { A1_GR_L04 } from "./content/francais/gramm-g4.1";
import { A1_GR_DOUBLE_AUXILIAIRE } from "./content/francais/gramm-g8.3";
import { A1_GR_PRONOMINAUX_PASSE } from "./content/francais/gramm-g8.4";
import { A2_GR_FUTUR_SIMPLE_PROCHE } from "./content/francais/gramm-g9.3";
import { A2_GR_HYPOTHESE_FUTUR } from "./content/francais/gramm-g9.4";

import { A1_GR_L18 } from "./content/francais/gramm-g4.5";
import { A1_GR_L19 } from "./content/francais/gramm-g4.6";
import { A1_GR_L22 } from "./content/francais/gramm-g14.3";

// ── Imports — conjugaison ─────────────────────────────────────────────────────

import { A1_CONJ_L00 } from "./content/francais/gramm-r1.1-les-pronoms-personnels";
import { A1_CONJ_L01 } from "./content/francais/gramm-r1.2-les-verbes-etre-et-avoir";
import { A1_CONJ_L07 } from "./content/francais/gramm-r1.5-les-verbes-en-er-au-present";
import { A1_CONJ_L08 } from "./content/francais/gramm-r2.1-les-verbes-de-mouvement";
import { A1_CONJ_L09 } from "./content/francais/gramm-r2.2-les-verbes-pronominaux";
import { A1_CONJ_L15 } from "./content/francais/gramm-r2.3-les-verbes-modaux";
import { A2_CONJ_IRREGULIERS } from "./content/francais/gramm-r2.4-verbes-irreguliers";
import { A1_CONJ_L20 } from "./content/francais/gramm-r4.1-le-futur-proche";

import { A1_CONJ_L28 } from "./content/francais/gramm-r5.1-passe-recent-et-present-continu";
import { A1_CONJ_L29 } from "./content/francais/gramm-r5.2-passe-compose-avec-avoir";
import { A1_CONJ_L30 } from "./content/francais/gramm-r5.3-passe-compose-avec-etre";
import { NEGATION_PASSE_COMPOSE } from "./content/francais/gramm-r5.4-negation-au-passe-compose";
import { A2_CONJ_L02 } from "./content/francais/gramm-r2.5-les-verbes-en-ir-2e-et-3e-groupes";

import { A2_CONJ_L04 } from "./content/francais/gramm-r6.1-le-conditionnel-de-politesse";
import { A2_CONJ_L05 } from "./content/francais/gramm-r6.3-l-imperatif";
import { A2_CONJ_L07 } from "./content/francais/gramm-r5.8-les-verbes-reguliers-a-l-imparfait";
import { A2_CONJ_L08 } from "./content/francais/gramm-r4.4-les-verbes-reguliers-au-futur-simple";
