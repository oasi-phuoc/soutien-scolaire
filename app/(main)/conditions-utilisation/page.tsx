      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-[var(--color-border-default)] bg-white p-5">
          ...
          <p className="text-sm leading-relaxed text-[var(--color-text-secondary)]">
            L&apos;application <strong className="text-[var(--color-text-primary)]">Soutien Scolaire</strong> est un outil pédagogique numérique développé pour accompagner les élèves dans leur apprentissage du français et des mathématiques dans le canton du Valais (Suisse). Son utilisation est réservée à des fins éducatives.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-[var(--color-border-default)] bg-white p-5">
          ...
          <p className="text-sm leading-relaxed text-[var(--color-text-secondary)]">
            L&apos;accès à l&apos;application nécessite la création d&apos;un compte avec une adresse e-mail valide. Chaque utilisateur est responsable de la confidentialité de ses identifiants. Tout usage frauduleux d&apos;un compte doit être signalé immédiatement.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-[var(--color-border-default)] bg-white p-5">
          ...
          <p className="text-sm leading-relaxed text-[var(--color-text-secondary)]">
            Les données collectées sont limitées à l&apos;adresse e-mail et à la progression pédagogique (exercices réalisés, notes obtenues). Ces données sont stockées de façon sécurisée et ne sont jamais transmises à des tiers à des fins commerciales. La progression est également sauvegardée localement sur l&apos;appareil de l&apos;utilisateur.
          </p>
        </div>
