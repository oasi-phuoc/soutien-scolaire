...
function CardShell({
  ...
  return (
    <Link
      href={href}
      className="block rounded-[var(--radius-lg)] border border-[var(--color-border-default)] bg-[var(--color-bg-primary)] px-4 py-4 transition-colors hover:border-opacity-60"
...
export function HomeProgressCards() {
  ...
  // Approximate progress: map level to % (PA=0, A0=10, A1=25, A2=45, B1=70, B2=100)
