...
export function MediaPlayerBar({
  ...
  const lightOrange = `color-mix(in srgb, ${accentColor} 72%, white)`;

  const secondaryBtnClass =
    "flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition-colors hover:bg-white/70 active:scale-95";

  return (
    <div
      className="rounded-[var(--radius-lg)] px-3 py-3 sm:px-4"
    ...
    >
      <div className="flex items-center gap-2.5 sm:gap-3">
        <button
          type="button"
          onClick={onToggle}
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-white shadow-md transition-transform hover:opacity-90 active:scale-95 sm:h-12 sm:w-12"
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex justify-between text-[10px] tabular-nums sm:text-xs" style={{ color: lightOrange }}>
