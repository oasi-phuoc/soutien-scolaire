...
const PREREQ_LABELS: Record<string, string> = {
  ...
  "a1-gr-l02": "Unité 7 Négation",
  "a1-gr-l03": "Unité 5 Genre",
  "a1-gr-l04": "Unité 4 Articles",
  "a1-gr-l10": "Unité 9 Questions ouvertes",
  "a1-gr-l11": "Unité 12 Prépositions",
  "a1-gr-l14": "Unité 13 Partitifs",
  "a1-gr-l18": "Unité 11 Démonstratifs",
  "a1-gr-l19": "Unité 10 Possessifs",
  "a1-gr-l23": "Unité 14 Adjectifs",
  "a1-gr-pronominaux-passe-compose": "Unité 30 Pronominaux PC",
  "a2-conj-l04": "C4.1 Conditionnel politesse",
  "a2-conj-l05": "C4.2 Impératif",
  "a2-conj-l07": "C2.5 Imparfait",
  "a2-conj-l08": "C3.2 Futur simple",
  "a2-gr-l07": "Unité 15 Questions fermées",
  "a2-gr-l19": "Unité 23 Relatifs",
  "a2-gr-l35": "Unité 24 COD/COI",
  "a2-gr-l36": "Unité 25 Y / EN",
  "a2-gr-l39": "Unité 19 Comparatif",
  "a2-gr-l42": "Unité 22 Négation 2",
  "a2-gr-l52": "Unité 27 Cause / conséquence",
  "a2-gr-hypothese-futur": "Unité 35 Condition (si)",
  "a2-gr-subjonctif": "Unité 38 Subjonctif",
  "gr-marqueurs-temps-complet": "Unité 26 Marqueurs de temps",
