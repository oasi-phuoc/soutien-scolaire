...
const PREREQ_LABELS: Record<string, string> = {
  ...
  "a1-conj-l07": "C1.5 Verbes en -er",
  "a1-conj-l08": "C2.1 Mouvement",
  "a1-conj-l09": "C2.2 Pronominaux",
  "a1-conj-l15": "C2.3 Modaux",
  "a1-conj-l20": "C4.1 Futur proche",
  "a1-conj-l28": "C5.1 Passé récent",
  "a1-conj-l29": "C5.2 Passé composé (avoir)",
  "a1-conj-l30": "C5.3 Passé composé (être)",
  "a1-gr-l02": "G1.7 Négation",
  "a1-gr-l03": "G1.4 Genre",
  "a1-gr-l04": "G1.3 Articles",
  "a1-gr-l10": "G Interrogation",
  "a1-gr-l11": "G3.3 Prépositions",
  "a1-gr-l14": "G3.1 Partitifs",
  "a1-gr-l18": "G3.4 Démonstratifs",
  "a1-gr-l19": "G3.5 Possessifs",
  "a1-gr-l23": "G3.7 Adjectifs",
  "a1-gr-pronominaux-passe-compose": "G5.6 Pronominaux PC",
  "a2-conj-l04": "C6.1 Conditionnel politesse",
  "a2-conj-l05": "C6.3 Impératif",
  "a2-conj-l07": "C5.8 Imparfait",
  "a2-conj-l08": "C4.4 Futur simple",
  "a2-gr-l07": "G Questions",
  "a2-gr-l19": "G Relatifs",
  "a2-gr-l35": "G COD/COI",
  "a2-gr-l36": "G Y / EN",
  "a2-gr-l39": "G Comparatif",
  "a2-gr-l42": "G Négation 2",
  "a2-gr-l52": "G Cause / conséquence",
  "a2-gr-hypothese-futur": "G Condition (si)",
  "a2-gr-subjonctif": "G Subjonctif",
  "gr-marqueurs-temps-complet": "G Marqueurs de temps",
