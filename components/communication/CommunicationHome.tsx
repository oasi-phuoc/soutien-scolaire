...
const PREREQ_LABELS: Record<string, string> = {
  ...
  "a1-gr-l02": "Unité 40 La négation",
  "a1-gr-l03": "Unité 38 Le genre des noms et des adjectifs",
  ...
  "a1-gr-a-en-de-lieux": "Unité 35 À, en, de avec les noms de villes, p",
  ...
  "a1-gr-l10": "Unité 42 Les questions ouvertes",
  "a1-gr-l11": "Unité 43 Les prépositions de lieu",
  "a1-gr-l14": "Unité 44 Les adjectifs partitifs",
  "a1-gr-l18": "Unité 25 Les adjectifs démonstratifs",
  "a1-gr-l19": "Unité 26 Les adjectifs possessifs",
  "a1-gr-l23": "Unité 45 Les adjectifs qualificatifs",
  "a1-gr-pronominaux-passe-compose": "Unité 61 Les verbes pronominaux au passé comp",
  "a2-conj-l04": "C4.1 Conditionnel politesse",
  "a2-conj-l05": "C4.2 Impératif",
  "a2-conj-l07": "C2.5 Imparfait",
  "a2-conj-l08": "C3.2 Futur simple",
  "a2-gr-l07": "Unité 46 Les questions fermées",
  "a2-gr-l19": "Unité 54 Les pronoms relatifs qui et que",
  "a2-gr-l35": "Unité 55 Les pronoms COD et COI",
  "a2-gr-l36": "Unité 56 Les pronoms Y et EN",
  "a2-gr-l39": "Unité 50 Le comparatif",
  "a2-gr-l42": "Unité 53 La négation (2/2)",
  "a2-gr-l52": "Unité 58 Les relations logiques — Cause et co",
  "a2-gr-hypothese-futur": "Unité 66 L'hypothèse sur le futur",
  "a2-gr-subjonctif": "Unité 69 Le subjonctif",
  "gr-marqueurs-temps-complet": "Unité 57 Les marqueurs de temps",
