...
const PREREQ_LABELS: Record<string, string> = {
  ...
  "a1-gr-l02": "Unité 5 Négation",
  "a1-gr-l03": "Unité 3 Genre",
  "a1-gr-l04": "Unité 2 Articles",
  "a1-gr-l10": "Unité 8 Questions ouvertes",
  "a1-gr-l11": "Unité 11 Prépositions",
  "a1-gr-l14": "Unité 12 Partitifs",
  "a1-gr-l18": "Unité 10 Démonstratifs",
  "a1-gr-l19": "Unité 9 Possessifs",
  "a1-gr-l23": "Unité 13 Adjectifs",
  "a1-gr-pronominaux-passe-compose": "Unité 29 Pronominaux PC",
  "a2-conj-l04": "C4.1 Conditionnel politesse",
  "a2-conj-l05": "C4.2 Impératif",
  "a2-conj-l07": "C2.5 Imparfait",
  "a2-conj-l08": "C3.2 Futur simple",
  "a2-gr-l07": "Unité 14 Questions fermées",
  "a2-gr-l19": "Unité 22 Relatifs",
  "a2-gr-l35": "Unité 23 COD/COI",
  "a2-gr-l36": "Unité 24 Y / EN",
  "a2-gr-l39": "Unité 18 Comparatif",
  "a2-gr-l42": "Unité 21 Négation 2",
  "a2-gr-l52": "Unité 26 Cause / conséquence",
  "a2-gr-hypothese-futur": "Unité 34 Condition (si)",
  "a2-gr-subjonctif": "Unité 37 Subjonctif",
  "gr-marqueurs-temps-complet": "Unité 25 Marqueurs de temps",
