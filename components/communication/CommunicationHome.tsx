...
const PREREQ_LABELS: Record<string, string> = {
  ...
  "a1-gr-l02": "Unité 65 La négation",
  "a1-gr-l03": "Unité 63 Le genre des noms et des adjectifs",
  ...
  "a1-gr-l10": "Unité 67 Les questions ouvertes",
  "a1-gr-l11": "Unité 68 Les prépositions de lieu",
  "a1-gr-l14": "Unité 69 Les adjectifs partitifs",
  "a1-gr-l18": "Unité 25 Les adjectifs démonstratifs",
  "a1-gr-l19": "Unité 26 Les adjectifs possessifs",
  "a1-gr-l23": "Unité 70 Les adjectifs qualificatifs",
  "a1-gr-pronominaux-passe-compose": "Unité 86 Les verbes pronominaux au passé composé",
  "a2-conj-l04": "C4.1 Conditionnel politesse",
  "a2-conj-l05": "C4.2 Impératif",
  "a2-conj-l07": "C2.5 Imparfait",
  "a2-conj-l08": "C3.2 Futur simple",
  "a2-gr-l07": "Unité 71 Les questions fermées",
  "a2-gr-l19": "Unité 79 Les pronoms relatifs qui et que",
  "a2-gr-l35": "Unité 80 Les pronoms COD et COI",
  "a2-gr-l36": "Unité 81 Les pronoms Y et EN",
  "a2-gr-l39": "Unité 75 Le comparatif",
  "a2-gr-l42": "Unité 78 La négation (2/2)",
  "a2-gr-l52": "Unité 83 Les relations logiques — Cause et conséq",
  "a2-gr-hypothese-futur": "Unité 91 L'hypothèse sur le futur",
  "a2-gr-subjonctif": "Unité 94 Le subjonctif",
  "gr-marqueurs-temps-complet": "Unité 82 Les marqueurs de temps",
