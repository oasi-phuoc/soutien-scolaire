...
const PREREQ_LABELS: Record<string, string> = {
  ...
  "a1-gr-l02": "Unité 27 La négation",
  "a1-gr-l03": "Unité 25 Le genre des noms et des adj",
  "a1-gr-l04": "Unité 21 Les articles définis et indé",
  "a1-gr-l10": "Unité 29 Les questions ouvertes",
  "a1-gr-l11": "Unité 32 Les prépositions de lieu",
  "a1-gr-l14": "Unité 33 Les adjectifs partitifs",
  "a1-gr-l18": "Unité 31 Les adjectifs démonstratifs",
  "a1-gr-l19": "Unité 30 Les adjectifs possessifs",
  "a1-gr-l23": "Unité 34 Les adjectifs qualificatifs",
  "a1-gr-pronominaux-passe-compose": "Unité 50 Les verbes pronominaux au pa",
  "a2-conj-l04": "C4.1 Conditionnel politesse",
  "a2-conj-l05": "C4.2 Impératif",
  "a2-conj-l07": "C2.5 Imparfait",
  "a2-conj-l08": "C3.2 Futur simple",
  "a2-gr-l07": "Unité 35 Les questions fermées",
  "a2-gr-l19": "Unité 43 Les pronoms relatifs qui et ",
  "a2-gr-l35": "Unité 44 Les pronoms COD et COI",
  "a2-gr-l36": "Unité 45 Les pronoms Y et EN",
  "a2-gr-l39": "Unité 39 Le comparatif",
  "a2-gr-l42": "Unité 42 La négation (2/2)",
  "a2-gr-l52": "Unité 47 Les relations logiques",
  "a2-gr-hypothese-futur": "Unité 55 L'hypothèse sur le futur",
  "a2-gr-subjonctif": "Unité 58 Le subjonctif",
  "gr-marqueurs-temps-complet": "Unité 46 Les marqueurs de temps",
