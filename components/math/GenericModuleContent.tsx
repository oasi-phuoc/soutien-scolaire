...
function isSolutionSetLine(line: string): boolean {
...
function genEquationGroupStep(lesson: MathSubmoduleLesson, exNum = 1): EquationGroupStep {
  ...
  const fixedA102: EquationQuestion[] = [
    { expr: "4x · 3 - 2(x + 1) = 5x - 3 + x", solution: rat(-1, 4), development: ["12x - 2x - 2 = 6x - 3", "10x - 2 = 6x - 3", "4x - 2 = -3", "4x = -1", "x = -1/4"], operations: ["effectuer", "réduire", "- 6x", "+ 2", ": 4", ""] },
    { expr: "7 - (8 - 2x) = 7x + (2x - 1) · 3", solution: rat(2, 11), development: ["7 - 8 + 2x = 7x + 6x - 3", "-1 + 2x = 13x - 3", "-1 - 11x = -3", "-11x = -2", "x = 2/11"], operations: ["effectuer", "réduire", "- 13x", "+ 1", ": (-11)", ""] },
    { expr: "8x + x + x + 2x = (x - 2) - (x + 3)", solution: rat(-5, 12), development: ["12x = x - 2 - x - 3", "12x = -5", "x = -5/12"], operations: ["effectuer", "réduire", ": 12", ""] },
    ...
    { expr: "x + x + x - 3 = (x + 2) - (4x - 7)", solution: rat(2, 1), development: ["3x - 3 = x + 2 - 4x + 7", "3x - 3 = -3x + 9", "6x - 3 = 9", "6x = 12", "x = 2"], operations: ["effectuer", "réduire", "+ 3x", "+ 3", ": 6", ""] },
    { expr: "5(x - 2) + 2(8 + 3x) = 0", solution: rat(-6, 11), development: ["5x - 10 + 16 + 6x = 0", "11x + 6 = 0", "11x = -6", "x = -6/11"], operations: ["effectuer", "réduire", "- 6", ": 11", ""] },
    { expr: "50 - 3(x - 1) = (4 + 3x) · 2", solution: rat(5, 1), development: ["50 - 3x + 3 = 8 + 6x", "53 - 3x = 8 + 6x", "53 - 9x = 8", "-9x = -45", "x = 5"], operations: ["effectuer", "réduire", "- 6x", "- 53", ": (-9)", ""] },
    { expr: "3x · 2x - 8 = 7x² + 2 - x(x + 1)", solution: rat(10, 1), development: ["6x² - 8 = 7x² + 2 - x² - x", "6x² - 8 = 6x² + 2 - x", "-8 = 2 - x", "-10 = -x", "x = 10"], operations: ["effectuer", "réduire", "- 6x²", "- 2", "· (-1)", ""] },
    { expr: "(8 - 3x) - (7 - 3x) = 10", solution: { kind: "impossible" }, development: ["8 - 3x - 7 + 3x = 10", "1 = 10", "impossible !"], operations: ["effectuer", "réduire", "", ""] },
    ...
    { expr: "3x · 2 - 4 · 5x = 8 - (4 + 5x)", solution: rat(-4, 9), development: ["6x - 20x = 8 - 4 - 5x", "-14x = 4 - 5x", "-9x = 4", "x = -4/9"], operations: ["effectuer", "réduire", "+ 5x", ": (-9)", ""] },
    { expr: "5x · (-2) - 3x = 2x + 7 - 6x + 3", solution: rat(-10, 9), development: ["-10x - 3x = -4x + 10", "-13x = -4x + 10", "-9x = 10", "x = -10/9"], operations: ["effectuer", "réduire", "+ 4x", ": (-9)", ""] },
  ];
...
function genSystemEquationStep(lesson: MathSubmoduleLesson): SystemEquationStep {
  ...
  const templates: SystemEquationQuestion[] = [
    sys(["3x + y = 1", "5x - 8y = -37"], `{(-1 ; 4)}`, acceptPair("-1", "4"), [
      ...
      "5x - 8(1 - 3x) = -37", "5x - 8 + 24x = -37", "29x - 8 = -37", "29x = -29", "x = -1", "chercher la valeur de y", "y = 1 - 3x", "y = 1 - 3 · (-1) = 4",
    ...
    sys(["2x - 4y = 26", "7y = -32 - x"], `{(3 ; -5)}`, acceptPair("3", "-5"), [
      ...
      "2(-7y - 32) - 4y = 26", "-14y - 64 - 4y = 26", "-18y - 64 = 26", "-18y = 90", "y = -5", "chercher la valeur de x", "-7y - 32 = x", "x = -7 · (-5) - 32 = 3",
    ...
    sys(["3x - y = -22", "5x + 3y = -46"], `{(-8 ; -2)}`, acceptPair("-8", "-2"), [
      ...
      "5x + 3(22 + 3x) = -46", "5x + 66 + 9x = -46", "14x + 66 = -46", "14x = -112", "x = -8", "chercher la valeur de y", "y = 22 + 3x", "y = 22 + 3 · (-8) = -2",
    ...
    sys(["4x + 4y = 28", "x - (-2y) = 14"], `{(0 ; 7)}`, acceptPair("0", "7"), [
      ...
      "4(14 - 2y) + 4y = 28", "56 - 8y + 4y = 28", "56 - 4y = 28", "-4y = -28", "y = 7", "chercher la valeur de x", "x = 14 - 2y", "x = 14 - 2 · 7 = 0",
    ...
    sys(["15 - 3y = 5x + 2", "8y + 7 = 12 - x"], `{(${f("89", "37")} ; ${f("12", "37")})}`, acceptPair("89/37", "12/37"), [
      ...
      "chercher la valeur de x", "x = -8y + 5", `x = -8 · ${f("12", "37")} + 5 = ${f("89", "37")}`,
    ...
    sys(["3(y - 7) = 12 + x", "5(x + 1) = 3y + 2"], `{(${f("15", "2")} ; ${f("27", "2")})}`, acceptPair("15/2", "27/2"), [
      ...
      "5(3y - 33) + 5 = 3y + 2", "15y - 165 + 5 = 3y + 2", "12y - 160 = 2", "12y = 162", `y = ${f("27", "2")}`, "chercher la valeur de x", "x = 3y - 33", `x = 3 · ${f("27", "2")} - 33 = ${f("15", "2")}`,
    ...
    sys(["x - 7 = 8 + 3y", "2y - 5x = 10"], `{(${f("-60", "13")} ; ${f("-85", "13")})}`, acceptPair("-60/13", "-85/13"), [
      ...
      "chercher la valeur de x", "x = 15 + 3y", `x = 15 + 3 · ${f("-85", "13")} = ${f("-60", "13")}`,
    ...
    sys(["2x + 3y = 10", "8x = y - 7"], `{(${f("-11", "26")} ; ${f("47", "13")})}`, acceptPair("-11/26", "47/13"), [
      ...
      "chercher la valeur de y", "8x + 7 = y", `8 · ${f("-11", "26")} + 7 = y`, `y = ${f("47", "13")}`,
    ...
    sys(["y - 7 = 5x + 19", "3x - 8 = 2y + 1"], `{(${f("-61", "7")} ; ${f("-123", "7")})}`, acceptPair("-61/7", "-123/7"), [
      ...
      "chercher la valeur de y", "y = 5x + 26", `y = 5 · ${f("-61", "7")} + 26 = ${f("-123", "7")}`,
    ], ["", "+ 7", "", "", "effectuer", "- 3x", "- 53", ": 7", "", ""]),
    sys(["5(x - 7) = 8y + 2", "10 + y = 3(8 - 2x)"], `{(${f("149", "53")} ; ${f("-152", "53")})}`, acceptPair("149/53", "-152/53"), [
      ...
      "5x - 35 = 8(14 - 6x) + 2", "5x - 35 = 112 - 48x + 2", "53x - 35 = 114", "53x = 149", `x = ${f("149", "53")}`, "chercher la valeur de y", "y = 14 - 6x", `y = 14 - 6 · ${f("149", "53")} = ${f("-152", "53")}`,
    ...
    sys(["4x + 7y = 10", "x - 9y = 3"], `{(${f("111", "43")} ; ${f("-2", "43")})}`, acceptPair("111/43", "-2/43"), [
      ...
      "chercher la valeur de x", "x = 3 + 9y", `x = 3 + 9 · ${f("-2", "43")} = ${f("111", "43")}`,
    ], ["", "+ 9y", "", "", "effectuer", "- 12", ": 43", "", ""]),
    sys(["8y - x = 12", "-5x - 65 = -40y"], `impossible`, ["impossible", "s=∅", "vide", "∅"], [
      "isoler x dans I", "8y - x = 12", "-x = 12 - 8y", "x = -12 + 8y", "injecter I → II et résoudre", "-5(-12 + 8y) - 65 = -40y", "60 - 40y - 65 = -40y", "-5 = 0", "impossible !",
    ], ["", "- 8y", "· (-1)", "", "", "effectuer", "+ 40y", ""]),
    sys(["4y + 5x = 10", "3 - x = 7 + 8y"], `{(${f("8", "3")} ; ${f("-5", "6")})}`, acceptPair("8/3", "-5/6"), [
      ...
      "chercher la valeur de x", "x = -4 - 8y", `x = -4 - 8 · ${f("-5", "6")} = ${f("8", "3")}`,
    ], ["", "- 3", "· (-1)", "", "", "effectuer", "+ 20", ": (-36)", "", ""]),
    ...
    sys(["5y - 2x = 3", "10x + y = 7"], `{(${f("8", "13")} ; ${f("11", "13")})}`, acceptPair("8/13", "11/13"), [
      ...
      "chercher la valeur de y", "y = 7 - 10x", `y = 7 - 10 · ${f("8", "13")} = ${f("11", "13")}`,
...
function genLinearCombinationStep(lesson: MathSubmoduleLesson): SystemEquationStep {
  ...
  const templatesA104: SystemEquationQuestion[] = [
    ...
    sys(["-2x - 3y = 19", "7y = -25 + 5x"], `{(-2 ; -5)}`, acceptPair("-2", "-5"), [
      ...
      "dans I", "-2x - 3 · (-5) = 19", "-2x + 15 = 19", "-2x = 4", "x = -2",
    ], ["- 5x", "", "· 5", "· 2", ": (-29)", "", "", "", "- 15", ": (-2)", "", ""]),
    ...
    sys(["5y - 2x = 10", "15 - 7y = 5(x + 8)"], `{(-5 ; 0)}`, acceptPair("-5", "0"), [
      ...
      "dans I", "5y - 2 · (-5) = 10", "5y + 10 = 10", "5y = 0", "y = 0",
    ], ["", "", "- 5x / - 15", "· 7", "", "· 5", "", ": (-39)", "", "", "", "- 10", ": 5", "", ""]),
    sys(["10y + 7x - 1 = 0", "40y + 28x - 10 = 0"], `impossible`, ["impossible", "s=∅", "vide", "∅"], [
      "I · 4", "40y + 28x - 4 = 0", "II", "40y + 28x - 10 = 0", "6 = 0", "impossible !",
    ], ["· 4", "", "", "", "", ""]),
