...
function makeFigure(shapeKind: G3ShapeKind, mode: ExerciseMode, decimals: boolean): FigureData {
  ...
  <text x='115' y='28' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
  ...
  <text x='115' y='25' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(side)} ${unit}</text>
</svg>`,
    };
  }
  ...
  <text x='130' y='37' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findLength ? "x" : `${fmt(length)} ${unit}`}</text>
  <text x='228' y='93' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findLength ? `${fmt(width)} ${unit}` : "x"}</text>
  <text x='130' y='158' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
    const conv = withAreaConversion(area, unit);
  ...
  <text x='130' y='29' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(length)} ${unit}</text>
  <text x='228' y='85' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(width)} ${unit}</text>
</svg>`,
    };
  }
  ...
  <text x='160' y='180' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findBase ? "x" : `${fmt(base)} ${unit}`}</text>
  <text x='152' y='102' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findBase ? `${fmt(height)} ${unit}` : "x"}</text>
  <text x='160' y='22' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
    const conv = withAreaConversion(area, unit);
  ...
  <text x='160' y='176' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(base)} ${unit}</text>
  <text x='153' y='100' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>h = ${fmt(height)} ${unit}</text>
  <text x='86' y='91' text-anchor='end' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(side)} ${unit}</text>
</svg>`,
    };
  }
  ...
  <text x='128' y='174' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findBase ? "x" : `${fmt(base)} ${unit}`}</text>
  <text x='260' y='101' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findBase ? `${fmt(height)} ${unit}` : "x"}</text>
  <text x='160' y='24' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
    const conv = withAreaConversion(area, unit);
  ...
  <text x='128' y='169' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(base)} ${unit}</text>
  <text x='260' y='96' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>h = ${fmt(height)} ${unit}</text>
  <text x='72' y='86' text-anchor='end' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(side)} ${unit}</text>
</svg>`,
    };
  }
  ...
  <text x='165' y='32' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(top)} ${unit}</text>
  <text x='162' y='178' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(bottom)} ${unit}</text>
  <text x='235' y='105' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>x</text>
  <text x='165' y='196' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
    const conv = withAreaConversion(area, unit);
  ...
  <text x='165' y='30' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(top)} ${unit}</text>
  <text x='162' y='173' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${fmt(bottom)} ${unit}</text>
  <text x='235' y='100' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>h = ${fmt(height)} ${unit}</text>
</svg>`,
    };
  }
  ...
  <text x='120' y='162' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
    const conv = withAreaConversion(area, unit);
  ...
  <text x='120' y='154' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>d = ${fmt(diameter)} ${unit}</text>
</svg>`,
    };
  }
  ...
  <text x='155' y='190' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findD1 ? "x" : `d₁ = ${fmt(d1)} ${unit}`}</text>
  <text x='166' y='92' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${findD1 ? `d₂ = ${fmt(d2)} ${unit}` : "x"}</text>
  <text x='155' y='22' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
      };
    }
    const conv = withAreaConversion(area, unit);
  ...
  <text x='155' y='181' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>d₁ = ${fmt(d1)} ${unit}</text>
  <text x='166' y='87' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>d₂ = ${fmt(d2)} ${unit}</text>
</svg>`,
    };
  }
...
function makeCompositeFigure(mode: ExerciseMode, decimals: boolean, unit: Unit): FigureData {
  ...
  <text x='142' y='48' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(width)}</text>
  <text x='36' y='113' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif' transform='rotate(-90 36 113)'>${label(height)}</text>
  <text x='262' y='90' font-size='15' fill='var(--color-accent-alg)' font-weight='bold' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>x</text>
  <text x='170' y='204' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>Aire = ${fmt(area)} ${areaUnit(unit)}</text>
</svg>`,
    };
  }
  ...
  <text x='160' y='207' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(width)}</text>
  <text x='270' y='151' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(rectH)}</text>
  <text x='171' y='78' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>h = ${label(triH)}</text>
</svg>`,
    };
  }
  ...
  <text x='160' y='84' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(diameter)}</text>
  <text x='263' y='138' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(height)}</text>
</svg>`,
    };
  }
  ...
  <text x='150' y='33' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(bigW)}</text>
  <text x='34' y='113' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif' transform='rotate(-90 34 113)'>${label(bigH)}</text>
  <text x='218' y='119' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(cutW)}</text>
  <text x='194' y='84' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(cutH)}</text>
</svg>`,
    };
  }
  ...
  <text x='120' y='184' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(w1)}</text>
  <text x='42' y='128' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif' transform='rotate(-90 42 128)'>${label(h1)}</text>
  <text x='221' y='42' text-anchor='middle' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(w2)}</text>
  <text x='276' y='112' font-size='13' fill='var(--color-text-primary)' font-family='Century Gothic, CenturyGothic, AppleGothic, Nunito, sans-serif'>${label(h2)}</text>
</svg>`,
  };
}
