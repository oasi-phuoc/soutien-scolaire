...
function A1RevisionWrapper() {
  const [phase, setPhase] = useState<"a11" | "a12" | "rest">("a11");
  if (phase === "a11") {
    return (
      <A1ModuleContent
        startSubmoduleId="A1-1"
        startAtEval={true}
        autoStartEval={true}
        onRevisionComplete={() => setPhase("a12")}
      />
    );
  }
  if (phase === "a12") {
    return (
      <A1ModuleContent
        startSubmoduleId="A1-2"
        startAtEval={true}
        autoStartEval={true}
        onRevisionComplete={() => setPhase("rest")}
      />
    );
  }
  return (
