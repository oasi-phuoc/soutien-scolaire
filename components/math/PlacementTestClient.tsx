...
const EXERCISES: ExerciseMeta[] = [
  ...
  { id: 12, label: "Colonnes (1000–9999)", maxPoints: 3, component: Exercise13 },
  ...
  { id: 19, label: "Multiplication décimale", maxPoints: 2, component: Exercise20 },
  { id: 20, label: "Division décimale", maxPoints: 2, component: Exercise21 },
  { id: 21, label: "Colorier les fractions", maxPoints: 2, component: Exercise22 },
  { id: 22, label: "Conversions de longueur", maxPoints: 4, component: Exercise23 },
  { id: 23, label: "Calculs décimaux", maxPoints: 4, component: Exercise24 },
  { id: 24, label: "Parallélogramme", maxPoints: 2, component: Exercise25 },
  { id: 25, label: "Triangle rectangle", maxPoints: 2, component: Exercise26 },
  { id: 26, label: "Losange", maxPoints: 2, component: Exercise27 },
  { id: 27, label: "Puissances et racines", maxPoints: 4, component: Exercise28 },
  { id: 28, label: "Priorité des opérations", maxPoints: 2, component: Exercise29 },
  { id: 29, label: "Nombres relatifs", maxPoints: 4, component: Exercise30 },
  { id: 30, label: "Fractions", maxPoints: 4, component: Exercise31 },
  { id: 31, label: "Pourcentages et règle de trois", maxPoints: 2, component: Exercise32 },
  { id: 32, label: "Simplification algébrique", maxPoints: 2, component: Exercise33 },
  { id: 33, label: "Évaluer des expressions", maxPoints: 2, component: Exercise34 },
  { id: 34, label: "Résoudre des équations", maxPoints: 2, component: Exercise35 },
  { id: 35, label: "Conversions d'unités", maxPoints: 4, component: Exercise36 },
  { id: 36, label: "Trapèze", maxPoints: 2, component: Exercise37 },
  { id: 37, label: "Cercle", maxPoints: 2, component: Exercise38 },
];
