    ...
    <div className="mx-auto w-full max-w-xl flex-1 px-4 py-8 pb-56">
      <header className="mb-5 space-y-1">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/lecture"
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-[var(--color-accent-lecture)] transition-colors hover:bg-[var(--color-bg-secondary)]"
